...
// DRAM memory map
//------------------------------------------------------------------------------
#include "MIUSEL_WHISKY_MIU.h"

#if 1 // Use MMAP_FILE,
    // MMAP_FILE is defined at .config
    #include MMAP_FILE
#else

#if (MEMORY_MAP == MMAP_128MB)
    #include "MMAP_ATSCMM_WHISKY_128_R2.h"
#elif( MEMORY_MAP == MMAP_64MB )
    #if (ENABLE_ATSC)
        #include "MMAP_ATSCMM_WHISKY_64_R2.h"
    #else
        #include "MMAP_ATVMM_WHISKY_64_R2.h"
    #endif
#elif( MEMORY_MAP == MMAP_32MB )
    #if (ENABLE_32M_H264 == ENABLE)
        #include "MMAP_ATSCMM_WHISKY_32_R2.h"
    #else
