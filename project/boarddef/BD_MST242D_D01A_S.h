...
#define BOARD_NAME                  "BD_MST242D_D01A_S_MELODY"

#define PIN_FLASH_WP0               PIN_66 //PAD_SAR1 //HW-tighted to HIGH
...
#define PIN_66_IS_GPIO              GPIO_OUT_LOW  //(GPIO74,PAD_SAR1): Audio AMP Enable (H:Enable)
#define PIN_54_IS_GPIO              GPIO_OUT_HIGH //(GPIO0,PAD_TCON0): NORMAL_PWR-ON_OFF (H:On)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD91RQNx.h"
...
// Audio Amplifier
//#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_66 )
//#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_66 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_66 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_66 )
//3D EN
