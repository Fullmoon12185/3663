...
#define PIN_29_IS_GPIO              GPIO_OUT_LOW//default is low to prevent pop noise GPIO87: AUDIO-EN (H:Enable)
...
#define ARC_SUPPORT_PORT            2   //connect to UI port3
...
*/
    ...
    #if (FRONTEND_DEMOD_ISDBT_TYPE == DIB_DiB8006GP_DEMOD)
...
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_29 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_29 )
