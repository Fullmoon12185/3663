...
#define BOARD_NAME                  "BD_MST269C_D01A_S_MARLON"
...
#define PIN_125_IS_GPIO        GPIO_OUT_HIGH //GPIO70, AUDIO-EN (RT9116 Audio Amp Enable, L:Enable)  init: MUTE
#define PIN_126_IS_GPIO        GPIO_OUT_LOW //GPIO71, PreAMP_EN (Audio Mute, H:Mute -> set low)
#define PIN_95_IS_GPIO          GPIO_OUT_HIGH //GPIO19, MUTE_S       (I2S Audio Mute, L:Mute -> set high)
#define PIN_127_IS_GPIO        GPIO_IN            //GPIO72, USB0_OCD_N (USB Port 0 Over Current Detect)
...
#define PIN_31_IS_GPIO          GPIO_IN            //GPIO175, HP_DET
#define PIN_121_IS_GPIO        GPIO_IN            //GPIO94, CABLE_DET
...
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_125 ) // RT9116 Audio Amp, ENABLE
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_125 ) // RT9116 Audio Amp, MUTE
