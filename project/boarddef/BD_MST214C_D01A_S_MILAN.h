...
#define BOARD_NAME                  "BD_MST214C_D01A_S"
...
#define PIN_72_IS_GPIO              GPIO_OUT_LOW//GPIO49, AUDIO-EN (Audio Amp Enable, H:Enable) // init mute
...
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_72 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_72 )
