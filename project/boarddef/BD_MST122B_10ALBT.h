...
#define BOARD_NAME                  "BD_MST122B_10ALBT"

#define PIN_SPI_CZ1                     PIN_112
...
#define PADS_MHLVBUS_MODE    MHLVBUS_MODE(5)
...
#define PIN_60_IS_GPIO          GPIO_IN       	    //GPIO44, Tuner_SDA
#define PIN_61_IS_GPIO          GPIO_IN       	    //GPIO45, Tuner_SCL
#define PIN_95_IS_GPIO          GPIO_OUT_HIGH //GPIO19, MUTE_S       (I2S Audio Mute, L:Mute -> set high)
#define PIN_97_IS_GPIO          GPIO_OUT_LOW //GPIO17, PANEL_ON_OFF (Panel Power Enable, L:On)
#define PIN_96_IS_GPIO          GPIO_OUT_HIGH //GPIO18, NORMAL_PWR-ON_OFF
#define PIN_121_IS_GPIO        GPIO_IN            //GPIO16, CABLE_DET
#define PIN_31_IS_GPIO          GPIO_OUT_LOW   //BACKLIGHT ON OFF 1.H>ï¼?2.5V,L<=0.3V 2.default LOW 3.L: OFF, H: ON,
#define PIN_129_IS_GPIO        GPIO_OUT_HIGH  //LNB_EN: H:VCC_LNB On, L:VCC_LNB Off
#define PIN_98_IS_GPIO          GPIO_OUT_LOW  //LNB_SEL: H:VCC_LNB 18.3V, L:VCC_LNB   13.3V

//------Chip Type---------------------------------------------------------------
#include "chip/MSD92LCBW2.h"
...
#define TS_CLK_INV                      0
#define TS_SERIAL_OUTPUT_IF_CI_REMOVED  0
#define FRONTEND_TUNER_TYPE             SILAB_2151_TUNER//MxL_601SI_TUNER // MxL_601SI_TUNER	//NXP_FH2608_TUNER //NUTUNE_FK1602_TUNER
#define FRONTEND_IF_MIXER_TYPE          XUGUANG_T126CWADC //PHILIPS_FQD1216_TUNER
#define FRONTEND_IF_DEMODE_TYPE         MSTAR_INTERN_VIF  //PHILIPS_TDA9886 //MSTAR_VIF_MSB1210   //MSTAR_VIF //PHILIPS_TDA9886
#define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
...
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_95 ) // RT9116 Audio Amp, ENABLE
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_95 ) // RT9116 Audio Amp, MUTE

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_97 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_97 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_31 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_31 )
