...
#define DIGITAL_I2S_SELECT              AUDIO_I2S_NONE//AUDIO_I2S_NONE
...
#define Switch_DVI()       MApi_XC_DVI_SwitchSrc(INPUT_PORT_DVI2)
...
#define HDMI1_INPUT_DETECT()            mdrv_gpio_get_level(PIN_119)   //mdrv_gpio_get_level(PIN_118)     // HDMI0
