...
#define BOARD_NAME                  "BD_MST061B_10AZU_14014"
...
#define PADS_MHL_VBUS               Unknown_pad_mux //PAD_PWM1
...
#define PADS_SPDIF_OUT              PAD_TCON0 //PAD_PWM1,PAD_TCON0, PAD_GPIO4, PAD_TCON1
...
#define PIN_82_IS_GPIO          	GPIO_OUT_LOW   //GPIO3: Panel On: Low / Off: High

#define PIN_49_IS_GPIO              GPIO_IN         //GPIO44: Tuner_SDA
#define PIN_50_IS_GPIO              GPIO_IN         //GPIO45: Tuner_SCL

#define PIN_87_IS_GPIO              GPIO_OUT_HIGH//GPIO46: AUDIO-EN (H:Enable)
#define PIN_83_IS_GPIO              GPIO_OUT_HIGH   //GPIO2: PreAMP_EN(H:Mute -> set low)
#define PIN_80_IS_GPIO              GPIO_OUT_LOW    //GPIO5: MUTE_S(L:Mute -> set high)

#define PIN_84_IS_GPIO              GPIO_OUT_HIGH   //GPIO1: PWR_ON/OFF

#define PIN_81_IS_GPIO              GPIO_IN         //GPIO4: USB Port 0 Over Current Detect
#define PIN_102_IS_GPIO             GPIO_OUT_LOW

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8314Z1.h"
...
#define ARC_SUPPORT_PORT            2   //default is HDMI2
...
*/
  ...
  #elif(ENABLE_DTMB)//DTMB
    #define TS_CLK_INV                      0
    #define TS_SERIAL_OUTPUT_IF_CI_REMOVED  1
    #define FRONTEND_TUNER_TYPE             MxL_661SI_TUNER//SILAB_2158_TUNER
    #define FRONTEND_IF_MIXER_TYPE          XUGUANG_T126CWADC
    #define VIF_TUNER_TYPE                  1       // 0: RF Tuner; 1: Silicon Tuner
    #define VIF_SAW_ARCH                    2       // 0: Dual SAW; 1: external Single SAW; 2:silicon tuner(DIF); 3: no saw(VIF); 4: internal single SAW; 5: no SAW(DIF) ;6:silicon tuner(VIF)
  #else
...
#if ENABLE_ATSC
    #define FRONTEND_DEMOD_ATSC_TYPE             MSTAR_MSB1501_DEMODE
    #define TS_PARALLEL_ATSC_OUTPUT              0 // 0: Serial; 1: paralell
    ...
    #define TS_PARALLEL_ISDBT_OUTPUT              1
    #else
    #define TS_PARALLEL_ISDBT_OUTPUT              1
    #endif
...
#if ENABLE_SSC
#define MIU_SSC_SPAN_DEFAULT            25 // 350
#define MIU_SSC_STEP_DEFAULT            10 // 200
...
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_102 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_102)
...
#define ADC_KEY_1_L6                    0xC9//RFU
#define ADC_KEY_1_L7                    0xE0//RFU
