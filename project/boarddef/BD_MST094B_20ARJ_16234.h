...
#define BOARD_NAME                  "BD_MST094B_20ARJ_16234"
...
//------Input Source Mux--------------------------------------------------------
#define INPUT_VGA_MUX               INPUT_PORT_NONE_PORT
...
#define ENABLE_MxL661_GPO       ENABLE      // Only for melody 80pin new ic, for amp mute by MxL661 GPO.
...
// Audio Amplifier
//#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_12 )
//#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_12 )
...
// Config Tuner GPO to control AMP Mute.
#define Adj_Volume_On()                 MxL661_AMPMuteByConfigDevGPO(1) // 1:MXL661_PORT_HIGH  0:MXL661_PORT_LOW
#define Adj_Volume_Off()                MxL661_AMPMuteByConfigDevGPO(0)
#endif
//3D EN
#define Set_3D_ON()                      _FUNC_NOT_USED()
#define Set_3D_OFF()                     _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_56 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_56 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_66 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_66 )
