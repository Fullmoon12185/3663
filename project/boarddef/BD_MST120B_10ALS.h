...
#define PIN_159_IS_GPIO              GPIO_OUT_HIGH//GPIO49, AUDIO-EN (RT9116 Audio Amp Enable, L:Enable)  init: MUTE
...
#define PIN_32_IS_GPIO              GPIO_OUT_LOW//GPIO14, PANEL_ON_OFF (Panel Power Enable, L:On)
#define PIN_69_IS_GPIO              GPIO_OUT_HIGH//GPIO46, NORMAL_PWR-ON_OFF
#define PIN_70_IS_GPIO              GPIO_OUT_LOW        //Backlight Ctrl
...
#define LNB_EN_GPIO                     PIN_65
#define LNB_SEL_GPIO                    PIN_171
#endif
#endif
...
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_70 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_70 )
