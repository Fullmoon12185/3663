...
#define BOARD_NAME                  "BD_MST118B_10ALU"
...
#define PADS_MHLVBUS_MODE    MHLVBUS_MODE(4)//PAD_PWM1
...
#define PADS_SPDIF_OUT       SPDIF_OUT_MODE(3)//PAD_TCON0
...
#define PADS_FLASH_MODE      FLASH_MODE(1)       //NAND : 4 SPINAND : 2 SPIFLASH: 1
...
#define PIN_80_IS_GPIO             GPIO_OUT_LOW //(GPIO46,PAD_GPIO2): Audio Amp (H:Enable)
...
#define PIN_102_IS_GPIO              GPIO_OUT_LOW        //Backlight Ctrl

//------Chip Type---------------------------------------------------------------
#include "chip/MSD92LEUK1.h"
...
#define AUDIO_PATH_LINEOUT          AUDIO_PATH_MONITOROUT
