...
#define BOARD_NAME                  "BD_MST223B_D01A_S"
...
#define PIN_54_IS_GPIO             GPIO_IN              //(GPIO44,PAD_GPIO0): Tuner SDA
#define PIN_55_IS_GPIO             GPIO_IN              //(GPIO45,PAD_GPIO1): Tuner SCL
#define PIN_124_IS_GPIO           GPIO_OUT_LOW  //(GPIO92,PAD_GPIO24): Audio Amp (H:Enable)
#define PIN_121_IS_GPIO           GPIO_OUT_LOW  //(GPIO89,PAD_GPIO21): PreAMP_EN (H:Mute)
#define PIN_122_IS_GPIO           GPIO_IN              //(GPIO90,PAD_GPIO22): USB Port 0 Over Current Detect
#define PIN_123_IS_GPIO           GPIO_OUT_HIGH //(GPIO91,PAD_GPIO7): MUTE_S (L:Mute)
#define PIN_99_IS_GPIO              GPIO_OUT_HIGH //(GPIO61,PAD_GPIO17): PANEL_ON_OFF (L:On)
#define PIN_145_IS_GPIO            GPIO_OUT_HIGH //(GPIO54,PAD_GPIO10): NORMAL_PWR-ON_OFF (H:On)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_124 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_124 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_124 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_124 )
//3D EN
#define Set_3D_ON()                      _FUNC_NOT_USED()
#define Set_3D_OFF()                     _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_99 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_99 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_99 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_99 )
