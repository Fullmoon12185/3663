...
#define BOARD_NAME                      "BD_MST106B_10ARU_16115_ISDB_MELODY"
...
#define PIN_80_IS_GPIO              GPIO_OUT_HIGH  //(GPIO5,PAD_TCON5): I2S Audio Mute (L:Mute)
//#define PIN_87_IS_GPIO              GPIO_OUT_HIGH //(GPIO3,PAD_TCON3): Panel Power Enable (L:On)
#define PIN_53_IS_GPIO              GPIO_OUT_HIGH //(GPIO46,PAD_GPIO2): Audio Amp (H:Enable)
...
#define ARC_SUPPORT_PORT        2 //connect to UI port3 (ARC Port)
...
#define DEMO_TUNER_IIC_TYPE                 ONE_ROAD_BUS //DEMO_TO_TUNER
...
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_80 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_80 )

//3D EN
#define Set_3D_ON()                     _FUNC_NOT_USED()
#define Set_3D_OFF()                    _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_87 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_87)
