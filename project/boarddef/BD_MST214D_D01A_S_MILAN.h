...
#define BOARD_NAME                  "BD_MST214D_D01A_S"

#define PIN_SPI_CZ1                 PIN_204
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PIN_34
...
#define PADS_I2SOUT_MODE     I2SOUT_MODE(3)
...
#define PIN_80_IS_GPIO          GPIO_IN       	//GPIO44, Tuner_SDA
#define PIN_81_IS_GPIO          GPIO_IN       	//GPIO45, Tuner_SCL

#define PIN_43_IS_GPIO          GPIO_OUT_LOW    //GPIO74, AUDIO-EN      (MSH9010 Audio Amp Enable, H:Enable)  init: MUTE
#define PIN_46_IS_GPIO          GPIO_OUT_LOW    //GPIO77, PreAMP_EN    (Audio Mute, H:Mute -> set low)
#define PIN_44_IS_GPIO          GPIO_OUT_HIGH   //GPIO75, MUTE_S           (I2S Audio Mute, L:Mute -> set high)

#define PIN_45_IS_GPIO          GPIO_IN         //GPIO76, USB0_OCD_N (USB Port 0 Over Current Detect)
#define PIN_202_IS_GPIO         GPIO_OUT_LOW    //GPIO14, PANEL_ON_OFF (Panel Power Enable, L:On)
#define PIN_82_IS_GPIO          GPIO_OUT_HIGH   //GPIO46, NORMAL_PWR-ON_OFF

#define PIN_83_IS_GPIO          GPIO_IN         //GPIO47, HP_DET
#define PIN_215_IS_GPIO         GPIO_IN         //GPIO94, CABLE_DET

//------Chip Type---------------------------------------------------------------
#include "chip/MSD91G0LM.h"
...
#define SCART_ID1_SAR_CHAN          KEYPAD_ADC_CHANNEL_8    //Due to PAD_SAR1 set to do SCART Hsync.
...
#define AUDIO_SOURCE_DVI2           AUDIO_SOURCE_PC // default: AUDIO_SOURCE_PC
#define AUDIO_SOURCE_DVI3           AUDIO_SOURCE_PC // default: AUDIO_SOURCE_PC
...
#define AUDIO_PATH_SCART            AUDIO_T3_PATH_AUOUT2   // always output ATV/DTV sound
...
#define AUDIO_OUTPUT_MONITOROUT     AUDIO_AUOUT2_OUTPUT
#define AUDIO_OUTPUT_SCART          AUDIO_AUOUT0_OUTPUT  // define NULL when no used
#define AUDIO_OUTPUT_LINEOUT        AUDIO_NULL_OUTPUT
#define AUDIO_OUTPUT_SIFOUT         AUDIO_OUTPUT_SCART   // define AUDIO_OUTPUT_SCART when use
...
#define TS_CLK_INV                      0
#define TS_SERIAL_OUTPUT_IF_CI_REMOVED  0
#define FRONTEND_TUNER_TYPE             MxL_601SI_TUNER // MxL_601SI_TUNER	//NXP_FH2608_TUNER //NUTUNE_FK1602_TUNER
#define FRONTEND_IF_MIXER_TYPE          XUGUANG_T126CWADC //PHILIPS_FQD1216_TUNER
#define FRONTEND_IF_DEMODE_TYPE         MSTAR_INTERN_VIF  //PHILIPS_TDA9886 //MSTAR_VIF_MSB1210   //MSTAR_VIF //PHILIPS_TDA9886
#define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
...
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_43 ) // MSH9010 Audio Amp, ENABLE
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_43 )  // MSH9010 Audio Amp, MUTE

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_202 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_202 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_202 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_202 )
