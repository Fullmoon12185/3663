...
#define PIN_64_IS_GPIO              GPIO_OUT_LOW//GPIO109, AUDIO-EN (Audio Amp Enable, H:Enable) // init mute
...
#define PIN_97_IS_GPIO              GPIO_OUT_LOW//GPIO14, PANEL_ON_OFF (Panel Power Enable, L:On)
...
#define AUDIO_SOURCE_PC             AUDIO_AUIN5_INPUT       // no PC line_in, so connect to AV input
...
//------Tuner Setting-----------------------------------------------------------
    ...
    #define FRONTEND_TUNER_TYPE                 MxL_601SI_TUNER
...
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_64 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_64 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_97 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_97 )
