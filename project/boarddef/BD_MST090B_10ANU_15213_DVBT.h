...
#define BOARD_NAME                  "BD_MST090B_10ANU_15213_DVBT_WHISKY"

//#define PIN_FLASH_WP0               PIN_85
...
#define ARC_SUPPORT_PORT        2 //connect to UI port2 (ARC Port)
...
#define PADS_MHLVBUS_MODE           Unknown_pad_mux //MHLVBUS_MODE(4)//PAD_PWM1 <-- PAD PWM1 demo board use it as amp GPIO
...
#define PADS_SPDIF_OUT              SPDIF_OUT_MODE(3)//SPDIF_OUT_MODE(3)//PAD_TCON0
...
#define PIN_84_IS_GPIO              GPIO_OUT_HIGH //(GPIO1,PAD_TCON1): Normal Power Enable (H:On)
//#define PIN_101_IS_GPIO             GPIO_IN //SAR0 Keypad
#define PIN_102_IS_GPIO             GPIO_OUT_LOW //VBL_CTRL BACKLIGHT ON OFF
#define PIN_82_IS_GPIO              GPIO_OUT_LOW //(GPIO3,PAD_TCON3): Panel Power Enable (L:On)
#define PIN_87_IS_GPIO              GPIO_OUT_HIGH //(GPIO46,PAD_GPIO2): Audio Amp (H:Enable)

//#define PIN_83_IS_GPIO              GPIO_OUT_HIGH//(GPIO2,PAD_TCON2): Audio Mute (H:Mute)
#define PIN_81_IS_GPIO              GPIO_IN              //(GPIO4,PAD_TCON4): USB Port 0 Over Current Detect
#define PIN_80_IS_GPIO              GPIO_OUT_LOW  //(GPIO5,PAD_TCON5): I2S Audio Mute (L:Mute)
#define PIN_85_IS_GPIO              GPIO_OUT_HIGH //(GPIO0,PAD_TCON0): Flash WP Enable (L:On)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8314N.h"
...
#define DEMOD_IF_KHz                    5000 //5380
#define DEMOD_IQSWAP                    0 //1
...
// Audio Amplifier
#define Audio_Amplifier_ON()            _FUNC_NOT_USED()//mdrv_gpio_set_high( PIN_87 )
#define Audio_Amplifier_OFF()           _FUNC_NOT_USED()//mdrv_gpio_set_low( PIN_87 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_87 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_87 )
//3D EN
#define Set_3D_ON()                     _FUNC_NOT_USED()
#define Set_3D_OFF()                    _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_82 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_82 )
#define Panel_Backlight_VCC_ON()        MDrv_WriteByte(0x01424, 0x2)//mdrv_gpio_set_high( PIN_102 )
#define Panel_Backlight_VCC_OFF()       MDrv_WriteByte(0x01424, 0x0);//mdrv_gpio_set_low( PIN_102 )
...
#define ADC_CH2_LEVELS                  8 //### must be <= ADC_KEY_LEVEL
#define ADC_CH3_LEVELS                  8 //### must be <= ADC_KEY_LEVEL
#define ADC_CH4_LEVELS                  8 //### must be <= ADC_KEY_LEVEL

#define ADC_KEY_1_L0                    0x01//0x27
#define ADC_KEY_1_L1                    0x20//0x47
#define ADC_KEY_1_L2                    0x3D//0x63
#define ADC_KEY_1_L3                    0x5C//0x7B
#define ADC_KEY_1_L4                    0x85//RFU
#define ADC_KEY_1_L5                    0x9A//RFU
#define ADC_KEY_1_L6                    0xB8//RFU
#define ADC_KEY_1_L7                    0xCE//RFU
...
#define BD_LVDS_CONNECT_TYPE            1 //0:156, 1: 100,128
