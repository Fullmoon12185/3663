...
#define BOARD_NAME                  "BD_MST242A_D01A_S_MELODY"

#define PIN_FLASH_WP0               PIN_66 //PAD_SAR1
...
#define HDMI_DRIVER_PACKET_TYPE         E_PACKAGE_TYPE_QFP80
...
#define PIN_53_IS_GPIO              GPIO_IN              //(GPIO1,PAD_TCON1): Tuner SDA
#define PIN_52_IS_GPIO              GPIO_IN              //(GPIO2,PAD_TCON2): Tuner SCL
#define PIN_12_IS_GPIO              GPIO_OUT_LOW  //(GPIO106,PADA_HSYNC1): Audio Amp (H:Enable)
#define PIN_56_IS_GPIO              GPIO_OUT_HIGH //(GPIO14,PAD_PWM1): PANEL_ON_OFF (L:On)
#define PIN_66_IS_GPIO              GPIO_OUT_HIGH //(GPIO74,PAD_SAR1): Flash WP Enable (L:On)
#define PIN_54_IS_GPIO              GPIO_OUT_HIGH //(GPIO0,PAD_TCON0): NORMAL_PWR-ON_OFF (H:On)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD91RKNx.h"
...
#define INPUT_AV_YMUX               INPUT_PORT_NONE_PORT
...
#define INPUT_HDMI2_MUX             INPUT_PORT_NONE_PORT
#define INPUT_HDMI3_MUX             INPUT_PORT_NONE_PORT
// For special case
#define INPUT_HDMI1_DDC_PORT        E_XC_PROG_DVI0_EDID
...
#define Switch_DVI()                MApi_XC_DVI_SwitchSrc(INPUT_PORT_DVI1)
#define Switch_DVI2()               _FUNC_NOT_USED()
...
#define ARC_SUPPORT_PORT            0 // ARC is NOT supported in Melody 242A
...
// Audio Amplifier
//#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_12 )
//#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_12 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_12 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_12 )
//3D EN
#define Set_3D_ON()                      _FUNC_NOT_USED()
#define Set_3D_OFF()                     _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_56 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_56 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_56 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_56 )
...
#define ADC_KEY_1_L1_FLAG               IRKEY_MENU
#define ADC_KEY_1_L2_FLAG               IRKEY_VOLUME_MINUS
#define ADC_KEY_1_L3_FLAG               IRKEY_SELECT
#define ADC_KEY_1_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L7_FLAG               IRKEY_DUMY//RFU
...
#define ADC_KEY_2_L0_FLAG               IRKEY_POWER
#define ADC_KEY_2_L1_FLAG               IRKEY_INPUT_SOURCE
#define ADC_KEY_2_L2_FLAG               IRKEY_VOLUME_PLUS//IRKEY_RIGHT
#define ADC_KEY_2_L3_FLAG               IRKEY_CHANNEL_MINUS//IRKEY_DOWN
#define ADC_KEY_2_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L7_FLAG               IRKEY_DUMY//RFU
