...
#define BOARD_NAME                  "BD_XL3_MEGA_NASA"

//------MHL Setting-----------------------------------------------------------
#define ENABLE_MHL                  DISABLE//ENABLE
...
#define PADS_UART2_MODE             PAD_GPIO0//Unknown_pad_mux //PAD_GPIO0 or PAD_GPIO1
...
#define PADS_MHL_CBUS               Unknown_pad_mux//MHL_CBUS_MODE1
#define PADS_MHL_VBUS               Unknown_pad_mux//MHL_VBUS_MODE1 //PAD_GPIO2
#define PADS_MHL_DEBUG              Unknown_pad_mux //PAD_GPIO0
#define PADS_MHL_DET                Unknown_pad_mux//PAD_MHL_DET //PAD_MHL_DET
...
#define PADS_I2S_OUT                I2S_OUT_MODE5//Unknown_pad_mux
#define PADS_SPDIF_IN               Unknown_pad_mux //PAD_GPIO7
#define PADS_SPDIF_OUT              PAD_TCON1 //PAD_PWM1,PAD_TCON0, PAD_GPIO4, PAD_TCON1
...
#define PIN_100_IS_GPIO              GPIO_IN   //TCON7: ECO_SCL
#define PIN_101_IS_GPIO              GPIO_IN   //TCON6: ECO_SDA

#define PIN_121_IS_GPIO             GPIO_OUT_LOW   //GPIO89: SW_POWER

#define PIN_54_IS_GPIO              GPIO_IN         //GPIO44: TDB_RANET
#define PIN_55_IS_GPIO              GPIO_IN         //GPIO45: RDB_FANET
#define PIN_95_IS_GPIO              GPIO_OUT_LOW   //LCK: SW_PVCC    //Panel 13V H:On L:Off
#define PIN_96_IS_GPIO              GPIO_OUT_HIGH   //LDE: STB_CHECK    //H:STB Initial L:STB Ready
#define PIN_98_IS_GPIO              GPIO_IN   //IDENT_COMP1   //H: Connect L:Normal
#define PIN_99_IS_GPIO              GPIO_IN   //GPIO61: IDENT_VIDEO1 //H: Connect L:Normal
#define PIN_102_IS_GPIO             GPIO_OUT_HIGH   //TCON5: LED_STB //H: Key LED on, L: Key LED off

#define PIN_113_IS_GPIO             GPIO_OUT_HIGH   //GPIO96: UNDER_DRIVER H: BLU brightness normal, L: BLU 70%
#define PIN_114_IS_GPIO             GPIO_OUT_HIGH    //GPIO97: SW_INVERTER H: BL off, L: BL on
#define PIN_116_IS_GPIO             GPIO_IN   //GPIO98: MODE_SEL2 //H: VESA, L:Jeida
#define PIN_117_IS_GPIO             GPIO_IN   //GPIO99: MODE_SEL0 //H: HD panel, L:FHD panel
#define PIN_120_IS_GPIO             GPIO_OUT_HIGH    //GPIO88: SPI_WP0 H:Write Enable L:Write disable
#define PIN_124_IS_GPIO             GPIO_OUT_LOW    //GPIO92: UART_SEL H: USB con<-->FANET path
#define PIN_125_IS_GPIO             GPIO_OUT_HIGH    //GPIO93: USB0_EN  H: USB power on. L: USB power off
#define PIN_126_IS_GPIO             GPIO_OUT_LOW   //GPIO94: new hotplug pin to replace hotplugA
#define PIN_135_IS_GPIO             GPIO_IN    //GPIO101: POWER_DET  H: Power normal L: power abnormal
#define PIN_137_IS_GPIO             GPIO_IN    //GPIO103: IDENT_HDMI2 //H: Connect L:Not Connect
#define PIN_138_IS_GPIO             GPIO_IN    //GPIO104: IDENT_HDMI1 // H: Connect L:Not Connect

//Audio AMP related
#define PIN_104_IS_GPIO             GPIO_IN   //TCON3: AMP_SCL
#define PIN_105_IS_GPIO             GPIO_IN   //TCON2: AMP_SDA
#define PIN_103_IS_GPIO             GPIO_OUT_LOW   //TCON4: AMP_RESET //H: Normal, L: Reset
#define PIN_107_IS_GPIO             GPIO_OUT_LOW   //TCON0: S_AMP_MUTE //H: AMP Mute, L: Mute off

//Tuner related
#define PIN_63_IS_GPIO              GPIO_IN   //GPIO52: TUNER_SDA
#define PIN_64_IS_GPIO              GPIO_IN   //GPIO53: TUNER_SCL
#define PIN_56_IS_GPIO              GPIO_OUT_LOW   //GPIO46: TUNER_NRESET

//Tcon  related
#define PIN_123_IS_GPIO             GPIO_IN    //GPIO91: TCON_SDA
#define PIN_122_IS_GPIO             GPIO_IN   //GPIO90: TCON_SCL
#define PIN_97_IS_GPIO              GPIO_OUT_LOW   //TCON_WP   //L:Normal


//------Chip Type---------------------------------------------------------------
#include "chip/MSD8316ZB1.h"
...
//------Input Source Mux--------------------------------------------------------
#define INPUT_VGA_MUX               INPUT_PORT_NONE_PORT//INPUT_PORT_ANALOG0
#define INPUT_VGA_SYNC_MUX          INPUT_PORT_NONE_PORT//INPUT_PORT_ANALOG0_SYNC //SYNC port of VGA. There is a case which data and sync use different port.
#define INPUT_YPBPR_MUX             INPUT_PORT_ANALOG0//INPUT_PORT_YMUX_G0//INPUT_PORT_ANALOG1
#define INPUT_YPBPR2_MUX            INPUT_PORT_NONE_PORT
#define INPUT_TV_YMUX               INPUT_PORT_YMUX_CVBS0
#define INPUT_AV_YMUX               INPUT_PORT_YMUX_G0//INPUT_PORT_ANALOG0_SYNC//INPUT_PORT_YMUX_CVBS0
#define INPUT_AV2_YMUX              INPUT_PORT_NONE_PORT//INPUT_PORT_YMUX_CVBS1
...
#define INPUT_SCART_FB_MUX          INPUT_PORT_NONE_PORT//SCART_FB1
...
#define AUDIO_SOURCE_PC             AUDIO_NULL_INPUT//AUDIO_AUIN4_INPUT
#define AUDIO_SOURCE_YPBPR          AUDIO_AUIN5_INPUT//AUDIO_AUIN4_INPUT
...
//------Tuner Setting-----------------------------------------------------------
    ...
    #define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
  #elif (DTV_SYSTEM_SEL ==DTV_SYSTEM_SBTVD)
    #define USE_UTOPIA						ENABLE
    #define FRONTEND_DEMOD_TYPE 			EMBEDDED_ISDBT_DEMOD
    #define FRONTEND_SECOND_DEMOD_TYPE		MSTAR_NONE_DEMOD
  #else
    #define FRONTEND_DEMOD_TYPE             EMBEDDED_DVBT_DEMOD
    #define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
  ...
  #if (DTV_SYSTEM_SEL ==DTV_SYSTEM_SBTVD)
    #define FRONTEND_TUNER_TYPE             MxL_661SI_TUNER
   ...
   #if (FRONTEND_DEMOD_TYPE == DIB_DiB8006GP_DEMOD)
    #define TS_PARALLEL_OUTPUT              1
   #else
    #define TS_PARALLEL_OUTPUT              1
   #endif
  #elif(DTV_SYSTEM_SEL == DTV_SYSTEM_DTMB)//DTMB
    #define TS_CLK_INV                      0
    #define TS_PARALLEL_OUTPUT              1
    #define TS_SERIAL_OUTPUT_IF_CI_REMOVED  1
    #define FRONTEND_TUNER_TYPE             MxL_661SI_TUNER
...
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_107 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_107 )



#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_95 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_95 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_114 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_114 )

#define BACKLIGHT_INVERSE               ENABLE
#define Panel_BackLight_Invese(x)      (PWM1_PERIOD-x)    //perioud should be the same as PWM channel
...
#define KEYPAD_STABLE_NUM_MIN        45 //Modify for sec keypad
...
#define KEYPAD_CH1_LB                   0xE0//0x80
...
#if 1/*CUSTMOER keypad For B2*/

#define ADC_CH1_LEVELS 3 //### must be <= ADC_KEY_LEVEL
#define ADC_CH2_LEVELS 4 //### must be <= ADC_KEY_LEVEL

#define ADC_KEY_1_L0 0x7D
#define ADC_KEY_1_L1 0xC6
#define ADC_KEY_1_L2 0x02
#define ADC_KEY_1_L3 0x00
#define ADC_KEY_1_L4 0x00
#define ADC_KEY_1_L5 0x00
#define ADC_KEY_1_L6 0x00
#define ADC_KEY_1_L7 0x00

#define ADC_KEY_2_L0 0x02
#define ADC_KEY_2_L1 0x41
#define ADC_KEY_2_L2 0xC6
#define ADC_KEY_2_L3 0x7D
#define ADC_KEY_2_L4 0x00
#define ADC_KEY_2_L5 0x00
#define ADC_KEY_2_L6 0x00
#define ADC_KEY_2_L7 0x00

#define ADC_CH3_LEVELS 0 //### must be <= ADC_KEY_LEVEL
#define ADC_CH4_LEVELS 0 //### must be <= ADC_KEY_LEVEL
...
/*
                                   [KEY2]                        |                 [KEY1]
               SOURCE        MENU          V+          V-        |        CH+        CH-        POWER
KEY INPUT1(V)  3.3           3.3           3.3         3.3       |        1.6        2.5        0
KEY INPUT2(V)  0             0.85          2.5         1.6       |        3.3        3.3        3.3
SPEC(V)        0-3.3         0.3-1.2       2.2-3.3     1.2-2.2   |        1.2-2.2    2.2-3.3    0-0.3
*/
#define ADC_KEY_1_L0_FLAG IRKEY_CHANNEL_PLUS
#define ADC_KEY_1_L1_FLAG IRKEY_CHANNEL_MINUS
#define ADC_KEY_1_L2_FLAG IRKEY_POWER
#define ADC_KEY_1_L3_FLAG IRKEY_DUMY
#define ADC_KEY_1_L4_FLAG IRKEY_DUMY
#define ADC_KEY_1_L5_FLAG IRKEY_DUMY
#define ADC_KEY_1_L6_FLAG IRKEY_DUMY
#define ADC_KEY_1_L7_FLAG IRKEY_DUMY

#define ADC_KEY_2_L0_FLAG IRKEY_SELECT
#define ADC_KEY_2_L1_FLAG IRKEY_MENU
#define ADC_KEY_2_L2_FLAG IRKEY_VOLUME_PLUS
