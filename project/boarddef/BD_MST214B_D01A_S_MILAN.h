...
#define BOARD_NAME                  "BD_MST214B_D01A_S"

#define PIN_SPI_CZ1                     PIN_125
#define PIN_SPI_CZ2                     0
#define PIN_SPI_CZ3                     0
#define PIN_FLASH_WP0               PIN_119
...
#define PIN_58_IS_GPIO          GPIO_IN       	//GPIO44, Tuner_SDA
#define PIN_59_IS_GPIO          GPIO_IN       	//GPIO45, Tuner_SCL

#define PIN_79_IS_GPIO          GPIO_OUT_LOW    //GPIO109, AUDIO-EN (MSH9010 Audio Amp Enable, H:Enable)  init: MUTE
#define PIN_80_IS_GPIO          GPIO_OUT_LOW    //GPIO108, PreAMP_EN (Audio Mute, H:Mute -> set low)
#define PIN_77_IS_GPIO          GPIO_OUT_HIGH   //GPIO111, MUTE_S       (I2S Audio Mute, L:Mute -> set high)

#define PIN_78_IS_GPIO          GPIO_IN         //GPIO110, USB0_OCD_N (USB Port 0 Over Current Detect)
#define PIN_123_IS_GPIO         GPIO_OUT_LOW    //GPIO14, PANEL_ON_OFF (Panel Power Enable, L:On)
#define PIN_60_IS_GPIO          GPIO_OUT_HIGH   //GPIO46, NORMAL_PWR-ON_OFF

#define PIN_35_IS_GPIO          GPIO_IN         //GPIO197, HP_DET
#define PIN_132_IS_GPIO         GPIO_IN         //GPIO94, CABLE_DET

//------Chip Type---------------------------------------------------------------
#include "chip/MSD91G0BMN.h"
...
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_79 ) // MSH9010 Audio Amp, ENABLE
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_79 )  // MSH9010 Audio Amp, MUTE

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_123 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_123 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_123 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_123 )
