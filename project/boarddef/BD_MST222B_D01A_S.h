...
#define BOARD_NAME                  "BD_MST222B_D01A_S"
...
#define PIN_FLASH_WP0               PIN_99//PIN_133 (Optional, default : 0) => because been used by PWR
...
#define PADS_TCON_CONFIG            0x0007FB //TCON0~TCON10
...
#define PIN_94_IS_GPIO             GPIO_OUT_LOW
#define PIN_96_IS_GPIO             GPIO_OUT_HIGH
#define PIN_98_IS_GPIO             GPIO_OUT_LOW
#define PIN_99_IS_GPIO             GPIO_OUT_HIGH
#define PIN_115_IS_GPIO            GPIO_OUT_LOW
#define PIN_116_IS_GPIO            GPIO_OUT_LOW //VBL_CTRL
#define PIN_63_IS_GPIO             GPIO_IN  //demond iic
#define PIN_64_IS_GPIO             GPIO_IN  //demond iic
#define PAD_TCON2_IS_GPIO          GPIO_OUT_HIGH
...
#define DEMOD_IF_KHz                    5000
#define DEMOD_IQSWAP                    0
#elif ((FRONTEND_TUNER_TYPE == SILAB_2158_TUNER)||(FRONTEND_TUNER_TYPE == SILAB_2158_TUNER_A20))
#define VIF_SAW_ARCH                    6                   // 0: Dual SAW; 1: external Single SAW; 2:silicon tuner; 3: no saw(VIF); 4: internal single SAW; 5: no SAW(DIF)
#define VIF_TUNER_TYPE                  1                   // 0: RF Tuner; 1: Silicon Tuner
...
// Audio Amplifier
#define Audio_Amplifier_ON()            //mdrv_gpio_set_high( PIN_97 )
#define Audio_Amplifier_OFF()           //mdrv_gpio_set_low( PIN_97 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_97 )//mdrv_gpio_set_low( PIN_61 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_97 )//mdrv_gpio_set_high( PIN_61 )

//3D EN
#define Set_3D_ON()                     _FUNC_NOT_USED()
#define Set_3D_OFF()                    _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_121 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_121 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_121 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_121 )
