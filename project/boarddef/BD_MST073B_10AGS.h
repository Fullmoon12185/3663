...
#define BOARD_NAME                  "BD_MST073B_10AGS"
...
#else
#define PADS_UART3_MODE      UART3_MODE(1)
#endif
...
#define PIN_72_IS_GPIO              GPIO_IN       //GPIO49, HDMI0 ARC DETECT
#define PIN_159_IS_GPIO             GPIO_OUT_HIGH //GPIO56, PreAMP_EN (Audio Mute, H:Mute -> set low)
...
#define PIN_165_IS_GPIO             GPIO_OUT_LOW  //
#if (!ENABLE_UART2)
#define PIN_69_IS_GPIO              GPIO_OUT_HIGH //GPIO46, NORMAL_PWR-ON_OFF
#endif
#define PIN_70_IS_GPIO              GPIO_OUT_LOW //GPIO47,  VBL_CTRL   L:Disable,H:Enable
#define PIN_178_IS_GPIO             GPIO_IN       //GPIO94, MHL CABLE_DET
//#define PIN_175_IS_GPIO           GPIO_OUT_HIGH //GPIO96, PCMCIA Power Control
#define PIN_32_IS_GPIO              GPIO_OUT_LOW //VSYNC2, PANEL_ON/OFF   H:ON,L:OFF
//------Chip Type---------------------------------------------------------------
#include "chip/MSD91G0SM.h"
...
#define INPUT_SV_CMUX               INPUT_PORT_CMUX_R1
...
#define AUDIO_PATH_HP               AUDIO_PATH_NULL // milan 073B, set NULL, HP out is the same as speaker out, so only control speaker
...
#define AUDIO_PATH_LINEOUT          AUDIO_PATH_NULL // line out, milan 073B, set NULL, beacuse line out hawware ouput port is the same as scart out, this customer need control scart out, so not control line out
#define AUDIO_PATH_SIFOUT           AUDIO_T3_PATH_AUOUT3
#define AUDIO_PATH_SCART1           AUDIO_T3_PATH_AUOUT3 // scart out

#define AUDIO_OUTPUT_MAIN_SPEAKER   AUDIO_AUOUT1_OUTPUT
#define AUDIO_OUTPUT_HP             AUDIO_NULL_OUTPUT   // milan 073B, set NULL, HP out is the same as speaker out, so only control speaker        // default: AUDIO_HP_OUTPUT, if no headphone output, define NULL
#define AUDIO_OUTPUT_MONITOROUT     AUDIO_NULL_OUTPUT
#define AUDIO_OUTPUT_SCART          AUDIO_NULL_OUTPUT  // define NULL when no used
#define AUDIO_OUTPUT_LINEOUT        AUDIO_AUOUT3_OUTPUT // line out
#define AUDIO_OUTPUT_SIFOUT         AUDIO_AUOUT3_OUTPUT // scart out
...
#if( ENABLE_DVB_T2 )
    #define FRONTEND_DEMOD_T2_TYPE              EMBEDDED_DVBT2_DEMOD
    #define TS_PARALLEL_DVBT2_OUTPUT            1 // 0: Serial; 1: paralell
    #define DEMOD_DVBT2_USE_UTOPIA              1
#else
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_159 )// mdrv_gpio_set_high( PIN_72 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high (PIN_159 ) // mdrv_gpio_set_low( PIN_72 )

#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_161 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_161 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high (PIN_32 )//mdrv_gpio_set_low (PIN_32 ) // mdrv_gpio_set_low( PIN_165 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_32 )//mdrv_gpio_set_high( PIN_32 ) // mdrv_gpio_set_high( PIN_165 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_70 ) // mdrv_gpio_set_low( PIN_165 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_70 ) // mdrv_gpio_set_high( PIN_165 )
