...
#define BOARD_NAME                  "BD_MST269F_D01A_S_MARLON"

#define PIN_SPI_CZ1                     PIN_167
#define PIN_SPI_CZ2                     0
#define PIN_SPI_CZ3                     0
#define PIN_FLASH_WP0               PIN_159
...
#define PIN_66_IS_GPIO      GPIO_OUT_HIGH//GPIO47, AUDIO-EN (RT9116 Audio Amp Enable, L:Enable)  init: MUTE
#define PIN_67_IS_GPIO      GPIO_OUT_LOW //GPIO48, PreAMP_EN (Audio Mute, H:Mute -> set low)
#define PIN_72_IS_GPIO      GPIO_OUT_HIGH//GPIO51, MUTE_S (I2S Audio Mute, L:Mute -> set high)
#define PIN_71_IS_GPIO      GPIO_IN           //GPIO50, USB0_OCD_N (USB Port 0 Over Current Detect)
#define PIN_168_IS_GPIO    GPIO_OUT_LOW//GPIO14, PANEL_ON_OFF (Panel Power Enable, L:On)
#define PIN_65_IS_GPIO      GPIO_OUT_HIGH//GPIO46, NORMAL_PWR-ON_OFF
#define PIN_158_IS_GPIO    GPIO_IN            //GPIO19, HP_DET
#define PIN_159_IS_GPIO    GPIO_OUT_HIGH //GPIO18, SPI_Flash WP
#define PIN_160_IS_GPIO    GPIO_OUT_HIGH //GPIO17, PCMCIA Power Control
#define PIN_163_IS_GPIO    GPIO_OUT_LOW //GPIO2, MHL_VBUS-EN
//#define PIN_161_IS_GPIO    GPIO_OUT_HIGH //GPIO16, MHL_OCB
...
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_66 ) // RT9116 Audio Amp, ENABLE
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_66 ) // RT9116 Audio Amp, MUTE

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_168 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_168 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_168 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_168 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_low( PIN_160 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_high( PIN_160 )
