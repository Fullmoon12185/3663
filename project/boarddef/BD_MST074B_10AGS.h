...
#define MHLVBUS_MODE(X)         X //1: PAD_GPIO24, 2: PAD_GPIO33, 3: PAD_TCON2, 4: PAD_TCON0
...
#define SPDIF_IN_MODE(X)        X //1: PAD_GPIO35
#define SPDIF_OUT_MODE(X)       X //1: PAD_PM_SPI_CZ2, 2: PAD_NAND_AD3
...
#define FLASH_MODE(X)           X //1: SPINOR, 2: SPINAND, 3:NAND, 4: NANDSHARE
...
#define PADS_MHLVBUS_MODE    MHLVBUS_MODE(3)
#define PADS_MHLDBG_MODE     Unknown_pad_mux
#define PADS_MHLDET_MODE     MHLDET_MODE(1)
#define PADS_DDCDA_MODE      DDCDA_MODE(2)
#define PADS_DDCDB_MODE      DDCDB_MODE(2)
#define PADS_DDCDC_MODE      DDCDC_MODE(2)
...
#define PADS_PCMPE_MODE     Unknown_pad_mux
#define PADS_PCMCTRL_MODE    Unknown_pad_mux
#define PADS_PCMAD_MODE      Unknown_pad_mux
#define PADS_TS0_MODE        Unknown_pad_mux
#define PADS_TS1_MODE        Unknown_pad_mux
#define PADS_TSD_MODE        Unknown_pad_mux
...
#define PIN_52_IS_GPIO              GPIO_IN       	//GPIO44, Tuner_SDA
#define PIN_53_IS_GPIO              GPIO_IN       	//GPIO45, Tuner_SCL
#define PIN_64_IS_GPIO              GPIO_OUT_HIGH//GPIO109, AUDIO-EN (Audio Amp Enable, H:Enable)
#define PIN_65_IS_GPIO              GPIO_OUT_LOW //GPIO104, PreAMP_EN (Audio Mute, H:Mute -> set low)
#define PIN_62_IS_GPIO              GPIO_OUT_HIGH//GPIO111, MUTE_S    (I2S Audio Mute, L:Mute -> set high)
#define PIN_63_IS_GPIO              GPIO_IN             //GPIO110, USB0_OCD_N (USB Port 0 Over Current Detect)
#define PIN_97_IS_GPIO              GPIO_OUT_LOW //GPIO_OUT_HIGH//GPIO14, PANEL_ON_OFF (Panel Power Enable, L:On)
#define PIN_93_IS_GPIO              GPIO_OUT_HIGH//GPIO0, NORMAL_PWR-ON_OFF
#define PIN_104_IS_GPIO             GPIO_IN             //GPIO94, CABLE_DET
#define PIN_61_IS_GPIO              GPIO_OUT_HIGH
#define PIN_106_IS_GPIO             GPIO_OUT_LOW //GPIO_OUT_HIGH

//------Chip Type---------------------------------------------------------------
#include "chip/MSD91G0UN.h"
...
//#define FLASH_SIZE                  FLASH_SIZE_4MB //depend on SW_Config
...
#define SCART_ID1_SAR_CHAN          0xFF    //Due to PAD_SAR1 set to do SCART Hsync.
...
#define AUDIO_PATH_HP               AUDIO_PATH_NULL // milan 074B no HP out
...
#define AUDIO_PATH_LINEOUT          AUDIO_T3_PATH_AUOUT2 // line out
...
#define AUDIO_OUTPUT_HP             AUDIO_NULL_OUTPUT // milan 074B no HP out
#define AUDIO_OUTPUT_MONITOROUT     AUDIO_NULL_OUTPUT
#define AUDIO_OUTPUT_SCART          AUDIO_NULL_OUTPUT  // define NULL when no used
#define AUDIO_OUTPUT_LINEOUT        AUDIO_AUOUT2_OUTPUT // line out
...
#define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
#endif
#define FRONTEND_TUNER_TYPE             SILAB_2151_TUNER // MxL_601SI_TUNER	//NXP_FH2608_TUNER //NUTUNE_FK1602_TUNER
#define FRONTEND_IF_MIXER_TYPE          XUGUANG_T126CWADC //PHILIPS_FQD1216_TUNER
#define FRONTEND_IF_DEMODE_TYPE         MSTAR_INTERN_VIF  //PHILIPS_TDA9886 //MSTAR_VIF_MSB1210   //MSTAR_VIF //PHILIPS_TDA9886
//#define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
#endif
...
#define FRONTEND_IF_DEMODE_TYPE         MSTAR_INTERN_VIF  //PHILIPS_TDA9886 //MSTAR_VIF_MSB1210   //MSTAR_VIF //PHILIPS_TDA9886
    ...
    #define FRONTEND_DEMOD_S2_TYPE              EMBEDDED_DVBS_DEMOD//MSTAR_MSB131X_DVBS2//MSTAR_MSB124X_DVBT
    #define TS_PARALLEL_S2_OUTPUT               1 // 0: Serial; 1: paralell
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_61 )// mdrv_gpio_set_high( PIN_72 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high (PIN_61 ) // mdrv_gpio_set_low( PIN_72 )

#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_62 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_62 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_97 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_97 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_106 ) // mdrv_gpio_set_low( PIN_165 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_106 ) // mdrv_gpio_set_high( PIN_165 )
...
#define ADC_KEY_1_L0                    0x10 //0x10//0x27
#define ADC_KEY_1_L1                    0x30 //0x30//0x47
#define ADC_KEY_1_L2                    0x50 //0x50//0x63
#define ADC_KEY_1_L3                    0x78 //0x6A//0x7B
#define ADC_KEY_1_L4                    0x8F //0x00//RFU
#define ADC_KEY_1_L5                    0xB0 //0x00//RFU
#define ADC_KEY_1_L6                    0xC8 //0x00//RFU
#define ADC_KEY_1_L7                    0xE8 //0x00//RFU
...
#define ADC_KEY_1_L1_FLAG               IRKEY_CHANNEL_PLUS    //IRKEY_MENU
#define ADC_KEY_1_L2_FLAG               IRKEY_CHANNEL_MINUS   // IRKEY_LEFT
#define ADC_KEY_1_L3_FLAG               IRKEY_VOLUME_PLUS     //IRKEY_MUTE
#define ADC_KEY_1_L4_FLAG               IRKEY_VOLUME_MINUS    //IRKEY_DUMY//RFU
#define ADC_KEY_1_L5_FLAG               IRKEY_SELECT          //IRKEY_DUMY//RFU
#define ADC_KEY_1_L6_FLAG               IRKEY_INPUT_SOURCE    //IRKEY_DUMY//RFU
#define ADC_KEY_1_L7_FLAG               IRKEY_MENU            //IRKEY_DUMY//RFU
...
// enable To load DAC current mode
#define ADC_DACCURRENTMPDE          E_ADC_IDAC_FULL_MODE  // Full current mode
...
// T2 MCP Demod Reset
#define MCP_DEMOD_RESET_On()            _FUNC_NOT_USED()
#define MCP_DEMOD_RESET_Off()           _FUNC_NOT_USED()
...
#define D_DMD_IF_DVBT_8M        5000L
#define D_DMD_IF_DVBT_7M        5000L
#define D_DMD_IF_DVBT_6M        5000L
#define D_DMD_IF_DVBC_8M        5000L
#define D_DMD_IF_DVBC_7M        5000L
#define D_DMD_IF_DVBC_6M        5000L
#define D_DMD_TUNER_IQSWAP      1
#else
