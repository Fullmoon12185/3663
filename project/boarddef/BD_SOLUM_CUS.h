...
#define BOARD_NAME                  "BD_SOLUM_CUS"
...
#define PADS_SPDIF_OUT              Unknown_pad_mux //PIN_62
...
#define PADS_PWM1_MODE          PWM1_MODE(1)//PAD_PWM1 //Unknown_pad_mux //PAD_PWM1
...
#define PIN_104_IS_GPIO             GPIO_IN //AMP_SCL //Amp I2C
#define PIN_105_IS_GPIO             GPIO_IN //AMP_SDA //Amp I2C
#define PIN_107_IS_GPIO             GPIO_OUT_LOW //S_AMP_MUTE , H:AMP_MUTE DISABLE / L:AMP_MUTE ENABLE

//Tuner related
#define PIN_63_IS_GPIO              GPIO_IN   //TUNER_SDA
#define PIN_64_IS_GPIO              GPIO_IN   //TUNER_SCL
...
#define PIN_152_IS_GPIO             GPIO_OUT_LOW//HOTPLUG_A
#define PIN_151_IS_GPIO             GPIO_OUT_LOW//HOTPLUG_B
...
#define PIN_151_IS_GPIO             GPIO_OUT_HIGH//HOTPLUG_B
...
#define RM_EEPROM_TYPE                  RM_TYPE_24C64
#define DIGITAL_I2S_SELECT             AUDIO_I2S_TAS5747 //AUDIO_I2S_NONE
#define DIGITAL_I2S_AMP2                AUDIO_I2S_NONE
...
#define FRONTEND_TUNER_TYPE_2           0
#else
#define TS_CLK_INV                      0
#define TS_PARALLEL_OUTPUT              1
#define TS_SERIAL_OUTPUT_IF_CI_REMOVED  1
#define FRONTEND_TUNER_TYPE             MxL_661SI_TUNER//SILAB_2190B_TUNER //TCL_F20WT_3DD_E//NXP_FH2608_TUNER
#define FRONTEND_IF_DEMODE_TYPE         MSTAR_INTERN_VIF//SAMSUNG_SI21XX //MSTAR_INTERN_VIF  //PHILIPS_TDA9886 //MSTAR_VIF_MSB1210   //MSTAR_VIF //PHILIPS_TDA9886
#endif
#define FRONTEND_SECOND_DEMOD_TYPE      MSTAR_NONE_DEMOD
...
#define DEMOD_IF_KHz                    DEMOD_IF_KHz_TDA18275A
#define DEMOD_IQSWAP                    DEMOD_IQSWAP_TDA18275A
...
//------IR & Key Setting--------------------------------------------------------
#define IR_TYPE_SEL                     IR_TYPE_SAMSUNG_REMOTE//IR_TYPE_MSTAR_DTV // IR_TYPE_CUS03_DTV // IR_TYPE_NEW
...
#define ENABLE_SSC                      DISABLE//ENABLE
...
#define HDMIDetect()                    (mdrv_gpio_get_level(PIN_137))
#define HDMI2Detect()                   (mdrv_gpio_get_level(PIN_136))
...
#define KEYPAD_KEY_VALIDATION           2///3  Modify for keypad
#define KEYPAD_REPEAT_KEY_CHECK         KEYPAD_KEY_VALIDATION + 2
#define KEYPAD_REPEAT_KEY_CHECK_1       KEYPAD_KEY_VALIDATION + 3
#define KEYPAD_STABLE_NUM               50 //10 Modify for keypad
#define KEYPAD_STABLE_NUM_MIN           45 //9 Modify for keypad
