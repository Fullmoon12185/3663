...
#define BOARD_NAME                  "BD_MST089B_10ANB_15213_WHISKY"
...
#define ARC_SUPPORT_PORT        3 //connect to UI port2 (ARC Port)
...
#define PIN_59_IS_GPIO             GPIO_OUT_HIGH //(GPIO47,PAD_GPIO3): Audio Amp (H : MUTE  ON , L :  MUTE  OFF)
#define PIN_47_IS_GPIO             GPIO_OUT_HIGH //(Ear out R)
#define PIN_46_IS_GPIO             GPIO_OUT_HIGH //(Ear out L)
...
//#define PIN_109_IS_GPIO           GPIO_OUT_LOW   //VBL_CTRL BACKLIGHT ON OFF
...
#define PIN_129_IS_GPIO           GPIO_OUT_LOW  //(GPIO101,PAD_GPIO33): Panel Power Enable (L: OFF  , H: ON)
#define PIN_130_IS_GPIO           GPIO_OUT_HIGH //(GPIO102,PAD_GPIO34): Ear-phone Enable (H:On)
#define PIN_134_IS_GPIO           GPIO_OUT_LOW  //(H : BACKLIGHT  ON , L : BACKLIGHT  OFF , )
...
#define LVDS_PN_SWAP_L                  0x00 // if Backlight and Panel VCC is OK, Panel can not show anything, can try it .
#define LVDS_PN_SWAP_H                  0x00 // if Backlight and Panel VCC is OK, Panel can not show anything, can try it .
...
#define PANEL_SWAP_LVDS_POL             0 // if Backlight and Panel VCC is OK, Panel not show anything, can try it .
#define PANEL_SWAP_LVDS_CH              0
#define BD_LVDS_CONNECT_TYPE            0 //0:156, 1: 100,128  // if Backlight and Panel VCC is OK, Panel not show anything, can try it .
...
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_59 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_59 )
//3D EN
#define Set_3D_ON()                      _FUNC_NOT_USED()
#define Set_3D_OFF()                     _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_129 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_129 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_134 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_134 )
