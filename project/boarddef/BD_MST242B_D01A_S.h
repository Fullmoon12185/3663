...
#define BOARD_NAME                      "BD_MST242B_D01A_S_MELODY"
...
#define HDMI_DRIVER_PACKET_TYPE         E_PACKAGE_TYPE_QFP128
...
#define PADS_SPDIF_OUT              Unknown_pad_mux//SPDIF_OUT_MODE(3)//PAD_TCON0
...
#define PIN_51_IS_GPIO              GPIO_IN              //(GPIO44,PAD_GPIO0): Tuner SDA
#define PIN_52_IS_GPIO              GPIO_IN              //(GPIO45,PAD_GPIO1): Tuner SCL
#define PIN_83_IS_GPIO              GPIO_OUT_LOW//(GPIO2,PAD_TCON2): Audio Mute (H:Mute)
...
#define PIN_82_IS_GPIO              GPIO_OUT_HIGH //(GPIO3,PAD_TCON3): Panel Power Enable (L:On)
#define PIN_53_IS_GPIO              GPIO_OUT_LOW //(GPIO46,PAD_GPIO2): Audio Amp (H:Enable)
...
// Audio Amplifier
//#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_53 )
//#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_53 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_53 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_53 )
...
#define ADC_KEY_1_L0_FLAG               IRKEY_CHANNEL_PLUS//IRKEY_UP
#define ADC_KEY_1_L1_FLAG               IRKEY_MENU
#define ADC_KEY_1_L2_FLAG               IRKEY_VOLUME_MINUS//IRKEY_LEFT
#define ADC_KEY_1_L3_FLAG               IRKEY_SELECT//IRKEY_MUTE
#define ADC_KEY_1_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L7_FLAG               IRKEY_DUMY//RFU
