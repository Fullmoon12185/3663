...
#define BOARD_NAME                  "BD_MST222F_D01A_S"
...
#define PIN_63_IS_GPIO             GPIO_OUT_HIGH //PAD_GPIO2, POWER_ON (Active: High)
...
#define PIN_127_IS_GPIO           GPIO_OUT_HIGH //PAD_SAR2, Pre Amp,mute(Low: Mute) (Active: High)
#define PIN_128_IS_GPIO           GPIO_OUT_HIGH //PAD_SAR3, Class D Amp, enable(High Mute)
