...
//============================================================================
    ...
    #define BIN_ID_CODE_MHEG5           BIN_ID_CODE_MHEG5_A
      ...
      #if(ENABLE_HK_MP4)
        #define BIN_ID_CODE_VDPLAYER        BIN_ID_CODE_AEON_VDPLAYER_LITE_HK_MP4
      #else
        #define BIN_ID_CODE_VDPLAYER        BIN_ID_CODE_AEON_VDPLAYER_LITE
      #endif

    #elif(ENABLE_HK_MP4)
      #define BIN_ID_CODE_VDPLAYER        BIN_ID_CODE_AEON_VDPLAYER_HK_MP4
