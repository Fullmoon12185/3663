...
#ifndef _SW_CONFIG_TRUNK_MELODY_64M_ISDB_SZ_H_
#define _SW_CONFIG_TRUNK_MELODY_64M_ISDB_SZ_H_

#define SW_CONFIG_NAME              "SW_CONFIG_TRUNK_MELODY_64M_ISDB_SZ"
...
#define DTV_SYSTEM_SEL                  DTV_SYSTEM_SBTVD
...
#define ENABLE_SBTVD_BRAZIL_APP         ENABLE //DISABLE
#define ENABLE_SBTVD_BRAZIL_CM_APP      ENABLE //DISABLE
...
#if ENABLE_SBTVD_BRAZIL_APP
#define ENABLE_SELECT_NONESEARCH_CH
#endif
#if (ENABLE_DTV)
...
// ----  PROGRAM EDITOR  -----------------------------------------------------------------------
#define PRG_EDIT_INPUT_LCN_MOVE         ENABLE //DISABLE
//-----------------------------------------------------------------------------------------------------------
...
#define ENABLE_FM_RADIO    DISABLE//ENABLE
