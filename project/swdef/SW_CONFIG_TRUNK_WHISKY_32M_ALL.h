...
#if CHAKRA3_AUTO_TEST
#define ENABLE_DLC                      DISABLE
#define ENABLE_DBC                      DISABLE

#define MWE_FUNCTION                    DISABLE
#else
...
#if CHAKRA3_AUTO_TEST
#define ENABLE_SZ_FACTORY_OVER_SCAN_FUNCTION            DISABLE//factory overscan adjust enable usefull  //enable for DTG AFD test
#define ENABLE_SZ_DESIGN_OVER_SCAN_FUNCTION     DISABLE//design overscan adjust enable usefull
#define ENABLE_VD_PACH_IN_CHINA                         DISABLE
#define ENABLE_SHOW_PHASE_FACTORY         DISABLE
#define ENABLE_SHOW_PHASE_DESIGN         DISABLE
#else
