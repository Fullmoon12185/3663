...
#ifndef _SW_CONFIG_TRUNK_MELODY_64M_ATVMM_H_
#define _SW_CONFIG_TRUNK_MELODY_64M_ATVMM_H_

#define SW_CONFIG_NAME              "SW_CONFIG_TRUNK_MELODY_64M_ATVMM"
...
#define DTV_SYSTEM_SEL                      DTV_SYSTEM_NONE
...
//--------- ZUI, related with Panel resolution ----------------------------------
    ...
    #define UI_SKIN_SEL                 UI_SKIN_960X540X565
    #define MENU_LANGUAGE_LITE          ENABLE
#else
...
//----AUDIO----------------------------------------------------------------------
#define ENABLE_AUDIO_DEC_R2_BIN             DISABLE
#define ENABLE_AUDIO_DEC_R2_BIN_COMPRESS    DISABLE
...
//----MENU Config Reset----------------------------------------------------------
#define DAILEO_RESET_MANU_CONFIG        ENABLE
...
#define ENABLE_HK_LOAD_MM_VDEC              ENABLE
    ...
    #define ENABLE_MPLAYER_CAPTURE_LOGO     0  //enable it to store logo
    #define ENABLE_MPLAYER_CAPTURE_MUSIC    0  //enable it to store music
    #define ENABLE_MPLAYER_CAPTURE_MOVIE    0  //enable it to store Movie
...
//#else
#define ENABLE_ATV_CHINA_APP            ENABLE//DISABLE//ENABLE
//#endif
...
#define ENABLE_INDIA_OSD                    ENABLE
#else
...
#define SUPPORT_PVR_CRID                    FALSE //TRUE    // enable PVR DTG functions
...
// ----  PROGRAM EDITOR  -----------------------------------------------------------------------
#define PRG_EDIT_INPUT_LCN_MOVE         DISABLE
//-----------------------------------------------------------------------------------------------------------
...
#define ENABLE_PICTURE_NONLINEAR_CURVE      0
#define ENABLE_NONLINEAR_CURVE              0
...
#define ENABLE_DESIGN_POWER_ON_MODE                     ENABLE// ENABLE//DISABLE//ENABLE
...
#define ENABLE_PANEL_3D_ONOFF_CTRLBY6M30                0
...
#endif // #ifndef _SW_CONFIG_TRUNK_MELODY_64M_ATVMM_H_
