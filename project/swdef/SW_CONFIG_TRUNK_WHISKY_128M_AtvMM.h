...
#ifndef _SW_CONFIG_TRUNK_WHISKY_128M_ATVMM_H_
#define _SW_CONFIG_TRUNK_WHISKY_128M_ATVMM_H_

#define SW_CONFIG_NAME              "ATVMM"
...
#define DTV_SYSTEM_SEL                  DTV_SYSTEM_ATSC
...
#define ENABLE_HK_LOAD_MM_VDEC  ENABLE
	...
	#define EN_STYLE_STANDARD               DISABLE
	#define EN_STYLE_DYNAMIC                ENABLE   // dynamic display the menu item ,need enable COMPOSER_BMP_LOADER
...
//----PM_MODE-------------------------------------------------------------------
#define PM_MODE_SELECT                  PM_MODE_STANBY
...
#endif // _SW_CONFIG_TRUNK_WHISKY_128M_ATVMM_H_
