...
#ifndef _SW_CONFIG_TRUNK_MARLON_128M_H_
#define _SW_CONFIG_TRUNK_MARLON_128M_H_

#define SW_CONFIG_NAME              "MARLON_128M"
...
#if 0//(ENABLE_BOOT_SPEED_UP)
    #define ENABLE_AUDIO_DEC_R2_BIN_COMPRESS    0
#else
...
//-------------------------------------------------------------------------------
#ifndef ENABLE_NTSC
    #define ENABLE_NTSC DISABLE
#endif

#if((ENABLE_ISDBT)||(ENABLE_NTSC))
...
//#define ENABLE_EWS                      ENABLE
//#define ENABLE_SOUNDTEST_MUSIC_LOOP     ENABLE
...
#define ENABLE_PANEL_H_MIRROR   ENABLE
//#define ENABLE_TCON_BIN_IN_DB   DISABLE
//#define ENABLE_TCON_VER_20      1
#endif
...
#ifdef PROJ_CERTIFICATION_SGP_MDA
#undef CHINESE_SIMP_FONT_ENABLE
...
#ifdef ENABLE_128PIN_128M
    #define ENABLE_CI                       DISABLE
    #define ENABLE_CI_PLUS                  DISABLE
#elif (ENABLE_DVBT || ENABLE_DVBC || ENABLE_DTMB || ENABLE_ISDBT || ENABLE_ATV_CHINA_APP) //#ifdef DVB_SYSTEM
...
#define ENABLE_SUBTITLE_SWITCH_MENU     ENABLE_SUBTITLE
...
#define SCALER_USE_FBL_IN_DTV_H265_1080P_50P  1
...
#else
    #define DVB_T_C_DIFF_DB                 ENABLE//DISABLE // DVB-T and C use different two DB
#endif
...
#define PQ_OSD_BW_DISABLE_FOR_HD_PANEL    ENABLE // mantis 1353111 [HD panel][DTV 1080p] menu -> programme edit; menu -> source; video flash
...
//=========================================================================
// Thailand - NBTC DVB-T/T2
// Malaysia - MTSFB DVB-T/T2
// Indonesia - MCIT DVB-T/T2 + EWS
// Middle East - GCC DVB-T2(UAE)
//=========================================================================
#ifdef PROJ_CERTIFICATION_GROUP1
// Indonesia MCIT DVB-T/T2 + EWS Test
#define ENABLE_EWS                              ENABLE
#define ENABLE_SOUNDTEST_MUSIC_LOOP             ENABLE
#define ENABLE_SOUTHEAST_ASIA_CERTIFICATION     ENABLE

// Thailand NBTC DVB-T/T2 Test
#if VECTOR_FONT_ENABLE
#undef ENABLE_THAI_OSD
#define ENABLE_THAI_OSD                         ENABLE
#undef ENABLE_ARABIC_OSD
#define ENABLE_ARABIC_OSD                       ENABLE
#endif

#endif  //PROJ_CERTIFICATION_GROUP1

//=========================================================================
// CI+1.3
// New Zealand - Freeview
// Germany - Media Broadcast
// Finland/Norway - Canal Digital
//=========================================================================
#ifdef PROJ_CERTIFICATION_GROUP2

#define ENABLE_MEDIA_BROADCAST                  ENABLE      //for Media Broadcast

// Canal Digital
#define SAVE_AVPIDINVALID_PROGRAM               ENABLE //save program even if video/audio pid invalid

#endif  //PROJ_CERTIFICATION_GROUP2

//=========================================================================
// Sweden & Denmark - Boxer
// Ireland - Saorivew
// Norway - Riks
// Australia - AS4933(AU)
// Finland - Antenna Ready HD
// Germany - Unity Media
// Finland - Cable Ready HD
// France - Canal Ready CI+
// France - TNT HD
//=========================================================================
#ifdef PROJ_CERTIFICATION_GROUP3

// RiksTV
#define ENABLE_RIKS_TV_IRD_SETTING              ENABLE  // RiksTV spec ver2.0 p.15 of default IRD installation setting, test case: TC16032502012

// UnityMedia
#define ENABLE_UNITY_MEDIA_SETTING              ENABLE  // UnityMedia spec of default installation setting, test case: TC17020701332

// Antenna Ready HD
#define ENABLE_EPG_INFO_DISP_GENRE_TYPE         ENABLE  // mantis 1281457, test case: TC14060600057
#define ENABLE_FileIn_PMTMonitor                ENABLE  // mantis 1288338, test case: TC14060600063
#define ENABLE_SUBTITLE_SEL_PREFER_ONLY                 // mantis 1296558, test case: TC12122000080

// Cable Ready HD
#define ENABLE_CABLE_READY_SETTING              ENABLE  // CableReady Task 02.15+05.05, test case: TC16100300738, TC16100300741
// For NorDig-Unified_Test_specification_ver_2.2.2.pdf task
// 1. Nordic country and match its onid, keep the LCN, ignore the LCN of non-matched services
// 2. Nordic country and onid match one of nordic country, keep the LCN, ignore the LCN of non-nordic country
// 3. Neither nordic country nor any matched nordic onid, keep the LCN

#define ENABLE_COUNTRY_ICELANDIC                ENABLE  // CableReady Task 09.37, test case: TC16100300804
#define ENABLE_FORCE_PRESET_PASSWORD            ENABLE  // Canal Ready CI Plus-0035, test case: TC16071800039
#define ENABLE_CANAL_READY_CIPLUS_AUTH          ENABLE

#endif  //PROJ_CERTIFICATION_GROUP3

//=========================================================================
// Netherlands - Ziggo
//=========================================================================
#ifdef PROJ_CERTIFICATION_GROUP4

#define ENABLE_ZIGGO                            ENABLE

#endif  //PROJ_CERTIFICATION_GROUP4

//=========================================================================
// Ghana - Digital Thumb
// Vietnam - VNTA Backend
// Kenya - CCK DVB-T/T2
// Myanmar - MMR DVB-T/T2
//=========================================================================
#ifdef PROJ_CERTIFICATION_GROUP5

#define ENABLE_COUNTRY_GHANA                    ENABLE
#define ENABLE_COUNTRY_VIETNAM                  ENABLE
#define ENABLE_COUNTRY_KENYA                    ENABLE
#define ENABLE_COUNTRY_MYANMAR                  ENABLE

#define ENABLE_SUBTITLE_SEL_PREFER_ONLY               //mantis 1326852, test case: TC16082400006

#endif  //PROJ_CERTIFICATION_GROUP5

//=========================================================================
// RCS & RDS-C - Romania
// RCS & RDS-S - Romania
//=========================================================================
#ifdef PROJ_CERTIFICATION_GROUP6

#endif  //PROJ_CERTIFICATION_GROUP6
...
#define ENABLE_PARENTAL_GUIDANCE_CLASSIFICATION ENABLE
#define ENABLE_AFD_FOR_SGP_MDA                  ENABLE // mantis 1297143, [TC15051300144][Singapore MDA]Section 5.1 : AFD 4:3 in 16:9 Broadcasted Frame

#endif  //PROJ_CERTIFICATION_SGP_MDA

//#define ENABLE_DTV_CERTIFICATION_TNT        1

#ifndef ENABLE_EWS
  #if (MS_BOARD_TYPE_SEL == BD_MST269B_D01A_S_MARLON) // For Coverity test
    #define ENABLE_EWS  ENABLE
  #endif
#endif
...
#if (ENABLE_CI_PLUS)
#ifdef ENABLE_CI_V_1_4
    #define ENABLE_CI_PLUS_V1_4       ENABLE
#endif
#else
...
#if( defined(ENABLE_GAME)&& ENABLE_GAME )
#define ENABLE_GAME_BG_MUSIC            ENABLE

#if ( ENABLE_GAME_BG_MUSIC )
#define ENABLE_SOUNDTEST_MUSIC_LOOP     ENABLE
#endif  //ENABLE_GAME_BG_MUSIC

#define GAME_BOXMAN                     ENABLE
#define GAME_GOBANG                     ENABLE
#define GAME_SNAKE                      ENABLE
#define GAME_SUDOKU                     ENABLE
#define GAME_TETRIS                     ENABLE
#define GAME_MINES                      ENABLE
#define GAME_SHOT                       DISABLE//ENABLE
#endif  //( defined(ENABLE_GAME)&& ENABLE_GAME )
...
#define ENABLE_PQ_TABTYPE_XVYCC DISABLE
    ...
    #define ENABLE_SBTVD_DIRECT_TUNE  DISABLE
#else
    #define ENABLE_SBTVD_DIRECT_TUNE  DISABLE//ENABLE
#endif
#endif

//------HW ADC CALIBRATION-----------------------------------------------------
#define ENABLE_HW_INTERNAL_ADC_CALIBRATION      ENABLE

#endif // #ifndef _SW_CONFIG_TRUNK_MARLON_128M_H_
