...
#ifndef _SW_CONFIG_TRUNK_MILAN_128M_DVBT_PLUS_DVBC_H_
#define _SW_CONFIG_TRUNK_MILAN_128M_DVBT_PLUS_DVBC_H_

#define SW_CONFIG_NAME              "MILAN_128M_DVBT_PLUS_DVBC"
...
#define ENABLE_DVB_T2                       ENABLE  // DISABLE
...
#if ENABLE_RIKS_TV
#define ENABLE_DELETE_PROGRAM_CONTROL
#endif

#define ENABLE_MEDIA_BROADCAST 				DISABLE		//for Media Broadcast

#if ENABLE_MEDIA_BROADCAST
#define ENABLE_AD_DISABLE_MAINAUDIO ENABLE
#else
...
#define SW_LOAD_BMP_ON_DEMAND           1//DISABLE
...
#if(ENABLE_DTV && ENABLE_PVR && ENABLE_CI && ENABLE_CI_PLUS)
    #define ENABLE_CIPLUS_PVR        DISABLE//ENABLE
#else
