...
#ifndef _SW_CONFIG_TRUNK_WHISKY_128M_H_
#define _SW_CONFIG_TRUNK_WHISKY_128M_H_

#define SW_CONFIG_NAME              "TRUNK_WHISKY_128M"
...
#define MCU_AEON_ENABLE             ENABLE
        ...
        #define ENABLE_SECURITY_R2_HDCP22   ENABLE

  #ifndef ENABLE_ATSC_TTS
    #if( ENABLE_ATSC && (FLASH_SIZE>=FLASH_SIZE_8MB) )
...
//------------------------------VECTOR FONT-------------------------------------
#if 0//(VECTOR_FONT_ENABLE && !MCU_AEON_ENABLE)
...
#endif // #ifndef _SW_CONFIG_TRUNK_WHISKY_128M_H_
