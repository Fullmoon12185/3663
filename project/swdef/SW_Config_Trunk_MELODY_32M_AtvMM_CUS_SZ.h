...
#ifndef _SW_CONFIG_TRUNK_MELODY_32M_ATVMM_H_
#define _SW_CONFIG_TRUNK_MELODY_32M_ATVMM_H_

#define SW_CONFIG_NAME              "SW_CONFIG_TRUNK_MELODY_32M_ATVMM"
...
#define ENABLE_AUDIO_DSP_BIN            ENABLE
//-------------------------------------------------------------------------------
// Common DVB System
//-------------------------------------------------------------------------------
...
#define ENABLE_SDT_OTHER_MONITOR            0//ENABLE
#define ENABLE_NZ_EIT_TIME_DISPLAY          0//ENABLE
//------------------------------------------------------------------------------
...
#if ENABLE_DMP
#define ENABLE_DMP_MINI_MENU            1

#define ENABLE_DMP_MINI_TEMP            1 // 临时，可能为了编译通过
#define ENABLE_DMP_MINI_READY           0 // 可能后面还会用，先保留
#define ENABLE_DMP_MINI_USE_READY       0 // 后面还会用，先保留
#define ENBALE_DMP_READY                0
#define ENBALE_DMP_MUSIC_READY          0
#define ENBALE_DMP_PHOTO_READY          0
#define ENBALE_DMP_TEXT_READY           0
#else
#define ENABLE_DMP_MINI_MENU            0

#define ENABLE_DMP_MINI_TEMP            0 // 临时，可能为了编译通过
#define ENABLE_DMP_MINI_READY           0 // 可能后面还会用，先保留
#define ENABLE_DMP_MINI_USE_READY       0 // 后面还会用，先保留
#define ENBALE_DMP_READY                0
#define ENBALE_DMP_MUSIC_READY          0
...
#endif // #ifndef _SW_CONFIG_TRUNK_MELODY_32M_ATVMM_H_
