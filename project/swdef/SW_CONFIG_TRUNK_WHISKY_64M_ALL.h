...
#ifndef _SW_CONFIG_TRUNK_WHISKY_64M_H_
#define _SW_CONFIG_TRUNK_WHISKY_64M_H_

#define SW_CONFIG_NAME              "TRUNK_WHISKY_64M"
...
//#undef FLASH_SIZE
    ...
    #define FORCE_VDEC_BIN_NO_COMPRESS  ENABLE
#endif

#if(!BLOADER)

  #ifndef ENABLE_ATSC_TTS
    #if( defined(CHAKRA3_AUTO_TEST) && (CHAKRA3_AUTO_TEST) )
        // Don't enable TTS

    #elif( ENABLE_ATSC && (FLASH_SIZE>=FLASH_SIZE_8MB) )
        #define ENABLE_ATSC_TTS             ENABLE
        #define MS_TTS_SAMPLING_RATE_SEL    MS_TTS_LIB_16_IN_16_OUT
        #define ENABLE_POWERON_MUSIC        DISABLE
    #endif
  #elif(ENABLE_ATSC_TTS)
        #define MS_TTS_SAMPLING_RATE_SEL    MS_TTS_LIB_16_IN_16_OUT
        #define ENABLE_POWERON_MUSIC        DISABLE
  #endif
...
#undef ENABLE_SECURITY_R2
#if(ENABLE_SECURITY_R2_HDCP22  /*  || (ENABLE_ATSC_TTS && (TTS_IS_ON_HK == 0))*/ )
...
#define HDCP22_ALL_R2_TASK_ENABLE       DISABLE
...
#define MPEG_HD_PRE_SCAL_DOWN    ENABLE
...
#define ENABLE_DTV_EPG                      ENABLE    // ATSC EPG is in different way...
#else
#define ENABLE_DTV_EPG                      DISABLE
#endif

#define ENABLE_SCHE_EXT                     DISABLE    // enable Extended Info in EPG
#define SUPPORT_PVR_CRID                    DISABLE    // enable PVR DTG functions
...
#define ENABLE_BL_UI                    ENABLE
    #define ENABLE_BL_OAD_SCAN          0//ENABLE
#endif //(BLOADER)
...
#define ENABLE_GAMMA_ADJUST 			DISABLE//ENABLE
...
//******************************************************************************
//This complier option need check with demod lib like "libdrvDEMOD.a"
...
#endif // #ifndef _SW_CONFIG_TRUNK_WHISKY_64M_H_
