...
INC_DIR  += \
        ...
        -I$(ROOT)/core/driver/sys/whisky/include                      \
        -I$(ROOT)/core/api/n51fs/include                            \
        -I$(ROOT)/core/bin/whisky/audio                               \
...
CHIP_FILES += \
        $(ROOT)/chip/whisky/device/gpio/GPIO.c                         \
        $(ROOT)/core/driver/power/whisky/drvPower_cus.c                \
        $(ROOT)/core/driver/power/whisky/drvPower.c                    \
        $(ROOT)/chip/whisky/color/color.c                              \

DEVICES_FILES += \
        $(ROOT)/device/keypad/whisky/msKeypad.c                        \
        $(ROOT)/device/ir/whisky/msIR.c                                \
...
INC_DIR  += \
        ...
        -I$(ROOT)/project/mmap                                      \
        -I$(ROOT)/chip/whisky/color/include                           \
        -I$(ROOT)/chip/whisky/device/gpio                             \
        -I$(ROOT)/chip/whisky/image                                   \
        -I$(ROOT)/device/panel                                      \
        -I$(ROOT)/device/panel/include                              \
        -I$(ROOT)/device/panel_dft                                  \
        -I$(ROOT)/device/flash                                      \
        -I$(ROOT)/device/keypad/whisky                               \
        -I$(ROOT)/device/ir/whisky                                   \
...
LINT_INC  += \
        ...
        $(ROOT)/project/mmap                                       \
        $(ROOT)/chip/whisky/color/include                            \
        $(ROOT)/chip/whisky/device/gpio                              \
        $(ROOT)/chip/whisky/image                                    \
        $(ROOT)/device/panel                                       \
        $(ROOT)/device/panel/include                               \
        $(ROOT)/device/panel_dft                                   \
        $(ROOT)/device/flash                                       \
        $(ROOT)/device/keypad/whisky                                \
        $(ROOT)/device/ir/whisky                                    \
...
LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/whisky/libprana_whisky_aeonR2.a -Wl,--no-whole-archive
else
LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/whisky/libprana_whisky_a.a -Wl,--no-whole-archive
endif

DRV_LIB_PATH   = $(ROOT)/core/driver
API_LIB_PATH   = $(ROOT)/core/api

DRV_BSP_PATH   = $(ROOT)/core/drv_bsp/whisky_nos_r2m/lib
