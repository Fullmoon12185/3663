...
##################################################################
DRV_FILES += \
        $(ROOT)/core/driver/sys/milan/drvUartDebug.c                   \
        $(ROOT)/core/driver/sys/milan/SysInit.c                        \
        $(ROOT)/core/driver/sys/milan/drvISR.c                         \
        $(ROOT)/core/driver/usb/milan/drvUsbHostLib.c                  \


# PIP ENABLE need include these 2 files
DRV_FILES += \
        $(ROOT)/core/driver/pq/hal/milan/QualityMap_Sub.c              \
        $(ROOT)/core/driver/pq/hal/milan/QualityMap_SubEx.c           \
        $(ROOT)/core/driver/sys/milan/drvPadConf.c
...
INC_DIR  += \
        ...
        -I$(ROOT)/core/driver/sys/milan/include                   \
        -I$(ROOT)/core/driver/sc/milan/include                    \
        -I$(ROOT)/core/bin/milan/audio                            \
...
APP_FILES += \
        ...
        $(TVAP)/dvb/app/MApp_CIPVR_Adaption.c                                 \
...
CHIP_FILES += \
        $(ROOT)/chip/milan/device/gpio/GPIO.c                     \
        $(ROOT)/core/driver/power/milan/drvPower_cus.c            \
        $(ROOT)/core/driver/power/milan/drvPower.c                \
        $(ROOT)/chip/milan/color/color.c                          \

DEVICES_FILES += \
        $(ROOT)/device/keypad/milan/msKeypad.c                    \
        $(ROOT)/device/ir/milan/msIR.c                            \
...
INC_DIR  += \
        ...
        -I$(ROOT)/project/image/bininfo/milan                    \
        -I$(ROOT)/project/mmap                                     \
        -I$(ROOT)/chip/milan/color/include                       \
        -I$(ROOT)/chip/milan/device/gpio                         \
        -I$(ROOT)/chip/milan/image                               \
        -I$(ROOT)/device/panel                                     \
        -I$(ROOT)/device/panel/include                             \
        -I$(ROOT)/device/panel_dft                                 \
        -I$(ROOT)/device/flash                                     \
        -I$(ROOT)/device/keypad/milan                            \
        -I$(ROOT)/device/ir/milan                                \
...
LINT_INC  += \
        ...
        $(ROOT)/project/image/bininfo/milan                      \
        $(ROOT)/project/mmap                                       \
        $(ROOT)/chip/milan/device/gpio                           \
        $(ROOT)/chip/milan/image                                 \
        $(ROOT)/chip/milan/color/include                         \
        $(ROOT)/device/panel                                       \
        $(ROOT)/device/panel_dft                                   \
        $(ROOT)/device/panel/include                               \
        $(ROOT)/device/flash                                       \
        $(ROOT)/device/keypad/milan                              \
        $(ROOT)/device/ir/milan                                  \
...
DRV_BSP_PATH   = $(ROOT)/core/drv_bsp/milan_nos_mips/lib
...
BIN_INFO = $(ROOT)/project/image/bininfo/milan/BinInfo.h

REBUILD_FILES=$(TVAP)/dvb/ui2/MApp_ZUI_ACTmenufunc.c

include project/build/FILES_COMMON_MILAN.mk
