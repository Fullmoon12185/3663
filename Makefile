...
ifneq ($(ENABLE_DVBS),)
    CC_TVOPTS += -DENABLE_S2=DISABLE#$(ENABLE_DVBS)
else
    CC_TVOPTS += -DENABLE_S2=DISABLE
endif

ifeq ($(ENABLE_ATSC), ENABLE)
    CC_TVOPTS += -DENABLE_ATSC=DISABLE
endif
...
ifeq ($(ENABLE_DVBS), ENABLE)
    CC_TVOPTS += -DENABLE_DVBS=DISABLE
endif

ifeq ($(ENABLE_DVBC), ENABLE)
    CC_TVOPTS += -DENABLE_DVBC=DISABLE
endif

ifeq ($(ENABLE_ISDBT), ENABLE)
    CC_TVOPTS += -DENABLE_ISDBT=DISABLE
endif

ifeq ($(ENABLE_DTMB), ENABLE)
    CC_TVOPTS += -DENABLE_DTMB=DISABLE
endif
