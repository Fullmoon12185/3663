...
void GetGenreType(MS_U8 u8Type, char* pstr, U8 u8BufSize)
{
    ...
    switch( u8Type )
    {
        case 0x1: // Genre type is movie.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Movie": "Movie/Drama"), u8BufSize);
            break;
        case 0x2: // Genre type is news.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "News and Factual": "News/Current affairs"), u8BufSize);
            break;
        case 0x3: // Genre type is show.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Entertainment": "Show/Game show"), u8BufSize);
          break;
        case 0x4: // Genre type is sport
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Sport": "Sports"), u8BufSize);
            break;
        case 0x5: // Genre type is children.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Children's": "Children's/Youth programmes"), u8BufSize);
            break;
        case 0x6: // Genre type is music.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Entertainment": "Music/Ballet/Dance"), u8BufSize);
            break;
        case 0x7: // Genre type is arts.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "News and Factual": "Art/Culture(without music)"), u8BufSize);
            break;
        case 0x8: // Genre type is social.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "News and Factual": "Social/Political Issues/Economics"), u8BufSize);
            break;
        case 0x9: // Genre type is education.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Education": "Education/Science/Factual Topics"), u8BufSize);
            break;
        case 0x10: // Genre type is leisure.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Lifestyle": "leisure Hobbis"), u8BufSize);
            break;
        case 0x11: // Genre type is special.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "not supported": "Special Characteristics"), u8BufSize);
            break;
        case 0x12: // Reserved constant.
        case 0x13: // Reserved constant.
        case 0x14: // Reserved constant.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "not supported": "Reserved for future use"), u8BufSize);
            break;
        case 0x15: // Genre type is user defined.
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Drama": "user defined"), u8BufSize);
            break;
        default:
            Str8_StrCpy_CheckDest(pstr, (TRUE == isUKCountry?  "Unclassified": "Unclassified"), u8BufSize);
            break;
        }
}
