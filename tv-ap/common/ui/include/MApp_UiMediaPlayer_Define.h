...
#define NUM_OF_PHOTO_FILES_PER_PAGE     12
#define NUM_OF_MUSIC_FILES_PER_PAGE     12
#define NUM_OF_MOVIE_FILES_PER_PAGE     12
#define NUM_OF_TEXT_FILES_PER_PAGE      12
...
#define PHOTO_PREVIEW_HEIGHT    ((PREIVEW_WND_DEFAULT_HEIGHT*PANEL_HEIGHT)/ZUI_PHOTO_PREVIEW_PANEL_HEIGHT)-1
    ...
    #else
        #define ENABLE_EMBEDDED_PHOTO_DISPLAY       1
    #endif
#else
    #define ENABLE_EMBEDDED_PHOTO_DISPLAY       0
#endif
...
#define ENABLE_MOVIE_PREVIEW_ALL_AND_1ST_FRAME  1//���@��>��ܤ@�i
#define ENABLE_MOVIE_PREVIEW_1ST_FRAME          0//������ܤ@�i
#define MOVIE_REPEAT_PREVIEW                    0//0:���@��>���� 1:��N��
