...
{
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_PLAY_PAUSE,E_BMP_DMP_BUTTON_ICON_PAUSE,en_str_Pause},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_PREV,E_BMP_DMP_BUTTON_ICON_PREV,en_str_Prev},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_NEXT,E_BMP_DMP_BUTTON_ICON_NEXT,en_str_Next},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_STOP,E_BMP_DMP_BUTTON_ICON_STOP,en_str_Stop},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_REPEAT,E_BMP_DMP_BUTTON_ICON_REPEAT,en_str_Repeat},
#if RANDOM_PLAY
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_RANDOM,E_BMP_DMP_BUTTON_ICON_RANDOM,en_str_Repeat},
#endif
#if (ENABLE_BGM) && (DIRECTORY_BGM)
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_MUSIC,E_BMP_DMP_BUTTON_ICON_BGM,en_str_Music},
#endif
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_PLAYLIST,E_BMP_DMP_BUTTON_ICON_PLAY_LIST,en_str_Playlist},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_INFO,E_BMP_DMP_BUTTON_ICON_INFO,en_str_Info},
#if (!ENABLE_4K2K)
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_CLOCKWISE,E_BMP_DMP_BUTTON_ICON_ROTATE_CLOCK,en_str_Rotate},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_COUNTERCLOCKWISE,E_BMP_DMP_BUTTON_ICON_ROTATE_ANTICLOCK,en_str_Rotate},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_ZOOMIN,E_BMP_DMP_BUTTON_ICON_ZOOMOUT,en_str_Zoom_In},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_ZOOMOUT,E_BMP_DMP_BUTTON_ICON_ZOOMIN,en_str_Zoom_Out},
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_MOVEVIEW, E_BMP_DMP_MOVE_VIEW, en_str_Move_View},
#endif
#if (ENABLE_BGM) && (PLAYLIST_BGM)
    {EN_EXE_DMP_PLAYBACK_BGMINFO_INFO, E_BMP_DMP_BUTTON_ICON_BGM, en_str_Music},
    {EN_EXE_DMP_PLAYBACK_BGMINFO_PLAYLIST, E_BMP_DMP_BUTTON_ICON_PLAY_LIST, en_str_Playlist},
#endif
#if (ENABLE_MPLAYER_CAPTURE_LOGO == 1)
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_CAPTURE,E_BMP_DMP_BUTTON_ICON_CAPTURE,en_str_Capture},
#endif
#if (!ENABLE_4K2K)
    {EN_EXE_DMP_PLAYBACK_PHOTOINFO_SLIDESHOW, E_BMP_DMP_BUTTON_ICON_FUNCTION, en_str_Slide_Show},
#endif
};
...
static const U8 u8PhotoInfoBarMax = PHOTOINFO_NUM;

/*action bitmapWnd stringWnd*/

static U32 DMP_MusicInfoBarTable[][3] =
{
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_PLAY_PAUSE,E_BMP_DMP_BUTTON_ICON_PAUSE,en_str_Pause},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_FB,E_BMP_DMP_BUTTON_ICON_FB,en_str_FB},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_FF,E_BMP_DMP_BUTTON_ICON_FF,en_str_FF},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_PREV,E_BMP_DMP_BUTTON_ICON_PREV,en_str_Prev},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_NEXT,E_BMP_DMP_BUTTON_ICON_NEXT,en_str_Next},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_STOP,E_BMP_DMP_BUTTON_ICON_STOP,en_str_Stop},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_REPEAT,E_BMP_DMP_BUTTON_ICON_REPEAT,en_str_Repeat},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_AB_REPEAT,E_BMP_DMP_BUTTON_ICON_AB_REPEAT,en_str_SET_A},
#if RANDOM_PLAY
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_RANDOM,E_BMP_DMP_BUTTON_ICON_RANDOM,en_str_Repeat},
#endif
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_MUTE,E_BMP_DMP_BUTTON_ICON_MUTE,en_str_MUTE},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_PLAYLIST,E_BMP_DMP_BUTTON_ICON_PLAY_LIST,en_str_Playlist},
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_INFO,E_BMP_DMP_BUTTON_ICON_INFO,en_str_Info},
#if (ENABLE_MPLAYER_CAPTURE_MUSIC == 1)
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_CAPTURE,E_BMP_DMP_BUTTON_ICON_CAPTURE,en_str_Capture},
#endif
    {EN_EXE_DMP_PLAYBACK_MUSICINFO_GOTO_TIME,E_BMP_DMP_BUTTON_ICON_TIME,en_str_Goto_Time}
};
...
static const U8 u8MusicInfoBarMax = MUSICINFO_NUM;

/*action bitmapWnd stringWnd*/
#if (ENABLE_MPLAYER_TEXT)
static U32 DMP_TextInfoBarTable[][3] =
{
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_PREV,E_BMP_DMP_BUTTON_ICON_FB,en_str_Prev_Page},
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_NEXT,E_BMP_DMP_BUTTON_ICON_FF,en_str_Next_Page},
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_PREVFILE,E_BMP_DMP_BUTTON_ICON_PREV,en_str_Prev},
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_NEXTFILE,E_BMP_DMP_BUTTON_ICON_NEXT,en_str_Next},
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_STOP,E_BMP_DMP_BUTTON_ICON_STOP,en_str_Stop},
#if (ENABLE_BGM) && (DIRECTORY_BGM)
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_MUSIC,E_BMP_DMP_BUTTON_ICON_BGM,en_str_Music},
#endif
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_PLAYLIST,E_BMP_DMP_BUTTON_ICON_PLAY_LIST,en_str_Playlist},
    {EN_EXE_DMP_PLAYBACK_TEXTINFO_INFO,E_BMP_DMP_BUTTON_ICON_INFO,en_str_Info},
};
#endif
typedef enum
{
...
static const U8 u8TextInfoBarMax = TEXTINFO_NUM;
...
{
    //Refine flow: allow loading msg can be replaced by unsupport msg.
    if((MApp_ZUI_API_GetFocus() != HWND_DMP_ALERT_WINDOW) || (_enDmpMsgType == DMP_MSG_TYPE_LOADING))
    {
        ...
        {
            if ((DMP_MSG_TYPE_NO_ENOUGH_SPACE == enMsgType)
                ||(DMP_MSG_TYPE_NO_SELECT_FILE == enMsgType)
                ||(DMP_MSG_TYPE_COPY_FILE_ERROR == enMsgType)
                ||(DMP_MSG_TYPE_DELETE_FILE_ERROR == enMsgType)
                ||(DMP_MSG_TYPE_FORMATTING == enMsgType)
                ||(DMP_MSG_TYPE_UNSUPPORTED_FORMAT == enMsgType)
                ||(DMP_MSG_TYPE_NEED_TO_SELECT_DELETE_FILE == enMsgType)
                ||(DMP_MSG_TYPE_NEED_TO_SELECT_COPY_FILE == enMsgType)
                ||(DMP_MSG_TYPE_PRESS_RED_BUTTON_PASTE == enMsgType)
                )
            {
...
void _MApp_ACTdmp_MusicCancelRepeatAB(void)
{
    ...
    DMP_MusicInfoBarTable[MUSICINFO_AB_REPEAT][2] = en_str_SET_A;
}
...
static void _MApp_ACTdmp_Playback_ShowPlaylistWin(enumMPlayerMediaType eMediaType, bool bSetFoucsOnCurrentPlayingIdx)
{
    ...
    {
        if(m_bBGMOn && MApp_MPlayer_IsMusicPlaying())
        {
        ...
        else
        {
            ...
            MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_PLAYLIST_PAGE_IDX_NUM,SW_HIDE);
            MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_PLAYLIST_PAGE_SLASH,SW_HIDE);
            MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_PLAYLIST_PAGE_TOTAL_NUM,SW_HIDE);

            MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_PLAYLIST_ARROW_DOWN,SW_HIDE);
            MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_PLAYLIST_ARROW_UP,SW_HIDE);
...
#if PLAYLIST_BGM
        if (bIsBGMPlaylist == TRUE)
            u16CurrentDirFileNum = MApp_MPlayer_QueryTotalMusicFileNum();
        else
#endif
...
#if (ENABLE_ATSC_TTS)
        MApp_TTSControlSetInputText(MApp_ZUI_API_GetU16String(u16CurrentDirFileNum),MApp_UiMenu_u16Strlen(MApp_ZUI_API_GetU16String(u16CurrentDirFileNum)));
        MApp_TTSControlSetOn(TRUE);
#endif

#if PLAYLIST_BGM
        if (bIsBGMPlaylist == TRUE)
            u16CurrentDirMediaFileNum = u16CurrentDirFileNum - MApp_MPlayer_QueryMusicDirectoryNumber();
        else
#endif
...
#if PLAYLIST_BGM
                if (bIsBGMPlaylist == TRUE)
                    u16CurrentPlayingIdx = u16CurrentPlayingIdx - MApp_MPlayer_QueryMusicDirectoryNumber();
                else
#endif
...
#if PLAYLIST_BGM
            if (bIsBGMPlaylist == TRUE)
                u16CurrentPlayingIdx = MApp_MPlayer_QueryCurrentPlayingFileIndex() - MApp_MPlayer_QueryMusicDirectoryNumber();
            else
#endif
    ...
    else  // there are some selected files, using playlist
    {
        ...
        }
        {
            ...
            if (u8CurrentPlayingPageIdx == u8CurrentPlaylistPageIdx)
            {
                ...
                RECT rc;
                RECT_SET(rc,
                _GUI_WindowPositionList_Zui_Dmp[HWND_DMP_PLAYBACK_PLAYLIST_ITEM1].rect.left+5,
                top,35,35);
                MApp_ZUI_API_MoveWindow(HWND_DMP_PLAYBACK_PLAYLIST_ARROW_UP_CURRENT, &rc );
                MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_PLAYLIST_ARROW_UP_CURRENT, SW_SHOW);
            }
          ...
          #endif  // ENABLE_DVD
            {
                switch(MApp_MPlayer_QueryCurrentMediaType())
                {
                    ...
                    if (MApp_MPlayer_QueryCurrentMediaType() == E_MPLAYER_TYPE_MOVIE)
                    {
                        ...
                        if((DrmInfo.u8DrmFileFormat)&&(!DrmInfo.u8DrmRentalStatus)&&(DrmInfo.u32DrmRentalFile))
                        {
                            MApp_ZUI_API_StoreFocusCheckpoint();
                            MApp_ZUI_API_ShowWindow(HWND_DMP_RESUME_STOP_WINDOW, SW_SHOW);
                            MApp_ZUI_API_SetTimer(HWND_DMP_RESUME_STOP_WINDOW, DMP_TIMER_RESUMESTOP_WIN, DMP_TIME_MS_RESUMESTOP_WIN);
                            MApp_ZUI_API_SetFocus(HWND_DMP_RESUME_STOP_ICON_YES);
                            return TRUE;
                        }
...
LPTSTR MApp_ZUI_ACT_GetDmpDynamicText(HWND hwnd)
{
    ...
    //===========================INFOBAR
        ...
        #if ENABLE_USB_3
            else if(msAPI_MSDCtrl_IsPortOpened(MSD_PORT_3))
            {
                eUSBDeviceStatus = (enumMPlayerUSBDeviceStatus)msAPI_GetUsbDeviceStatusPort3();
            }
        #endif

        #if ENABLE_USB_4
            else if(msAPI_MSDCtrl_IsPortOpened(MSD_PORT_4))
            {
                eUSBDeviceStatus = (enumMPlayerUSBDeviceStatus)msAPI_GetUsbDeviceStatusPort4();
            }
        #endif
            else
            {
...
U16 MApp_ZUI_ACT_GetDmpDynamicBitmap(HWND hwnd, DRAWSTYLE_TYPE ds_type)
{
    ...
    switch(hwnd)
    {
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM1:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM2:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM3:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM4:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM5:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM6:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM7:
        case HWND_DMP_PLAYBACK_INFOBAR_ITEM8:
        {
            U32 i;
            for( i = 0; i < DMP_INFOBAR_ICON_NUM; i++)
            {
...
BOOLEAN MApp_UiMediaPlayer_Notify(enumMPlayerNotifyType eNotify, void *pInfo)
{
    ...
    switch(eNotify)
    {
        ...
        }
        {
            ...
            enumMPlayerMediaType eMediaType = *(enumMPlayerMediaType *)pInfo;
#if(ENABLE_PLAYBACK_SHOW_UNSUPPORTED_ONLY_FIRST_TIME)
            MApp_MPlayer_SetFileDecodedFail(MApp_MPlayer_QueryCurrentPlayingList(), TRUE, eMediaType, MApp_MPlayer_QueryPlayMode());
#endif
            if( (MApp_DMP_GetDmpFlag() & DMP_FLAG_MEDIA_FILE_PLAYING)
                || MApp_DMP_GetDmpUiState() == DMP_UI_STATE_LOADING)
            {
                ...
                if(eMediaType == MApp_MPlayer_QueryCurrentMediaType())
                {
                    m_u16PlayErrorNum++;
                }

                //display playing stage OSD before alert window.
                if((MApp_DMP_GetDmpUiState() == DMP_UI_STATE_PLAYING_STAGE)&&(MApp_DMP_GetDMPStat() == DMP_STATE_UI))
                {
                    MApp_DMP_NotifyUiState(DMP_UI_STATE_PLAYING_STAGE);
                    MApp_DMP_SetDMPStat(DMP_STATE_WAIT);
                }
                ...
                &&(MApp_DMP_GetDmpFlag() & DMP_FLAG_BGM_MODE))
                {
                    ...
                    //------------------------Enter music mode------------------------
                    {
                        ...
                        {// N files in the play list.
                            DMP_DBG(printf("[check] Play BGM file error number = %d, Total BGM Files : %d\n", m_u16BGMErrorNum, _MApp_DMP_QueryTotalPlayListNum()));

                            if((m_u16BGMErrorNum >= _MApp_DMP_QueryTotalPlayListNum())
                           //||(MApp_MPlayer_QueryCurrentPlayingListFileIndex() >= _MApp_DMP_QueryTotalPlayListNum()) //mark it //allow to display last err UI
                             )
                ...
                else if (MApp_MPlayer_QueryRepeatMode() ==E_MPLAYER_REPEAT_1)
                {
                    ...
                    _MApp_ACTdmp_ShowAlertWin(DMP_MSG_TYPE_ALL_FILES_UNSUPPORTED); //this behavior same as  repeat all and play unsupported file case to show all files unsupported
                    MApp_ZUI_API_SetTimer(HWND_DMP_ALERT_WINDOW, DMP_TIMER_INVALID_WIN, DMP_TIME_MS_ERROR_WIN);
                    MApp_ZUI_API_ResetTimer(HWND_DMP_ALERT_WINDOW, DMP_TIMER_INVALID_WIN);
                    return FALSE;
                }
                else
                {// N files in the play list.
                    ...
                    if(MApp_MPlayer_QueryPlayerErrorDelayTime(eMediaType)>0)
                    {
                        if((m_u16PlayErrorNum >= _MApp_DMP_QueryTotalPlayListNum())
                           //||(MApp_MPlayer_QueryCurrentPlayingListFileIndex() >= _MApp_DMP_QueryTotalPlayListNum()) //mark it //allow to display last err photo UI
                          )
                        {// All selected files are decoded error!
                            ...
                            MApp_DMP_SetDmpFlag(DMP_FLAG_MEDIA_FILE_PLAYING_ERROR);
                            _MApp_DMP_ErrorHandling_GotoDefaultPage(eMediaType);
                            _MApp_ACTdmp_ShowAlertWin(DMP_MSG_TYPE_ALL_FILES_UNSUPPORTED);
                            MApp_ZUI_API_SetTimer(HWND_DMP_ALERT_WINDOW, DMP_TIMER_INVALID_WIN, DMP_TIME_MS_ERROR_WIN);
                            MApp_ZUI_API_ResetTimer(HWND_DMP_ALERT_WINDOW, DMP_TIMER_INVALID_WIN);
                            return FALSE;
                        }
                        else
                        {
                           ...
                           _MApp_ZUI_ACTdmp_RestoreGWINandFB();
                            ...
                            //If playing an unsupported music file, clear the bars.
                            if(eMediaType == E_MPLAYER_TYPE_MUSIC)
                            {
                                MApp_ZUI_API_KillTimer(HWND_DMP_PLAYBACK_MUSIC_EQ_GROUP, DMP_TIMER_EQ_PLAY);
                                MApp_ZUI_API_ShowWindow(HWND_DMP_PLAYBACK_MUSIC_EQ_GROUP, SW_HIDE);
            ...
            {//Error occured in default page - Preview Mode or BGM Mode(error occured in !MUSIC type)
                    ...
                    case E_MPLAYER_TYPE_MOVIE:
                        {
                            ...
                            else if (u32ErrorMsg == EN_VDP_ERRORCODE_NOT_SUPPORT_FRAMERATE)
                            {
                                DMP_DBG(printf("Set errMsg to video framerate not show\n"));
                                errMSG = DMP_MSG_TYPE_UNSUPPORTED_VIDEO_FRAME_RATE;
                            }
                            break;
                        }
                        #endif
                ...
                _MApp_ACTdmp_ShowAlertWin(errMSG);
                MApp_ZUI_API_SetTimer(HWND_DMP_ALERT_WINDOW, DMP_TIMER_INVALID_WIN, DMP_TIME_MS_ERROR_WIN);
                MApp_ZUI_API_ResetTimer(HWND_DMP_ALERT_WINDOW, DMP_TIMER_INVALID_WIN);
                return TRUE;
            }
...
void MApp_DMP_NotifyUiState(EN_DMP_UI_STATE enDmpUiState)
{
    ...
    switch(enDmpUiState)
    {
        ...
        case DMP_UI_STATE_FILE_SELECT:
            ...
            break;
    #if PLAYLIST_BGM
        case DMP_UI_STATE_BGM_DRIVE_SELECT:
            {
            #if (DMP_PHOTO_THUMBNAIL || DMP_MOVIE_THUMBNAIL || DMP_MUSIC_THUMBNAIL)
                _MApp_DMP_ThumbCopyRegion_Destroy();
                MApp_MPlayer_LeaveThumbnailMode();
                ...
                _MApp_ZUI_ACT_DMPCloseZoomMapWin();
            #endif
                DMP_DBG(printf("DMP_UI_STATE_BGM_DRIVE_SELECT\n"););
        ...
        case DMP_UI_STATE_LOADING:
            {
                ...
                else
                {
                    ...
                    MApp_ZUI_API_ShowWindow(HWND_MAINFRAME, SW_HIDE);
                    // Need Modify (should show minu menu Alert Win)
                    #if ENABLE_DMP_MINI_MENU
                    if(MApp_MPlayer_IsMoviePlaying() || (MApp_MPlayer_QueryCurrentMediaType() == E_MPLAYER_TYPE_MOVIE))
                    {
                        MApp_ZUI_ACT_ShutdownOSD();
                        //MApp_ZUI_API_SetFocus(HWND_DMP_ROOT_TRANSPARENT_BG);
                        //MApp_DMP_GotoDMPMiniMenu();
                    }
                    else
                    #endif
