...
#define MApp_UiMenu_u16Strlen(pu16Str)  Str16_StrLen( (pu16Str) )
...
//==================================================================================
INTERFACE U16 MApp_U8StrToU16Str_CheckBufSize( U8 *pu8SrcStr, U16 *pu16DestStr, U16 u16DestBufSize);
INTERFACE U16 MApp_U16StrToU8Str_CheckBufSize( U16 *pu16SrcStr, U8 *pu8DestStr, U16 u16DestBufSize);
