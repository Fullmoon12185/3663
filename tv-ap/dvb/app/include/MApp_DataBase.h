...
#define SAVE_DB_FLAG_DEFAULT                0
#define SAVE_DB_FLAG_CHECK_DB_CH_CHANGED    1
INTERFACE void MApp_DB_SaveDataBase_RightNow(U8 u8SaveDBFlag);
...
INTERFACE void MApp_DB_LoadHDCP22_KEY(U8 *au8AesKey, U8 *au8Hdcp22Key);
