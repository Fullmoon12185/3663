...
static U8 u8EwsScrollLineCount = 0;
static U8 u8EwsScrollLineCount_Pre = 0;
...
BOOLEAN MApp_EWS_Set_Description(void)
{
     ...
     Str8_StrCpy_CheckDest((char*)u8EwsDescriptionBuf, (char*)stEwsSettingData.u8_EwsDisasterType, EWS_DESC_BUF_SIZE );
    ...
    Str8_StrCpy_CheckDest((char*)&u8EwsDescriptionBuf[strcount], (char*)stEwsSettingData.u8_EwsDisasterRemark, EWS_DESC_BUF_SIZE - strcount );
    ...
    if( strcount > (EWS_DESC_BUF_SIZE-20) )
    {
     ...
     {
         case EN_EWS_AWAS:
             //strncpy((char*)&u8EwsDescriptionBuf[strcount], "Status Awas", EWS_DESC_BUF_SIZE-strcount);
             Str8_StrCpy_CheckDest((char*)&u8EwsDescriptionBuf[strcount], "Status Awas", EWS_DESC_BUF_SIZE-strcount);
             break;

         case EN_EWS_SIAGA:
             //strncpy((char*)&u8EwsDescriptionBuf[strcount], "Status Siaga", EWS_DESC_BUF_SIZE-strcount);
             Str8_StrCpy_CheckDest((char*)&u8EwsDescriptionBuf[strcount], "Status Siaga", EWS_DESC_BUF_SIZE-strcount);
             break;

         case EN_EWS_WASPADA:
             //strncpy((char*)&u8EwsDescriptionBuf[strcount], "Status Waspada", EWS_DESC_BUF_SIZE-strcount);
             Str8_StrCpy_CheckDest((char*)&u8EwsDescriptionBuf[strcount], "Status Waspada", EWS_DESC_BUF_SIZE-strcount);
             break;
