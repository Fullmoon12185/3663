...
#if CIPLUS_MHEG_1_3
U8 u8InputMask[MAX_MBX_PARAM_SIZE] = {0};
        ...
        switch ( u8KeyCode )
        {
...

		  {
                    ...
                    if (u8MHEG5_Key_Register == 3 || u8MHEG5_Key_Register == 4 || u8MHEG5_Key_Register == 5 ||
                        ...
                        u8MHEG5_Key_Register == 33 || u8MHEG5_Key_Register == 34 || u8MHEG5_Key_Register == 35 ||
                        u8MHEG5_Key_Register == 7 || u8MHEG5_Key_Register == 6)

    #else
                    if (u8MHEG5_Key_Register == 3 || u8MHEG5_Key_Register == 4 || u8MHEG5_Key_Register == 5 ||
                        u8MHEG5_Key_Register == 13 || u8MHEG5_Key_Register == 14 || u8MHEG5_Key_Register == 15 ||
                        u8MHEG5_Key_Register == 33 || u8MHEG5_Key_Register == 34 || u8MHEG5_Key_Register == 35 ||
                        u8MHEG5_Key_Register == 7)
    #endif
                    {
                        msAPI_MHEG5_Key_Transmit(u8KeyCode, 0);
                        u8KeyCode = KEY_NULL;
...
#define MHEG5_HOST_NAME_BUF_SIZE    256

U16 MApp_MHEG5_CheckServer_Status(void)
{
        int sd, port;
        U16 ReturnStatus = 0;
        char host_name[MHEG5_HOST_NAME_BUF_SIZE];
        struct hostent *nlp_host;
        struct sockaddr_in pin;

        //strncpy((char *)host_name,(const char *)"dtgtest.org", MHEG5_HOST_NAME_BUF_SIZE);
        Str8_StrCpy_CheckDest((char *)host_name,(const char *)"dtgtest.org", MHEG5_HOST_NAME_BUF_SIZE);
...
U16 MApp_MHEG5_Connect_Server(char *ICStraddr, int *st)
{
   ...
   tv.tv_usec = ( 30000 % 1000) * 1000;
    ...
    //strncpy((char *)host_name,(const char *)ICStraddr, MHEG5_HOST_NAME_BUF_SIZE);
    Str8_StrCpy_CheckDest((char *)host_name,(const char *)ICStraddr, MHEG5_HOST_NAME_BUF_SIZE);
