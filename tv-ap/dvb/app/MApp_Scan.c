...
#endif
#if ENABLE_SBTVD_DIRECT_TUNE
extern void MApp_ZUI_ACT_AtvManualTuningChangeCurrentCH(U16 Value );
extern E_ANTENNA_SOURCE_TYPE enLastWatchAntennaType;
extern BOOLEAN bDirectTune_Status;
#endif
//========================================================================
...
*/
        ...
        case STATE_BLIND_WAITFINISH:
        {
            MS_U8 u8Find = 0;
        #if(SUPPORT_UNICABLE)
            MS_U32 m_u32Frequency = 0; // Fix coverity-216708
            if (sat_info.eLNBType== EN_LNBTYPE_UNICABLE)
            {
    ...
    */
       ...
       case STATE_S2_SCAN_NIT_QUICK_SCAN_WAIT_SGT:
       {
        ...
        case STATE_SCAN_EXIT_MAIN_MENU:
            ...
            {
              #if ENABLE_SBTVD_DIRECT_TUNE //if no DTV program, go to air ATV scan
                    if ((bDirectTune_Status==TRUE)&&(enScanState == STATE_SCAN_END )&&(u16ScanDtvChNum==0&&u16ScanRadioChNum==0&&u16ScanDataChNum==0))
                    {
