...
void MApp_ReturnResolution(U8 *strBuffer, U16 u16BufSize)
{
    U16 h, v;
    U8 vfreq;
    char cIorP = 'P';
...
/*
    ...
    */
...
#endif
    {
        ...
        switch( mvideo_vd_get_videosystem() )
        {
            ...
            case SIG_NTSC_443:
                ...
                MApp_U16StrToU8Str_CheckBufSize((U16*)MApp_ZUI_API_GetString(en_str_NTSC), strBuffer, u16BufSize);
                //strBuffer += 4;
                break;
            ...
            case SIG_PAL_NC:
                ...
                MApp_U16StrToU8Str_CheckBufSize((U16*)MApp_ZUI_API_GetString(en_str_PAL), strBuffer, u16BufSize);
                //strBuffer += 3;
                break;
            ...
            case SIG_SECAM:
                ...
                MApp_U16StrToU8Str_CheckBufSize((U16*)MApp_ZUI_API_GetString(en_str_SECAM), strBuffer, u16BufSize);
                //strBuffer += 5;
                break;
            default:
                break;
    ...
    else if(IsYPbPrInUse())
    {
        ...
        cIorP = (MApi_XC_PCMonitor_GetSyncStatus(MAIN_WINDOW) & XC_MD_INTERLACE_BIT) ? 'i' : 'p';

        snprintf( (char*)strBuffer, u16BufSize, "%u%c %uHz", v, cIorP, vfreq);
    }
    else if(IsVgaInUse())
    {
        if(MApi_XC_PCMonitor_SyncLoss(MAIN_WINDOW))
        ...
        snprintf((char*)strBuffer, u16BufSize, "%ux%u %uHz", h, v, vfreq);
    }
    else if(IsHDMIInUse())
    {
        if( MApi_XC_PCMonitor_SyncLoss(MAIN_WINDOW) )
