...
typedef enum
{
    ...
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_MSG = 152,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BG = 153,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BG_2 = 154,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BG_TOP = 155,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BG_L = 156,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BG_C = 157,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BG_R = 158,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BAR = 159,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_CONFIRM_BTN_YES = 160,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BTN_YES_LEFT_ARROW = 161,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BTN_YES_TEXT = 162,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_CONFIRM_BTN_NO = 163,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BTN_NO_RIGHT_ARROW = 164,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_BTN_NO_TEXT = 165,
    HWND_MENU_CHANNEL_HAVE_LCN_CONFILICT_HELP_MSG = 166,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE = 167,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_BG_TOP = 168,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_BG_L = 169,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_BG_C = 170,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_BG_R = 171,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_TITLE = 172,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_TITLE_TEXT = 173,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_LIST = 174,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_CH_NUM = 175,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_CH_NUM_TXT = 176,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_CH_NUM_VALUE = 177,
    HWND_MENU_CHANNEL_LCN_CONFLIC_1ST = 178,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_1ST_NAME = 179,
    HWND_MENU_CHANNEL_LCN_CONFLIC_2ND = 180,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_2ND_NAME = 181,
    HWND_MENU_CHANNEL_LCN_CONFLIC_3RD = 182,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_3RD_NAME = 183,
    HWND_MENU_CHANNEL_LCN_CONFLIC_4TH = 184,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_4TH_NAME = 185,
    HWND_MENU_CHANNEL_LCN_CONFLIC_5TH = 186,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_5TH_NAME = 187,
    HWND_MENU_CHANNEL_SET_LCN_CONFLIC_PAGE_MENU = 188,
    HWND_OAD_TUNE = 189,
    HWND_OAD_TUNE_BG_PANE = 190,
    HWND_OAD_TUNE_SCAN_CONFIRM_MSG_BG = 191,
    HWND_OAD_TUNE_SCAN_CONFIRM_MSG_BG_TOP = 192,
    HWND_OAD_TUNE_SCAN_CONFIRM_MSG_BG_L = 193,
    HWND_OAD_TUNE_SCAN_CONFIRM_MSG_BG_C = 194,
    HWND_OAD_TUNE_SCAN_CONFIRM_MSG_BG_R = 195,
    HWND_OAD_TUNE_BG_TITLE = 196,
    HWND_OAD_TUNE_SCAN_PROGRESS_PANE = 197,
    HWND_OAD_TUNE_SCAN_PROGRESS_PERCENT = 198,
    HWND_OAD_TUNE_SCAN_PROGRESS_PERCENT_TEXT = 199,
    HWND_OAD_TUNE_SCAN_PROGRESS_CH_TYPE = 200,
    HWND_OAD_TUNE_SCAN_PROGRESS_CH_UHF = 201,
    HWND_OAD_TUNE_SCAN_PROGRESS_BAR = 202,
    HWND_FAVORITE_NETWORK_PAGE = 203,
    HWND_FAVORITE_NETWORK_BG_PANE = 204,
    HWND_FAVORITE_NETWORK_CONFIRM_MSG_BG = 205,
    HWND_FAVORITE_NETWORK_CONFIRM_MSG_BG_TOP = 206,
    HWND_FAVORITE_NETWORK_CONFIRM_MSG_BG_L = 207,
    HWND_FAVORITE_NETWORK_CONFIRM_MSG_BG_C = 208,
    HWND_FAVORITE_NETWORK_CONFIRM_MSG_BG_R = 209,
    HWND_FAVORITE_NETWORK_BG_TITLE = 210,
    HWND_FAVORITE_NETWORK_SEL_BAR = 211,
    HWND_FAVORITE_NETWORK_SEL_LEFT_ARW = 212,
    HWND_FAVORITE_NETWORK_SEL_RIGHT_ARW = 213,
    HWND_FAVORITE_NETWORK_SEL_OPTION = 214,
    HWND_FAVORITE_NETWORK_HELP_MSG = 215,
    HWND_FAVORITE_NETWORK_MSG1_LR_ICON = 216,
    HWND_FAVORITE_NETWORK_MSG1_L_ICON = 217,
    HWND_FAVORITE_NETWORK_MSG1_R_ICON = 218,
    HWND_FAVORITE_NETWORK_MSG1_SELECT_TEXT = 219,
    HWND_FAVORITE_NETWORK_MSG1_OK_ICON = 220,
    HWND_AUTO_TUNING_MAX = 221,
...
#define ZUI_AUTO_TUNING_XSTART   618
#define ZUI_AUTO_TUNING_YSTART   28
#define ZUI_AUTO_TUNING_WIDTH   320
#define ZUI_AUTO_TUNING_HEIGHT   303
