...
//            printf("u16TempID=%u\n", u16TempID);
        case HWND_MSGBOX_COMMON_TEXT2:
        {
			...
			case EN_MSGBOX_MODE_PARENTAL_BLOCK:
                    {
                        U8 au8VchipString[128];
    					Str8_StrCpy_CheckDest((char *)au8VchipString, (const char *)RatingInfoText(), 128);
    					//MApp_U8StringToU16String(au8VchipString, CHAR_BUFFER, strlen((const char *)au8VchipString));
                        MApp_U8StrToU16Str_CheckBufSize(au8VchipString, CHAR_BUFFER, STRING_BUFFER_LENGTH);
                    }
					return CHAR_BUFFER;
    #endif
