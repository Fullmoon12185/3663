...
static LPTSTR MApp_ZUI_ACT_GetAudioLanguageString(U8 u8index)
{
    ...
    {
    #if 1
        U16 u16StrLen = Str16_StrLen(u16StrLang);
        if( u16StrLen < (STRING_BUFFER_LENGTH-3) )
        {
            u16StrLang[u16StrLen++] = 0x20;
            u16StrLang[u16StrLen++] = 0x30 + Lang_Count;
            u16StrLang[u16StrLen] = 0;
        }
    #else
        U8 u8StrLang[20];
