...
//==============CI INFORMATION=========================================//
   ...
   // },
...
#if (ENABLE_SUPPORT_AQBIN_FLOW)
    {
        ...
        EN_FACTORY_PAGE_OTHER,
        EN_FACTORY_PAGE_ROOT, EN_FACTORY_PAGE_OTHER,
        3, en_str_AQ_Model_Index, FALSE
    },
    {
        // AQ USB Update
        EN_FACTORY_PAGE_OTHER,
        EN_FACTORY_PAGE_ROOT, EN_FACTORY_PAGE_OTHER,
        4, en_str_AQ_USB_Update, FALSE
    },
#endif
#if (ENABLE_UART_MSG_TO_USB)
    //==Usb Dump=============================================
    ...
    switch(_eFactoryMenuPage)
    {
        ...
        case EN_FACTORY_PAGE_OTHER:
            switch(u8Item)
            {
                ...
                {
                #if (ENABLE_SUPPORT_AQBIN_FLOW)
                    g_stFactorySetting.u8AQBinModelIdx = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,(U16) g_stFactorySetting.u8AQBinModelIdx, 0, AQModelIdxMax, 1);
                    printf("\r\n Switch AQ bin Model Index to %d\n",g_stFactorySetting.u8AQBinModelIdx);
                #endif
                    return EN_REDRAW_ITEM;
                }
                break;
     ...
     case EN_FACTORY_PAGE_SCRIPT_EXECUTE_PAGE: //wing
        ...
        case EN_FACTORY_PAGE_OTHER: //wing
            switch(u8Item)
            {
                ...
                {
                #if (ENABLE_SUPPORT_AQBIN_FLOW)
                    return MApp_ZUI_API_GetU16String(g_stFactorySetting.u8AQBinModelIdx);
                #endif
                }
                break;
            #else
...
BOOLEAN MApp_ZUI_ACT_ExecuteFactoryMenuAction(U16 act)
{
    switch(act)
    {
        ...
        #if (ENABLE_SUPPORT_AQBIN_FLOW)
            else if(_eFactoryMenuPage == EN_FACTORY_PAGE_OTHER &&
                MApp_ZUI_API_GetFocus() == HWND_FACTORY_MENU_ITEM4)
            {
                printf("\r\n AQ Bin Update! \n");
                u8KeyCode=KEY_NULL;
