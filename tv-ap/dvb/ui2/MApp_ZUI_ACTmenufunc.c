        ...
        if( IsDTVInUse() )
        {
            ...
            else
            {
                ...
                #endif
                {
                    ...
                    {
                        MApp_PVR_PlaybackAdAudioStopLanguage(g_u8AdAudSelected);
                    }
                    else
                    #endif
                    {
...
BOOLEAN MApp_ZUI_ACT_ExecuteMenuItemAction(U16 act)
{
    switch(act)
    {
        ...
        case EN_EXE_INC_SOUND_120_HZ:
            {
                //from case MAPP_UIMENUFUNC_ADJU16C1_SOUND_USER_120HZ:
                //MApp_UiMenuFunc_CheckAudioMode();
...
U16 _MApp_ZUI_ACT_GetPictureModeStringID(void)
{
    ...
    switch(ST_VIDEO.ePicture)
    {
        default:
        case PICTURE_Vivid:
            u16TempID=en_str_Vivid;
            break;
        case PICTURE_NORMAL:
            u16TempID=en_str_Standard;
            break;
        case PICTURE_Soft:
            u16TempID=en_str_Soft;
            break;
        case PICTURE_USER:
    #if PICTURE_USER_2
        ...
        case PICTURE_NATURAL:
            u16TempID=en_str_Natural;
            break;
        case PICTURE_SPORTS:
            u16TempID=en_str_Sports;
            break;
        case PICTURE_LIGHTNESS:
            u16TempID=en_str_Lightness;
            break;
    #endif
    }
    #if ENABLE_AUTOTEST
...
//        case HWND_MENU_PIC_ADJ_TEMP_RED_OPTION:
        case HWND_MENU_COMMON_ADJ_ITEM2_OPTION://HWND_MENU_PICCOLOR_COLOR_RED_OPTION:
...
//        case HWND_MENU_PIC_ADJ_TEMP_GREEN_OPTION:
        case HWND_MENU_COMMON_ADJ_ITEM3_OPTION://HWND_MENU_PICCOLOR_COLOR_GREEN_OPTION:
...
//        case HWND_MENU_PIC_ADJ_TEMP_BLUE_OPTION:
        case HWND_MENU_COMMON_ADJ_ITEM4_OPTION://HWND_MENU_PICCOLOR_COLOR_BLUE_OPTION:
...
U16 _MApp_ZUI_ACT_GetSpdifAudioDelayValue(void)
{
       return (stGenSetting.g_SoundSetting.Audiodelay);
}
...
LPTSTR MApp_ZUI_ACT_GetMenuItemDynamicText(HWND hwnd)
{
    ...
    switch (hwnd)
    {
        ...
        case HWND_MENU_PICTURE_ASPECT_RATIO_OPTION:
            ...
            && MApp_Scaler_Is_AspectRatioSupported_ByUI(EN_AspectRatio_Point_to_Point))
            {
                u16TempID = en_str_PointToPoint;
            }
          #endif
        ...
        case HWND_MENU_HDMI_CEC_DEVICE_LIST_J_PORT_TEXT :
            ...
            #if 1
                char acTmpStrBuf[32];
                memset(acTmpStrBuf, 0, 32);
                snprintf( acTmpStrBuf, 32, "HDMI%d", u16Value);
                return MApp_ZUI_API_StringBuffU8toU16(CHAR_BUFFER, (U8*)acTmpStrBuf, strlen(acTmpStrBuf) );
            #else
...
////==================================================================
    ...
    //==========================================================================
        ...
        // ========== SINGLELIST_ITEM18 ==========
        case HWND_MENU_SINGLELIST_ITEM18:
            switch (MApp_ZUI_ACT_GetSingleListMode())
            {
                case EN_COMMON_SINGLELIST_PARENTAL_GUIDANCE:
                    #if ENABLE_ZIGGO
...
#if ENABLE_DMP
            if (IsVgaInUse()||((IsStorageInUse())&&MApp_MPlayer_QueryCurrentMediaType()==E_MPLAYER_TYPE_PHOTO)||(IsHDMIInUse()&&(stXC_WinTime_Info.bMemFmt422==FALSE))||stXC_WinTime_Info.bFBL==TRUE)
            {
                return EN_DL_STATE_DISABLED;
            }
            else
