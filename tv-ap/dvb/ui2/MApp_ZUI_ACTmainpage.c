...
*/
    ...
    //**********************************************
        ...
        case EN_EXE_GOTO_NOISE_REDUCTION_PAGE:
        {
            ...
            eNR = MApp_MenuFunc_Video_NOISE_REDUCTION_Get();
            switch (eNR)
            {
                case MS_NR_OFF:
                   MApp_ZUI_API_SetFocus(HWND_MENU_SINGLELIST_ITEM1);
            ...
            switch(stGenSetting.g_BlockSysSetting.u8ParentalControl)
            {
                ...
                case 10:
                    ...
                    if(IS_SBTVD_APP)
                        ...
                        wNDTemp = HWND_MENU_SINGLELIST_ITEM9;
                #else
                   wNDTemp = HWND_MENU_SINGLELIST_ITEM9;
                #endif
                ...
                case 12:
                    ...
                    if(IS_SBTVD_APP)
                        ...
                        wNDTemp = HWND_MENU_SINGLELIST_ITEM11;
                #else
                   wNDTemp = HWND_MENU_SINGLELIST_ITEM11;
                #endif
                    MApp_ZUI_CTL_DynamicListSetItemFocus(HWND_MENU_SINGLELIST_COMMON_PAGE_LIST, wNDTemp);
                ...
                case 14:
                    ...
                    if(IS_SBTVD_APP)
                        ...
                        wNDTemp = HWND_MENU_SINGLELIST_ITEM13;
                #else
                   wNDTemp = HWND_MENU_SINGLELIST_ITEM13;
                #endif
                    MApp_ZUI_CTL_DynamicListSetItemFocus(HWND_MENU_SINGLELIST_COMMON_PAGE_LIST, wNDTemp);
                ...
                case 16:
                    ...
                    if(IS_SBTVD_APP)
                        ...
                        wNDTemp = HWND_MENU_SINGLELIST_ITEM15;
                #else
                   wNDTemp = HWND_MENU_SINGLELIST_ITEM15;
                #endif
                    MApp_ZUI_CTL_DynamicListSetItemFocus(HWND_MENU_SINGLELIST_COMMON_PAGE_LIST, wNDTemp);
                ...
                case 18:
                    ...
                    if(IS_SBTVD_APP)
                        ...
                        wNDTemp = HWND_MENU_SINGLELIST_ITEM17;
                #else
                   wNDTemp = HWND_MENU_SINGLELIST_ITEM17;
                #endif
                    MApp_ZUI_CTL_DynamicListSetItemFocus(HWND_MENU_SINGLELIST_COMMON_PAGE_LIST, wNDTemp);
                   ...
                   break;
                case 19:
                   MApp_ZUI_CTL_DynamicListSetItemFocus(HWND_MENU_SINGLELIST_COMMON_PAGE_LIST, HWND_MENU_SINGLELIST_ITEM18);
                   break;
            #else
                case 4:
                   MApp_ZUI_CTL_DynamicListSetItemFocus(HWND_MENU_SINGLELIST_COMMON_PAGE_LIST, HWND_MENU_SINGLELIST_ITEM2);
        ...
        case EN_EXE_GOTO_SOUND_BALANCE_PAGE:
            ...
            MApp_ZUI_API_ShowWindow(HWND_MENU_TRANSPARENT_BG, SW_SHOW);
            MApp_ZUI_API_ShowWindow(HWND_MENU_COMMON_ADJ_PAGE, SW_SHOW);
            if(MApp_ZUI_API_IsWindowEnabled(HWND_MENU_COMMON_ADJ_ITEM2) == FALSE)//modify by munez
            {
                MApp_ZUI_API_EnableWindow(HWND_MENU_COMMON_ADJ_ITEM2,TRUE);
            }
...
LPTSTR MApp_ZUI_ACT_GetSingleListDynamicText(HWND hwnd)
{
    ...
    switch(hwnd)
    {
        ...
        case HWND_MENU_SINGLELIST_ITEM17_OPTION:
            switch(_eCommonSingleMode)
            {
                case EN_COMMON_SINGLELIST_PARENTAL_GUIDANCE:
                    ...
                    break;
                  #else
                        return MApp_ZUI_API_GetU16String(EN_F4_LockSystem_Min+16);
                  #endif
                default:
                    break;
            }
        ...
        case HWND_MENU_SINGLELIST_ITEM18_OPTION:
            switch(_eCommonSingleMode)
            {
                case EN_COMMON_SINGLELIST_PARENTAL_GUIDANCE:
