    ...
    switch(hwnd)
    {
            ...
            switch (stGenSetting.g_Time.cOnTimerSourceFlag)
            {
                ...
                case EN_Time_OnTimer_Source_HDMI:
                    ...
                    if(INPUT_HDMI_VIDEO_COUNT >= 2)
                        ...
                        printf("nguyen test en_str_HDMI1 123");
                    break;
                #endif
        ...
        case HWND_MENU_COMMON_ADJ_ITEM5_OPTION://HWND_MENU_TIME_ONTIME_CHANNEL_OPTION:
        {
            ...
            switch (stGenSetting.g_Time.cOnTimerSourceFlag)
            {
                ...
                case EN_Time_OnTimer_Source_ATSC:
                    {
                        MS_VIRTUAL_CHANNEL stTempVirtualChNum;
                        MApp_ChanProc_GetSingleVirtualChannel(&stTempVirtualChNum, VIR_CH_IDX(stGenSetting.g_Time.cOnTimerChannel));
                        MApp_UiMenuFunc_ConvertProgramNumber2Str(&stTempVirtualChNum.stVirtualChNum, au8Section);
