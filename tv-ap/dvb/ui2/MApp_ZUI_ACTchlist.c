...
#define CHLIST_MARQUEE_ITEM_OFFSET      (HWND_CHLIST_ITEM0_TEXT - HWND_CHLIST_ITEM0)
#define CHLIST_MARQUEE_ITEM (MApp_ZUI_API_GetFocus()+CHLIST_MARQUEE_ITEM_OFFSET)
...
static LPTSTR _Chlist_softkeyboard_dynamictext(HWND hWnd)
{
    ...
    //MApp_ZUI_API_StringBuffU8toU16( CHAR_BUFFER, (MS_U8*)u8Str, 1);

    ((U16*)CHAR_BUFFER)[0] = _Chlist_softkeyboard_dispchar(hWnd);
    ((U16*)CHAR_BUFFER)[1] = 0;
...
static void _MApp_ZUI_ACT_CHLISTResetAllMarqueeTextAnimation(void)
{
    U8 u8Index;

    for(u8Index = 0;u8Index < CHANNEL_LIST_PAGE_NUM;u8Index++)
    {
        _MApp_ZUI_ACT_CHLISTMarqueeTextEnableAnimation(_ChannelListHwndList[u8Index]+CHLIST_MARQUEE_ITEM_OFFSET,FALSE);
    }
}
...
static void _MApp_OpMenuList_Handler (U16 u16ActiveProgOrder, U16 u16ShiftProgIndex, U16 u16TotalSrvCount, U8 u8SrvCommand)
{
    ...
    _MApp_ZUI_ACT_CHLISTResetAllMarqueeTextAnimation();
       ...
       case HWND_MENU_CHLIST_SOFTKEYBOARD_TITLE_M:
        {
             ...
             MApp_U8StrToU16Str_CheckBufSize(u8ProgName_chlist, CHAR_BUFFER, STRING_BUFFER_LENGTH);
             return CHAR_BUFFER;
        }
    #endif
...
//Channel number
                ...
                //MApp_ZUI_API_StringBuffU8toU16(CHAR_BUFFER, au8Section, STRING_BUFFER_LENGTH);
                MApp_U8StrToU16Str_CheckBufSize(au8Section, CHAR_BUFFER, STRING_BUFFER_LENGTH);
