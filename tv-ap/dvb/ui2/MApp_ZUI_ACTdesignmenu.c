...
static U8 GetDesignMenuItemIndex(DESIGN_MENU_ITEM stuMenuItem)
{
    ...
    {
        if (_DesignMenuItem[i].u8ShowItem == 0) //    Լ��: ��ҳ�������������Ϊ0
            ucMenuIndex = 0;
        else
            ucMenuIndex ++;
        ...
        if(_DesignMenuItem[i].eCurPage == EN_DESIGN_PAGE_SW_INFO_PAGE && _DesignMenuItem[i].u8ShowItem == 1)
            ucMenuIndex = 1; // EN_DESIGN_PAGE_SW_INFO_PAGEҳ��: ��1��ʼ�ģ�����ԭ���Ѿ�����ʾ����.
...
// ----------------------------------------------------------
// ����˵��: ��ȡ_DesignMenuItem�����u8ShowItemֵ
// ����˵��:
//    enuCurPage: ��ǰҳ�����DESIGN_MENU_PAGE
//    ucItemIndex: �˵����0��ʼ������
// ����˵��:
//    ����_DesignMenuItem�����u8ShowItemֵ
// ����˵��:
//    Լ��: ��ҳ�������������Ϊ0
// ----------------------------------------------------------
static U16 GetDesignMenuItemu8ShowItem(DESIGN_MENU_PAGE enuCurPage, U8 ucItemIndex)
{
    ...
    if(enuCurPage == EN_DESIGN_PAGE_SW_INFO_PAGE)
        ucMenuItemuIndex = 1; // EN_DESIGN_PAGE_SW_INFO_PAGEҳ��: ��1��ʼ�ģ���������ʾ����.
    for (i = 0; i < COUNTOF(_DesignMenuItem); i++)
    {
...
// ----------------------------------------------------------
// ����˵��: ��ȡ_DesignMenuItem�����16StringIDֵ
// ����˵��:
//    enuCurPage: ��ǰҳ�����DESIGN_MENU_PAGE
//    ucItemIndex: �˵����0��ʼ������
// ����˵��:
//    ����_DesignMenuItem�����16StringIDֵ
// ����˵��:
//    Լ��: ��ҳ�������������Ϊ0
// ----------------------------------------------------------
        ...
        case EN_DESIGN_PAGE_PICTURE_MODE:
            switch(u8Item)
            {
                ...
                case 1: //from case MAPP_UIMENUFUNC_SUB_BC_ADJUST_SUB_BRIGHTNES:
                    ...
                    //msAPI_ACE_PicSetBrightness(MApp_Scaler_DesignAdjBrightness(ST_PICTURE.u8Brightness,ST_SUBCOLOR.u8SubBrightness));

                    MApi_XC_ACE_PicSetBrightnessInVsync(MAIN_WINDOW, MApi_XC_Sys_ACE_transfer_Bri((MApp_Scaler_DesignAdjBrightness(msAPI_Mode_PictureBrightnessN100toReallyValue(ST_PICTURE.u8Brightness),ST_SUBCOLOR.u8SubBrightness)), BRIGHTNESS_R),
                                                              MApi_XC_Sys_ACE_transfer_Bri((MApp_Scaler_DesignAdjBrightness(msAPI_Mode_PictureBrightnessN100toReallyValue(ST_PICTURE.u8Brightness),ST_SUBCOLOR.u8SubBrightness)), BRIGHTNESS_G),
                                                              MApi_XC_Sys_ACE_transfer_Bri((MApp_Scaler_DesignAdjBrightness(msAPI_Mode_PictureBrightnessN100toReallyValue(ST_PICTURE.u8Brightness),ST_SUBCOLOR.u8SubBrightness)), BRIGHTNESS_B));
                ...
                case 2: //from case MAPP_UIMENUFUNC_SUB_BC_ADJUST_SUB_CONTRAST:
                    ...
                    MApi_XC_ACE_PicSetContrast(MAIN_WINDOW, MApi_XC_IsYUVSpace(MAIN_WINDOW), MApp_Scaler_DesignContrast(msAPI_Mode_PictureContrastN100toReallyValue(ST_PICTURE.u8Contrast),ST_SUBCOLOR.u8SubContrast));
...

                {
                    if(EN_NONLINEAR_BRIGHTNESS_CURVE == _eNonlinearCurveOption[src])
                    {
                        MApi_XC_ACE_PicSetBrightnessInVsync(MAIN_WINDOW,
                                                    MApi_XC_Sys_ACE_transfer_Bri((MApp_Scaler_DesignAdjBrightness(msAPI_Mode_PictureBrightnessN100toReallyValue(ST_PICTURE.u8Brightness),ST_SUBCOLOR.u8SubBrightness)), BRIGHTNESS_R),
                                                    MApi_XC_Sys_ACE_transfer_Bri((MApp_Scaler_DesignAdjBrightness(msAPI_Mode_PictureBrightnessN100toReallyValue(ST_PICTURE.u8Brightness),ST_SUBCOLOR.u8SubBrightness)), BRIGHTNESS_G),
                                                    MApi_XC_Sys_ACE_transfer_Bri((MApp_Scaler_DesignAdjBrightness(msAPI_Mode_PictureBrightnessN100toReallyValue(ST_PICTURE.u8Brightness),ST_SUBCOLOR.u8SubBrightness)), BRIGHTNESS_B));
                    }
                    else if(EN_NONLINEAR_CONTRAST_CURVE == _eNonlinearCurveOption[src])
