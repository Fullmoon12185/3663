...
static U8 UiMenuStr_GetTVRatingString(U8 *pu8Str, U16 u16StrBufSize)
{
    U8 u8Strlen = 0;


    //strncpy((char *)pu8Str, (char *)VChipTVPGMenuItemName_Text(), strlen((char *)VChipTVPGMenuItemName_Text()));
    Str8_StrCpy_CheckDest((char *)pu8Str, (char *)VChipTVPGMenuItemName_Text(), u16StrBufSize);

    u8Strlen = strlen((char *)pu8Str );

    if( u8Strlen >= (u16StrBufSize-3) )
    {
        return u8Strlen;
    }
...
U8 UiMenuStr_GetVChip1RatingString(U8* pu8Str, U16 u16StrBufSize)
{
    U8 u8Strlen;
...
#endif
    {
        ...
        //    strcat((char *)pu8Str, " / ");
        //}
        u8Strlen += UiMenuStr_GetTVRatingString(pu8Str, u16StrBufSize);
    }
