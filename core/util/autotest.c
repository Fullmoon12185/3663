...
void dhry2(unsigned int* final)
{
    ...
    U8    Ch_Index;
    U32   Enum_Loc;
    U8    Str_1_Loc[STRU_RECORD_STR_SIZE];
    U8    Str_2_Loc[STRU_RECORD_STR_SIZE];
    U32   Run_Index;
    ...
    Str8_StrCpy_CheckDest((char *)Ptr_Glob->variant.var_1.Str_Comp, "DHRYSTONE PROGRAM, SOME STRING", STRU_RECORD_STR_SIZE);
    Str8_StrCpy_CheckDest((char *)Str_1_Loc, "DHRYSTONE PROGRAM, 1'ST STRING", STRU_RECORD_STR_SIZE);
    ...
    do
    {
        ...
        for(Run_Index = 1; Run_Index <= Number_Of_Runs; ++Run_Index)
        {
            ...
            Int_1_Loc = 2;
            Int_2_Loc = 3;
            Str8_StrCpy_CheckDest((char *)Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING", STRU_RECORD_STR_SIZE);
            Enum_Loc = 1;
            ...
            for(Ch_Index = 'A'; Ch_Index <= Ch_2_Glob; ++Ch_Index)
            {
                ...
                {
                    Proc_6(0, &Enum_Loc);
                    Str8_StrCpy_CheckDest((char *)Str_2_Loc, "DHRYSTONE PROGRAM, 3'RD STRING", STRU_RECORD_STR_SIZE);
                    Int_2_Loc = Run_Index;
                    Int_Glob = Run_Index;
                }
            }
