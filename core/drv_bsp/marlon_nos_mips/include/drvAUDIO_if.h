...
typedef enum
{
    ...
    HDMI_OUT_8CH_NONPCM,                ///< HDMI OUTPUT non-PCM with 8 Channel output
} HDMI_TX_OUTPUT_TYPE;
...
typedef enum
{
    ...
    AU_SIF_CMD_FM_RADIO_SET_SCAN_MODE   = 0x19,
    ...
    AU_SIF_CMD_GET_FM_RADIO_AMP_HI      = 0x8D,
    AU_SIF_CMD_GET_FM_RADIO_AMP_LO      = 0x8E,
...
typedef enum
{
    ...
    AU_DVB_STANDARD_DTSXLL,               //0x1C
    AU_DVB_STANDARD_OPUS,               //0x1D
    AU_DVB_STANDARD_MAX,
...
typedef enum
{
    ...
    MSAPI_AUD_DVB2_XPCM,                ///< 0x39:
    MSAPI_AUD_DVB2_KTV,                 ///< 0x3A:
    MSAPI_AUD_DVB2_KTV2,                ///< 0x3B:
    MSAPI_AUD_DVB2_DTS,                 ///< 0x3C:
    MSAPI_AUD_DVB2_TONEGEN,             ///< 0x3D:
...
typedef struct
{
    ...
    MS_U32 u32StructSize;    //sizeof(AUDIO_OUTPUT_DEVICE_SELECTION_VERSION)
...
{
    E_AUD_3_PARSER = 0x0,
    E_AUD_4_PARSER_type1 = 0x1,    ///<K3S_type
    E_AUD_4_PARSER_type2 = 0x2,    ///<eiffle_type
    E_AUD_1_PARSER = 0x3,
    E_AUD_2_PARSER = 0x4,
