...
typedef enum
{
    ...
    #ifdef IRSEND_ENABLE
    /// mbx command for send key start
    E_IR_CPUTo51_CMD_SENDKEY_START,
    /// mbx command for send key
    E_IR_CPUTo51_CMD_SENDKEY,
    /// mbx command for send key stop
    E_IR_CPUTo51_CMD_SENDKEY_STOP,
    #endif
} IR_CPUTo51CmdIdx;
...
typedef enum
{
    ...
    #ifdef IRSEND_ENABLE
    /// ack mbx command for send key start
    E_IR_51ToCPU_CMD_ACK_SENDKEY_START,
    /// ack mbx command for send key
    E_IR_51ToCPU_CMD_ACK_SENDKEY,
    /// ack mbx command for send key stop
    E_IR_51ToCPU_CMD_ACK_SENDKEY_STOP,
    #endif
...
typedef enum
{
    ...
    #ifdef IRSEND_ENABLE
    /// ack flag for wait send key start
    E_IR_ACKFLG_WAIT_SENDKEY_START    = (1<<8),
    /// ack flag for wait send key
    E_IR_ACKFLG_WAIT_SENDKEY    = (1<<9),
    /// ack flag for wait send key stop
    E_IR_ACKFLG_WAIT_SENDKEY_STOP    = (1<<10),
    #endif
} IR_AckFlags;
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_Init(IR_RegCfg *pIRRegCfg);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_Config(IR_TimeBnd *pIRTimeBnd);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_GetKeyCode(MS_U8 *pu8Key, MS_U8 *pu8Repeat);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_SetCallback(IR_Callback pCallback);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Callback MDrv_IR_GetCallback(void);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_GetLibVer(const MSIF_Version **ppVersion);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_GetStatus(MS_U8 *pu8IRStatus);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_Enable(MS_BOOL bEnable);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC const IR_DrvInfo* MDrv_IR_GetInfo(void);
...
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_SetDbgLevel(IR_DbgLvl eLevel);

#ifdef IRSEND_ENABLE
//-------------------------------------------------------------------------------------------------
/// Set IR data start function.
/// @param 
/// @return E_IR_OK: Success
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_SendKey_Start(void);

//-------------------------------------------------------------------------------------------------
/// Set IR data function.
/// @param u8addr1, u8addr2,  u8data: customer codes, data codes, according to ir protocal
/// @return E_IR_OK: Success
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_SendKey( MS_U8 u8addr1,  MS_U8 u8addr2, MS_U8 u8data1, MS_U8 u8data2 );

//-------------------------------------------------------------------------------------------------
/// Set IR data stop function.
/// @param 
/// @return E_IR_OK: Success
/// @return E_IR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC IR_Result MDrv_IR_SendKey_Stop(void);
#endif
...
DLL_PUBLIC void MDrv_IR_OpenDevice(void);
DLL_PUBLIC void MDrv_IR_InitCfg(IR_InitCfgParam* pInitCfg);
DLL_PUBLIC void MDrv_IR_TimeCfg(IR_TimeCfgParam* pTimeCfg);
DLL_PUBLIC void MDrv_IR_GetPulseShot(IR_PulseShotInfo* pPulseShotInfo);
DLL_PUBLIC void MDrv_IR_SetMultiHeaderCode(MS_MultiIR_HeaderInfo* pMultiHeaderCode);
