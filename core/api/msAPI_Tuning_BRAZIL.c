...
void _msAPI_SBTVD_TuningProcessor(eAFTSTEP eState)
{
    ...
    switch ( _eCurrentTuningState )
    {
        ...
        case AFT_EXT_STEP_SEARCHONECH:
                ...
                if(_eCurrentTuningState == AFT_EXT_STEP_SEARCHALL)
                {
                ...
                else
                {
                    ...
                    u8StartFrom = u8IdleMajorValue-1;
                }
                #endif
        ...
        case AFT_MEMORIZEPRDATA:
                ...
                if(eAutoSearchType == E_AUTO_SEARCH_TYPE_ONETOUP)
                {
