...
//        #define MAX_SERVICE_NAME           27//20+1+2//Brazil only need 20 chars+0xE Char+2 char for 10.1 channel
    ...
    //@@--Changed for Some long name Channel
        ...
        #if(ENABLE_ZIGGO)
        #define MAX_DTVPROGRAM              520//600
        #define MAX_SERVICE_NAME            52//32
        #define MAX_DTVPROGRAM_DVBC         520//600 // MAX_DTV_C_PROGRAM
        #else
        #define MAX_DTVPROGRAM              600//600
        #define MAX_SERVICE_NAME            32//32
        #define MAX_DTVPROGRAM_DVBC         600//600 // MAX_DTV_C_PROGRAM
        #endif
