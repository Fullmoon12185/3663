...
#define FSENV_DBG(x)        //x
#define DEBUG_FSENV(x)      //x
#define DEBUG_FSENV_MMAP(x) //x


static FS_EnvironmentStruct g_environment_list[MAX_FS_ENVIRONMENT_NUM];
...
BOOLEAN msAPI_FSEnv_Init(U32 u32FS_adr,U32 u32FS_len)
{
    ...
    DEBUG_FSENV_MMAP( printf("USB_IO_TEMP_ADDR_CACHE=%X\n", USB_IO_TEMP_ADDR_CACHE); );
    DEBUG_FSENV_MMAP( printf("USB_IO_TEMP_ADDR=%X\n", USB_IO_TEMP_ADDR); );
    ...
    DEBUG_FSENV_MMAP( printf("STORAGE_DEVICE_MEMORY_ADDR=%X\n", STORAGE_DEVICE_MEMORY_ADDR); );
    ...
    DEBUG_FSENV_MMAP( printf("DRIVE_MEMORY_ADDR=%X\n", DRIVE_MEMORY_ADDR); );
    ...
    DEBUG_FSENV_MMAP( printf("FILE_SYSTEM_MOUNTED_ADDR=%X\n", FILE_SYSTEM_MOUNTED_ADDR); );
    ...
    DEBUG_FSENV_MMAP( printf("FILE_ENVIRONMENT_POOL=%X, %X\n", FILE_ENVIRONMENT_POOL, FILE_ENVIRONMENT_POOL_LEN); );
    ...
    DEBUG_FSENV_MMAP( printf("FILE_FAT_TABLE_CACHE=%X, %X\n", FILE_FAT_TABLE_CACHE, FILE_FAT_TABLE_CACHE_LEN); );
    ...
    DEBUG_FSENV_MMAP( printf("FILE_INODE_POOL=%X, %X\n", FILE_INODE_POOL, FILE_INODE_POOL_LEN); );


    FILE_HANDLE_POOL = (FILE_INODE_POOL + FILE_INODE_POOL_LEN);
    FILE_HANDLE_POOL_LEN = (FILE_HANDLE_MEMORY_SIZE * FS_FILE_HANDLE_NUM);
    DEBUG_FSENV_MMAP( printf("FILE_HANDLE_POOL=%X, %X\n", FILE_HANDLE_POOL, FILE_HANDLE_POOL_LEN); );
    ...
    DEBUG_FSENV_MMAP( printf("N51FS_TEMP_4K_BACKUP_BUFFER_0=%X\n", N51FS_TEMP_4K_BACKUP_BUFFER_0); );
    DEBUG_FSENV_MMAP( printf("N51FS_TEMP_4K_BACKUP_BUFFER_1=%X\n", N51FS_TEMP_4K_BACKUP_BUFFER_1); );
    DEBUG_FSENV_MMAP( printf("N51FS_TEMP_4K_BACKUP_BUFFER_2=%X\n", N51FS_TEMP_4K_BACKUP_BUFFER_2); );
    DEBUG_FSENV_MMAP( printf("N51FS_TEMP_4K_BUFFER_0=%X\n", N51FS_TEMP_4K_BUFFER_0); );
    DEBUG_FSENV_MMAP( printf("N51FS_TEMP_4K_FIXUP=%X\n", N51FS_TEMP_4K_FIXUP); );
...
//~!~
    ...
    DEBUG_FSENV_MMAP( printf("FS_MEMORY_MAP_END=%X\n", FS_MEMORY_MAP_END); );

    FSENV_DBG(printf("Total Used File System Memory: 0x%x(0x%x)!!\n", (FS_MEMORY_MAP_END-_FILE_SYSTEM_POOL_ADR), _FILE_SYSTEM_POOL_LEN));
    ...
    for(i = 0; i<FS_ENVIRONMENT_NUM; i++)
    {
        ...
        DEBUG_FSENV_MMAP( printf("%d) %X %X %X %X\n", i, XDataAddr[i][0], XDataAddr[i][1],XDataAddr[i][2],XDataAddr[i][3]); );
