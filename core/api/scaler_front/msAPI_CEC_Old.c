...
static MS_U8 _au8CecDeviceName[16][MAX_CEC_DEVICE_OSD_NAME];
...
void msAPI_CEC_SetDeviceName(MS_U8 u8Device, MS_U8* pName, MS_BOOL bIsDefault)
{
    if(bIsDefault)
        ...
        Str8_StrCpy_CheckDest((char *)_au8CecDeviceName[u8Device], (char *)gStrCECDeviceType[u8Device], MAX_CEC_DEVICE_OSD_NAME );
    else
        //strncpy((char *)_au8CecDeviceName[u8Device], (char *)pName, strlen((char *)pName));
        Str8_StrCpy_CheckDest((char *)_au8CecDeviceName[u8Device], (char *)pName, MAX_CEC_DEVICE_OSD_NAME );
}
...
void msAPI_CEC_InitVariableForPollingDeviceList(void)
{
    ...
    for(i=E_LA_TV; i<E_LA_UNREGISTERED; i++)
    {
        ...
        Str8_StrCpy_CheckDest((char *)_au8CecDeviceName[i], (char *)gStrCECDeviceType[i], MAX_CEC_DEVICE_OSD_NAME );
    }
}
