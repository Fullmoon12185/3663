...
#if 0 // Use msAPI_Demod_SetupTSPath() to replace this~
...
void msAPI_Tuner_Serial_Control(BOOLEAN bParallelMode, BOOLEAN bPVRMode)
{
    ...
    #else //if ((FRONTEND_DEMOD_DVBT_TYPE == MSTAR_MSB124X_DVBT)||(FRONTEND_DEMOD_DVBT_TYPE == SI2164B_DVBT)) //use extern demod
         MApi_DMX_FlowSet(eDmxFlow, DMX_FLOW_INPUT_EXT_INPUT0, FALSE, TRUE, !bEnable);
    ...
    if(IsDVBTInUse())
    {
        ...
        #else //if ((FRONTEND_DEMOD_DVBT_TYPE == MSTAR_MSB124X_DVBT)||(FRONTEND_DEMOD_DVBT_TYPE == SI2164B_DVBT)) //use external demod
            MApi_DMX_FlowSet(eDmxFlow, DMX_FLOW_INPUT_EXT_INPUT0, FALSE, TRUE, !bEnable);
    ...
    if(IsDVBCInUse())
    {
        ...
        #else //if((FRONTEND_DEMOD_DVBC_TYPE == MSTAR_MSB124X_DVBT)||(FRONTEND_DEMOD_DVBC_TYPE == SI2164B_DVBT))
            MApi_DMX_FlowSet(eDmxFlow, DMX_FLOW_INPUT_EXT_INPUT0, FALSE, TRUE, !bEnable);
        #endif
        }
