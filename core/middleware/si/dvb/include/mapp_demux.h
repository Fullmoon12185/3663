...
typedef struct
{
    ...
    U32 u32SDTScanTimeOut;
    U32 u32PATScanTimeOut;
    U32 u32PMTScanTimeOut;
    U32 u32BATScanTimeOut;
} SI_DMX_TimeoutMilliSec;
...
INTERFACE void MApp_Dmx_SetTimeoutMilliSec(SI_DMX_TimeoutMilliSec stSiTimeoutSec);
