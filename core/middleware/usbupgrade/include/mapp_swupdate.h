...
#ifndef MAPP_SWUPDATE_H
#define    MAPP_SWUPDATE_H

#include "datatype.h"

#ifdef MAPP_SWUPDATE_C
#define INTERFACE
#else
...
typedef enum
{
    SW_UPDATE_MODE_PARTIAL       = 0x00,     // AUTO partial update
    SW_UPDATE_MODE_FULL          = 0x01,     // FULL update
    SW_UPDATE_MODE_PARTIAL_OAD   = 0x02,     // OAD partial update
