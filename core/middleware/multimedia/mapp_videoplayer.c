...
#if (ENABLE_HK_MP4) && (ENABLE_INTERNAL_TEXT_SUBTITLE)
#define ENABLE_HK_SUBTITLE                      1
#else
...
/// Define the HKMP4 Version Info
typedef enum
{
    E_VDP_HKMP4_VERSION_NONE = 0,
    /// Version 1: MAX_VIDEO_TRACKS = 4, MAX_SUBTITLE_TRACKS = 16, MAX_MP4_TABLES = 6,
    ///                 MAX_AUDIO_TRACKS  = 10, Turn ON define ENABLE_HK_SUBTITLE
    E_VDP_HKMP4_VERSION_1,
    /// Version 2: MAX_VIDEO_TRACKS = 4, MAX_SUBTITLE_TRACKS = 16, MAX_MP4_TABLES = 4,
    ///                 MAX_AUDIO_TRACKS  = 10, Turn OFF define ENABLE_HK_SUBTITLE
    E_VDP_HKMP4_VERSION_2,
    /// Version 3: MAX_VIDEO_TRACKS = 1, MAX_SUBTITLE_TRACKS = 8, MAX_MP4_TABLES = 6,
    ///                 MAX_AUDIO_TRACKS  = 10, Turn ON define ENABLE_HK_SUBTITLE
    E_VDP_HKMP4_VERSION_3,
    /// Version 4: MAX_VIDEO_TRACKS = 1, MAX_SUBTITLE_TRACKS = 8, MAX_MP4_TABLES = 4,
    ///                 MAX_AUDIO_TRACKS  = 10, Turn OFF define ENABLE_HK_SUBTITLE
    E_VDP_HKMP4_VERSION_4,
} EN_VDP_HKMP4_VERSION;

#if (ENABLE_DIVX_PLUS)||(ENABLE_DIVX_HT31)||(ENABLE_DIVX_HD13)
#if (ENABLE_HK_SUBTITLE)
    #define HKMP4_VERSION E_VDP_HKMP4_VERSION_1
    #define MAX_MP4_TABLES 6
    #define MAX_AUDIO_TRACKS 10
    #define MAX_VIDEO_TRACKS 4
    #define MAX_SUBTITLE_TRACKS 16
#else
    #define HKMP4_VERSION E_VDP_HKMP4_VERSION_2
...
#else
#if (ENABLE_HK_SUBTITLE)
    #define HKMP4_VERSION E_VDP_HKMP4_VERSION_3
    #define MAX_MP4_TABLES 6
    #define MAX_AUDIO_TRACKS 10
    #define MAX_VIDEO_TRACKS 1
    #define MAX_SUBTITLE_TRACKS 8
#else
    #define HKMP4_VERSION E_VDP_HKMP4_VERSION_4
    #define MAX_MP4_TABLES 4
    #define MAX_AUDIO_TRACKS 10
    #define MAX_VIDEO_TRACKS 1
    #define MAX_SUBTITLE_TRACKS 8
...
static void MApp_VDPlayer_MP4_Init(U32 u32Addr, U16 u16Size, U8 u8version);
            ...
            break;
                    ...
                    case MB_VDPLAYER_MP4_INIT:
                        VDPLAYER_DBG(printf("MB_VDPLAYER_MP4_INIT\n"));
                        {
                            ...
                            u8Version = MB_Message.u8Parameters[4];

                            for (i = 5; i <= 6; i++)
                            {
                                u16Size = (u16Size << 8) | MB_Message.u8Parameters[i];
                            }

                            MApp_VDPlayer_MP4_Init(_PA2VA(u32Addr), u16Size, u8Version);
...
static bool MApp_VDPlayer_Check_HK_MP4_Version(U8 u8Version, U16 u16Size)
{
    if(HKMP4_VERSION != u8Version)
    {
        printf("[Error] HK_MP4 Version is not compatiable!!\n");
        printf("HK_Version = %d, VDP_Version = %d\n", HKMP4_VERSION, u8Version);
    }
    switch(u8Version)
    {
        case E_VDP_HKMP4_VERSION_NONE:
            printf("[Error] HK_MP4 Version Error, Please Check!!\n");
            return false;
            break;
        case E_VDP_HKMP4_VERSION_1:
        case E_VDP_HKMP4_VERSION_2:
        case E_VDP_HKMP4_VERSION_3:
        case E_VDP_HKMP4_VERSION_4:
            if(sizeof(ST_HK_MP4_INIT) == u16Size)
            {
                printf("[PASS] HK_MP4 Version = %d\n", u8Version);
                if(HKMP4_VERSION == u8Version)
                {
                    return true;
                }
            ...
            {
                printf("[Error] HK_MP4 Version(%d) : Size(%x) Error, Please Check!!\n", u8Version, u16Size);
                printf("sizeof(ST_HK_MP4_INIT) = %d u16Size = %d\n", sizeof(ST_HK_MP4_INIT), u16Size);
                return false;
            }
            break;
        default :
...
static void MApp_VDPlayer_MP4_Init(U32 u32Addr, U16 u16Size, U8 u8version)
{
    ...
    if(!MApp_VDPlayer_Check_HK_MP4_Version(u8version, u16Size))
    {
        printf("MApp_VDPlayer_MP4_Init() Fail\n");
    }
