...
//                         SCL              SDA             SPEED
    ...
    ||(MS_BOARD_TYPE_SEL == BD_MST222F_D01A_S)      \
    ||(MS_BOARD_TYPE_SEL == BD_MST084B_10AHB_15043) \
    ||(MS_BOARD_TYPE_SEL == BD_MST084B_10AHB_LVDS) \
    )
    ...
    #define MIIC_BUS_DDCD0  PAD_GPIO1,  PAD_GPIO0,  I2C_SPEED_MAPPING_250K
#elif (MS_BOARD_TYPE_SEL == BD_SOLUM_XL1U)
    #define MIIC_BUS_SYS    PAD_GPIO1,  PAD_GPIO0,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_DDCA0  PAD_GPIO1,  PAD_GPIO0,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_DDCD0  PAD_GPIO1,  PAD_GPIO0,  I2C_SPEED_MAPPING_250K
    #define MIIC_BUS_DDCD1  PAD_SAR2,  PAD_SAR3,  I2C_SPEED_MAPPING_100K
#else
