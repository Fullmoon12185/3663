...
#ifndef _DRV_UART_DEBUG_H_
#define _DRV_UART_DEBUG_H_
...
//*****************************************************************************
#include "drvUartDebug_Common.h"  //include common file for all chip
//*****************************************************************************
...
#define UART_SCAN_CMD_LOCK_STATE                0x14
#define UART_SCAN_CMD_CHECK_PACKET_ERR          0x15
...
typedef enum
{
    ...
    E_DEMOD_DTMB,
    E_DEMOD_ATSC,
}EN_UART_DEMOD_STANDARD;

typedef enum
{
   E_DEMOD_REGISTER_READ    = 3,
   E_DEMOD_REGISTER_WRITE   = 4,
}EN_DEMOD_EXTENDCMD;
