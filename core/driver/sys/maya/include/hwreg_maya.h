...
// for judgement on booting from AC/DC on
#define     PM_SLEEP_POWERON_FLAG               (RIUBASE_PM_SLEEP+0x72)//0x39*2
#define     POWERON_FLAG1                       0x12
#define     POWERON_FLAG2                       0x34

// for wakeup device in Standby mode
#define     PM_SLEEP_NOTIFY_WAKEUP_DEVICE_FLAG  (RIUBASE_PM_SLEEP+0x74) //0x3A*2
// for wakeup device configuration
#define     PM_SLEEP_WAKEUP_DEVICE_FLAG         (RIUBASE_PM_SLEEP+0x76) //0x3B*2

//available dummy keys for application in the future
#if 0
#define     PM_SLEEP_SW_DUMMY0                  (RIUBASE_PM_SLEEP+0x71) //0x38*2+1
#define     PM_SLEEP_SW_DUMMY1                  (RIUBASE_PM_SLEEP+0x78) //0x3C*2
#define     PM_SLEEP_SW_DUMMY2                  (RIUBASE_PM_SLEEP+0x79) //0x3C*2+1
#endif

// IR header codes for HW NEC decode
#define     STNADBY_IR_HEADER_CODE0_1           (RIUBASE_IR+0xA4) //0x52*2      //Customer code 0
#define     STNADBY_IR_HEADER_CODE0_2           (RIUBASE_IR+0xA5) //0x52*2+1  //Customer code 0
#define     STNADBY_IR_HEADER_CODE1_1           (RIUBASE_IR+0xC0) //0x60*2      //Customer code 1
#define     STNADBY_IR_HEADER_CODE1_2           (RIUBASE_IR+0xC1) //0x60*2+1  //Customer code 1
#define     STNADBY_IR_HEADER_CODE1_EN          (RIUBASE_IR+0xC2) //0x61*2     //Customer code 1 enable
#define         _IR_HEADER_CODE1_EN             BIT0

// for wakeup IR keys : max 4 keys (1 byte per key)
#define     STNADBY_WAKEUP_IR_KEY0              (RIUBASE_IR+0xB2) //0x59*2
#define     STNADBY_WAKEUP_IR_KEY1              (RIUBASE_IR+0xB3) //0x59*2+1
#define     STNADBY_WAKEUP_IR_KEY2              (RIUBASE_IR+0xB6) //0x5B*2
#define     STNADBY_WAKEUP_IR_KEY3              (RIUBASE_IR+0xB7) //0x5B*2+1


#define     STNADBY_DUMY0              (RIUBASE_IR+0xB8) //0x5C*2
#define     STNADBY_DUMY1              (RIUBASE_IR+0xB9) //0x5C*2+1
#define     STNADBY_DUMY2              (RIUBASE_IR+0xBA) //0x5D*2
#define     STNADBY_DUMY3              (RIUBASE_IR+0xBB) //0x5D*2+1

#define     REG_PM_CKG_DVI_RAW0                 ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x23*2))
#define     REG_PM_CKG_KREF                     ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x23*2))
//#define     REG_PM_INT_XTALI_FREQ_TUNE          ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x30*2))
#define     REG_PM_K_RPT0                       ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x42*2))
#define     REG_PM_DM_SEL_IB                    ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4A*2))
#define     REG_PM_DM_SEL_IB_ONEPORT            ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4A*2))
#define     REG_PM_DM_CLKSEL                    ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4A*2))
#define     REG_PM_DM_CLKSEL_ONEPORT            ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4A*2))
#define     REG_PM_PD_IBGREX                    ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4A*2))
#define     REG_PM_PD_IBGREX_ONEPORT            ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4A*2))
#define     REG_PM_GCR_SWCK                     ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_GCR_SWCK_OFFL                ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_GCR_SWCK_ONEPORT             ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_PD_CLKIN                     ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_PD_CLKIN_OFFL                ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_PD_CLKIN_ONEPORT             ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_PD_RCK                       ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_PD_RCK_ONEPORT               ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_DVI_SWCK_HW_EN               ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4B*2))
#define     REG_PM_PD_BG                        ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4C*2))
#define     REG_PM_PD_BG_ONEPORT                ((0x00*0x10000)+ (RIUBASE_PM_SLEEP + 0x4C*2))
...
#define     PMC_REG_BASE                        (0x1A00*2)
#define     REG_PM_INT_XTALI_FREQ_TUNE          ((0x00*0x10000)+ (PMC_REG_BASE + 0x05*2))
...
#define IR_COMP_KEY1                            ( RIUBASE_IR + 0xB2 )  //0x3DB2
#define IR_COMP_KEY2                            ( RIUBASE_IR + 0xB3 )  //0x3DB3
#define IR_COMP_KEY3                            ( RIUBASE_IR + 0xB6 )  //0x3DB6
#define IR_COMP_KEY4                            ( RIUBASE_IR + 0xB7 )  //0x3DB7
