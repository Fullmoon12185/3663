...
|| (MS_BOARD_TYPE_SEL == BD_MST090B_10ANU_15213_DVBT)||(MS_BOARD_TYPE_SEL == BD_MST089B_10ANB_15213))
    ...
    #define MIIC_BUS_DDCD0  PAD_GPIO1,  PAD_GPIO0,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_ISP  PAD_GPIO1,  PAD_GPIO0,  I2C_SPEED_MAPPING_200K
#elif  (MS_BOARD_TYPE_SEL == BD_SOLUM_CUS) //SEC_XL1+
    #define MIIC_BUS_SYS    PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_DDCA0  PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_DDCD0  PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_ISP    PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_400K  // Tuner IIC,
    #define MIIC_BUS_DDCD1  PAD_TCON3,  PAD_TCON2,  I2C_SPEED_MAPPING_100K // AMP IIC,
    #define MIIC_BUS_DDCD2  PAD_GPIO26, PAD_GPIO27, I2C_SPEED_MAPPING_100K // SENSOR IIC,
#elif  (MS_BOARD_TYPE_SEL == BD_SOLUM_XL1P_T2) //temp, copy from BD_MST223B_D01A_S
    #define MIIC_BUS_SYS    PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_DDCA0  PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_DDCD0  PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_100K
    #define MIIC_BUS_ISP    PAD_GPIO9,  PAD_GPIO8,  I2C_SPEED_MAPPING_400K  // Tuner IIC,
    #define MIIC_BUS_DDCD1  PAD_TCON7,  PAD_TCON6,  I2C_SPEED_MAPPING_100K // AMP IIC,
    #define MIIC_BUS_DDCD2  PAD_GPIO26, PAD_GPIO27, I2C_SPEED_MAPPING_100K // SENSOR IIC,
...
#if ((MS_BOARD_TYPE_SEL == BD_SOLUM_CUS)||(MS_BOARD_TYPE_SEL == BD_SOLUM_XL1P_T2))
