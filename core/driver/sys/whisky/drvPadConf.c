...
#define _MapBase_nonPM_WHISKY 0xA0200000
#define _MapBase_PM_WHISKY    0xA0000000
...
//---------------------------------------------------------------------
    ...
    _RVM1(0x1e1c, 0, BIT2|BIT1|BIT0 ),   //reg[101e1c]#2~#0 = 000b
    //reg_agc_dbg = 0
    _RVM1(0x1e06, 0, BIT7 ),   //reg[101e06] #7 = 0
    #endif
    ...
    _RVM1(0x1422, BIT2, BIT2),   //reg[1422] #2 = 0b
    #endif
    ...
    _RVM1(0x1422, BIT1, BIT1),   //reg[1422] #1 = 0b
    #endif
    ...
    _RVM1(0x1422, BIT0,  BIT0),   //reg[1422] #0 = 0b
    #endif
...
//#############################
...
#if (PIN_FLASH_WP0)
  #if ((MS_BOARD_TYPE_SEL == BD_MST233A_D01A_S) || (MS_BOARD_TYPE_SEL == BD_MST090B_10ANU_15213))//PIN_85: PAD_TCON0
    ...
    _RVM1(0x1e1c, 0, BIT2|BIT1|BIT0 ),   //reg[101e1c]#2~#0 = 000b
    _RVM1(0x1e26, 0, BIT7 ),   //reg[101e26]#7 = 0b
  #elif (MS_BOARD_TYPE_SEL == BD_MST233B_D01A_S)//PIN_115: PAD_GPIO30
    _RVM1(0x1e43, BIT2, BIT2), //output high
    _RVM1(0x1e47, 0, BIT2), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST223B_D01A_S) || (MS_BOARD_TYPE_SEL == BD_SOLUM_CUS)|| (MS_BOARD_TYPE_SEL == BD_SOLUM_XL1P_T2))//PIN_120: PAD_GPIO20
    _RVM1(0x1e42, BIT0, BIT0), //output high
    _RVM1(0x1e46, 0, BIT0), //oen: output(0)
   #else
...
void MDrv_Pad_Init( void )
{
    ...
    u32MapBase = _MapBase_nonPM_WHISKY;
    ...
    while (1)
    {
        ...
        if(u16Index == 0x0000) // switch base address
        {
            ...
            u32MapBase = (U32)_MapBase_PM_WHISKY + (u32RegAddr<<1);
            pPadConfig += 2;
            continue;
        }
