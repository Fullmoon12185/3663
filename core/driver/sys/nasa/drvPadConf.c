...
#define _MapBase_nonPM_NASA 0xA0200000
#define _MapBase_PM_NASA    0xA0000000
...
//---------------------------------------------------------------------
    _MEMMAP_nonPM_,
        ...
        _RVM1(0x1e7d, 0, BIT1),   //reg[101e7d]#1 = 0b
        //reg_i2soutconfig[1:0] = 00b
        _RVM1(0x1eae, 0, BIT6 | BIT5),   //reg[101eae]#6 ~#5 = 00b
        //reg_parallel_TS_in_Config[1:0] = 00b
        _RVM1(0x1ef7, 0, BIT5 | BIT4),   //reg[101ef7]#5~#4 = 00b
    ...
    //reg_pmcec_en = 0
    _RVM1(0x1e01, 0, BIT6 ),   //reg[101e01]#6 = 0b
    //reg_parallel_ts_out_config = 000b
    _RVM1(0x1e1c, 0, BIT2|BIT1|BIT0 ),   //reg[101e1c]#2 ~#0 = 000b
    #endif
    ...
    #define PADA_VSYNC1_OEN (PADA_VSYNC1_IS_GPIO == GPIO_IN ? 0 : BIT4) //###(((1: output,0: input)))
        ...
        //reg_test_vsync1[1] = 0b
        _RVM1(0x2561, 0, BIT1),   //reg[102561]#1 = 0b
        //reg_gpio_vsync1_en[4] = 1b
...
#define UART3_MODE   ((PADS_UART3_MODE == PAD_GPIO3) ? BIT2: \
                          (PADS_UART3_MODE == PAD_GPIO4) ? BIT2: 0)
        _RVM1(0x1E05, UART3_MODE, BIT3|BIT2),
#endif

#if (PADS_UART4_MODE != Unknown_pad_mux)
#define UART4_MODE   ((PADS_UART4_MODE == PAD_TCON0) ? BIT6: \
                          (PADS_UART4_MODE == PAD_TCON1) ? BIT6: 0)
        _RVM1(0x1E04, UART4_MODE, BIT7|BIT6),
#endif

#if (PADS_UART5_MODE != Unknown_pad_mux)
#define UART5_MODE   ((PADS_UART5_MODE == PAD_TCON2) ? BIT1: \
                          (PADS_UART5_MODE == PAD_TCON3) ? BIT1: 0)
...
#define DDCDC ((PADS_DDCDC == DDCDC_ENABLE) ? BIT3 : 0)
    ...
    //I2S_IN_MODE1 : PAD_GPIO2, PAD_GPIO3, PAD_GPIO4
#define I2S_IN    ((PADS_I2S_IN == I2S_IN_MODE1) ? BIT3 : 0)
        _RVM1(0x1EAE, I2S_IN, BIT4|BIT3),
#endif

#if (PADS_I2S_OUT != Unknown_pad_mux)
//I2S_OUT_MODE1 : PAD_GPIO2, PAD_TCON2, PAD_TCON4, PAD_TCON5
//I2S_OUT_MODE2 : PAD_GPIO2, PAD_TCON1, PAD_TCON2, PAD_TCON4, PAD_TCON5
//I2S_OUT_MODE3 : PAD_GPIO2, PAD_GPIO3, PAD_GPIO4, PAD_GPIO6, PAD_GPIO7
//I2S_OUT_MODE4 : PAD_GPIO3, PAD_GPIO4, PAD_GPIO6, PAD_GPIO17
//I2S_OUT_MODE5 : PAD_GPIO3, PAD_GPIO4, PAD_GPIO6, PAD_GPIO7
#define I2S_OUT   ((PADS_I2S_OUT == I2S_OUT_MODE1) ? BIT5 : \
                   (PADS_I2S_OUT == I2S_OUT_MODE2) ? BIT6 : 0)
#define I2S_OUT2  ((PADS_I2S_OUT == I2S_OUT_MODE3) ? BIT2 : \
                   (PADS_I2S_OUT == I2S_OUT_MODE4) ? BIT3 : \
                   (PADS_I2S_OUT == I2S_OUT_MODE5) ? BIT4 : 0)
...
#define SPDIF_OUT   ((PADS_SPDIF_OUT == PAD_TCON1) ? BIT1 : 0)
#define SPDIF_OUT2  ((PADS_SPDIF_OUT == PAD_PWM1) ? BIT5 : \
                         (PADS_SPDIF_OUT == PAD_TCON0) ? BIT6 : \
                         (PADS_SPDIF_OUT == PAD_GPIO4) ? BIT7 : 0)
...
#define TS_IN_P_CFG ((PADS_TS_IN_P_CFG == TS_IN_P_MODE(1)) ? BIT4 : \
    ...
    //TS_IN_S_MODE(1) : PAD_TCON7, PAD_TCON8, PAD_TCON9, PAD_TCON10
    //TS_IN_S_MODE(2) : PAD_TCON0, PAD_TCON1, PAD_TCON2, PAD_TCON3
...
//TS_OUT_P_MODE(1) : PAD_TCON0~PAD_TCON3, PAD_TCON5, PAD_GPIO0~PAD_GPIO2, PAD_DDCDA_CLK,PAD_DDCDA_DAT, PAD_DDCDB_CLK,PAD_DDCDB_DAT
//TS_OUT_P_MODE(2) : PAD_TCON0~PAD_TCON3, PAD_TCON5, PAD_GPIO0~PAD_GPIO2, PAD_DDCDA_CLK,PAD_DDCDA_DAT, PAD_DDCDB_CLK
//TS_OUT_P_MODE(3) : PAD_GPIO6~PAD_GPIO12, PAD_GPIO14, PAD_GPIO2, PAD_CEC, PAD_TCON5, PAD_GPIO5
//TS_OUT_P_MODE(4) : PAD_GPIO6~PAD_GPIO12, PAD_GPIO14, PAD_GPIO2, PAD_CEC, PAD_TCON5
#define TS_OUT_P_CFG ((PADS_TS_OUT_P_CFG == TS_OUT_P_MODE(1)) ? BIT0 : \
  ...
  #elif ((MS_BOARD_TYPE_SEL == BD_MST233B_D01A_S_NASA))

  #elif ((MS_BOARD_TYPE_SEL == BD_SEC_XL3_MEGA_NASA))
...
void MDrv_Pad_Init( void )
{
    ...
    u32MapBase = _MapBase_nonPM_NASA;
