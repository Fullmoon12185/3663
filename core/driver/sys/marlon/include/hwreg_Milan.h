...
// CEC reg
//------------------------------------------------------------------------------
#define REG_CEC_RX_LENGTH   ((0x00*0x10000)+ (RIUBASE_PM_CEC + 0x04*2))
#define REG_CEC_DEVICE        ((0x00*0x10000)+ (RIUBASE_PM_CEC + 0x20*2))
#define REG_CEC_OPCODE         ((0x00*0x10000)+ (RIUBASE_PM_CEC + 0x20*2 + 1))
