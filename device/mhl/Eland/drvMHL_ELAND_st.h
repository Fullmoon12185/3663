...
#ifndef _MST_ELAND_ST_H_
#define _MST_ELAND_ST_H_
...
#define DMHL_CTS_SEND_MSC       DISABLE//DISABLE
...
enum
{
    ...
    MSC_WRITE_BURST             = 0x6C, // Write 1-16 bytes to responders scratchpad.
...
#define GET_MHL_RECEIVE_MSC()           (MS_BOOL)((gMHLInfo.ucReceiveIndex & CBUS_RECEIVE_MSC_FLAG) ?TRUE :FALSE)
...
#define GET_MHL_RECEIVE_ACK()           (MS_BOOL)((gMHLInfo.ucReceiveIndex & CBUS_RECEIVE_ACK_FLAG) ?TRUE :FALSE)
...
#define GET_MHL_RECEIVE_ABORT()         (MS_BOOL)((gMHLInfo.ucReceiveIndex & CBUS_RECEIVE_ABORT_FLAG) ?TRUE :FALSE)
...
#define GET_MHL_RECEIVE_RCP()           (MS_BOOL)((gMHLInfo.ucReceiveIndex & CBUS_RECEIVE_RCP_FLAG) ?TRUE :FALSE)
...
#define GET_MHL_RECEIVE_RAP()           (MS_BOOL)((gMHLInfo.ucReceiveIndex & CBUS_RECEIVE_RAP_FLAG) ?TRUE :FALSE)
...
typedef MS_BOOL (*link_mhl_reg_i_func_b)(MS_U16, MS_U8, MS_U8*, MS_U16, MS_U8*);
typedef MS_BOOL (*link_mhl_reg_o_func_b)(MS_U16, MS_U8, MS_U8*, MS_U16, MS_U8*);
