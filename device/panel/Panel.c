...
{
    {
        ...
        1780ul,     //WORD m_wPanelMaxHTotal;           //PANEL_MAX_HTOTAL
        1600ul,//1430,  //WORD m_wPanelHTotal;          //PANEL_HTOTAL
        1580ul,     //WORD m_wPanelMinHTotal;           //PANEL_MIN_HTOTAL

        1050,        //WORD m_wPanelMaxVTotal;           //PANEL_MAX_VTOTAL
        884ul,      //WORD m_wPanelVTotal;              //PANEL_VTOTAL 20060511 chris :for Frame Lock operation
        768,        //WORD m_wPanelMinVTotal;           //PANEL_MIN_VTOTAL
