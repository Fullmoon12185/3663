...
Sys_Info_Type R840_Sys_Sel(R840_Standard_Type R840_Standard)
{
	...
	case R840_MN_5100:   
		R840_Sys_Info.IF_KHz=5100;                    //IF
		R840_Sys_Info.BW=0x60;                          //BW=6M
		R840_Sys_Info.FILT_CAL_IF=6050;          //CAL IF
		R840_Sys_Info.HPF_COR=0x0F;	             //R11[3:0]=15 (0.33M)
    ...
    case R840_MN_5800: 
		R840_Sys_Info.IF_KHz=5800;                    //IF
		R840_Sys_Info.BW=0x40;                          //BW=7M
		R840_Sys_Info.FILT_CAL_IF=6800;          //CAL IF  
		R840_Sys_Info.HPF_COR=0x0A;	             //R11[3:0]=10  (0.9M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x00;   //R30[1:0]=0,  lna=max-1 & Buf 4, hpf+3
		break;
    ...
    case R840_MN_CIF_5M:     
		R840_Sys_Info.IF_KHz=6750;                    //IF
		R840_Sys_Info.BW=0x40;                          //BW=7M
		R840_Sys_Info.FILT_CAL_IF=7750;          //CAL IF  
		R840_Sys_Info.HPF_COR=0x05;	             //R11[3:0]=5  (2M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x00;   //R30[1:0]=0,  lna=max-1 & Buf 4, hpf+3
		break;
	...
	case R840_PAL_I:      
		R840_Sys_Info.IF_KHz=7300;                    //IF
		R840_Sys_Info.BW=0x00;                          //BW=8M
		R840_Sys_Info.FILT_CAL_IF=8650;          //CAL IF  
		R840_Sys_Info.HPF_COR=0x0D;	             //R11[3:0]=13 (0.54M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x00;   //R30[1:0]=0,  lna=max-1 & Buf 4, hpf+3
		break;

	case R840_PAL_I_CIF_5M:       
		R840_Sys_Info.IF_KHz=7750;                    //IF
		R840_Sys_Info.BW=0x00;                          //BW=8M
		R840_Sys_Info.FILT_CAL_IF=9100;          //CAL IF  
	...
	case R840_PAL_DK_CIF_5M: 
		R840_Sys_Info.IF_KHz=7750;                    //IF
		R840_Sys_Info.BW=0x00;                          //BW=8M
		R840_Sys_Info.FILT_CAL_IF=8950;          //CAL IF     
		R840_Sys_Info.HPF_COR=0x09;	             //R11[3:0]=9 (1.15M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x00;   //R30[1:0]=0,  lna=max-1 & Buf 4, hpf+3
	...
	case R840_PAL_B_7M_CIF_5M:  
		R840_Sys_Info.IF_KHz=7250;                     //IF
		R840_Sys_Info.BW=0x00;                           //BW=8M
		R840_Sys_Info.FILT_CAL_IF=8450;           //CAL IF
	...
	case R840_SECAM_L: 
		R840_Sys_Info.IF_KHz=7300;                    //IF
		R840_Sys_Info.BW=0x00;                          //BW=8M
		R840_Sys_Info.FILT_CAL_IF=8550;          //CAL IF
		R840_Sys_Info.HPF_COR=0x0D;	             //R11[3:0]=13 (0.54M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x00;   //R30[1:0]=0,  lna=max-1 & Buf 4, hpf+3
    ...
    case R840_SECAM_L1:   
        R840_Sys_Info.IF_KHz=1320;                    //IF
		R840_Sys_Info.BW=0x00;                          //BW=8M
		R840_Sys_Info.FILT_CAL_IF=8050;          //CAL IF
		R840_Sys_Info.HPF_COR=0x0F;	             //R11[3:0]=15 (0.33M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x00;   //R30[1:0]=0,  lna=max-1 & Buf 4, hpf+3
    ...
    case R840_SECAM_L1_CIF_5M:   
        R840_Sys_Info.IF_KHz=2250;                    //IF
		R840_Sys_Info.BW=0x00;                          //BW=8M
		R840_Sys_Info.FILT_CAL_IF=8950;          //CAL IF
		R840_Sys_Info.HPF_COR=0x09;	             //R11[3:0]=9 (1.15M)
		R840_Sys_Info.FILT_EXT_ENA=0x00;      //R11[4]=0, ext disable
	...
	if (R840_Standard < R840_ATV_SIZE)  //ATV
	{
		R840_Sys_Info.FILT_CUR = 0x40;         //low  (R10[6:5]=2'b10), 
	}
	else
	{
	...
	switch(R840_Standard)
	{
		...
		case R840_SECAM_L1_INV_CIF_5M:
			 if(R840_DetectTfType==R840_UL_USING_BEAD)
                 R840_SetTfType = R840_TF_BEAD_LIN;		
			 else
				 R840_SetTfType = R840_TF_NARROW_ATV_LIN;	
...
SysFreq_Info_Type R840_SysFreq_Sel(R840_Standard_Type R840_Standard,UINT32 RF_freq)
{
    ...
    case R840_SECAM_L1:
    case R840_SECAM_L1_INV:
	case R840_MN_CIF_5M:	                      //ATV CIF=5M
	case R840_PAL_I_CIF_5M:
	case R840_PAL_DK_CIF_5M:
	case R840_PAL_B_7M_CIF_5M:
	case R840_PAL_BGH_8M_CIF_5M:
    ...
    case R840_SECAM_L1_INV_CIF_5M:
		...
		if(R840_Chip==R840_R)
		{
			...
			{
				R840_SysFreq_Info.LNA_TOP=0x05;		       // LNA TOP=2                    (R27[2:0]=3'b101)
			}
				R840_SysFreq_Info.LNA_VTH_L=0xA3;		   // LNA VTH/L=1.34/0.64     (R13=0xA3)			
				R840_SysFreq_Info.MIXER_TOP=0x05;	       // MIXER TOP=10               (R28[3:0]=4'b0101)
				R840_SysFreq_Info.MIXER_VTH_L=0xA5;  // MIXER VTH/L=1.34/0.84  (R14=0xA5)
				...
				R840_SysFreq_Info.LNA_DISCHARGE=0x0C; //LNA disch=12                   (R5[4:0]=5'b01100)
		...
		else //R840
		{
			...
			else
			{
				...
				R840_SysFreq_Info.LNA_VTH_L=0xA3;		   // LNA VTH/L=1.34/0.64     (R13=0xA3)
				R840_SysFreq_Info.MIXER_TOP=0x0C;	       // MIXER TOP=3               (R28[3:0]=4'b1100
				R840_SysFreq_Info.MIXER_VTH_L=0xA5;  // MIXER VTH/L=1.34/0.84  (R14=0xA5)
				R840_SysFreq_Info.RF_TOP=0xA0;              // RF TOP=2                        (R26[7:5]=3'b101)
				R840_SysFreq_Info.NRB_TOP=0x30;            // Nrb TOP=12                       (R28[7:4]=4'b0011)
				R840_SysFreq_Info.NRB_BW=0xC0;             // Nrb BW=lowest                      (R27[7:6]=2'b11)				
			...
			if(RF_freq>700000)
		   {
	            R840_SysFreq_Info.LNA_TOP=0x06;		       // LNA TOP=1                    (R27[2:0]=3'b110)
				R840_SysFreq_Info.LNA_VTH_L=0x71;	       // LNA VTH/L=1.04/0.44     (R13=0x71)
...
R840_ErrCode R840_Init(void)
{
	...
	if(R840_Initial_done_flag==FALSE)
	{
          ...
          if(R840_IMR_done_flag==FALSE)
		  {
			  ...
			  if(R840_IMR(4, TRUE) != RT_Success)   //Full K node 4
				return RT_Fail;
...
R840_ErrCode R840_InitReg(void)
{
	...
	if(I2C_Write_Len(&R840_I2C_Len) != RT_Success)
		return RT_Fail;
...
R840_ErrCode R840_TF_Check(void)
{
	...
	R840_I2C_Len.RegAddr = 0x00;
	R840_I2C_Len.Len = 4;
	if(I2C_Read_Len(&R840_I2C_Len) != RT_Success)
	{
	    I2C_Read_Len(&R840_I2C_Len);
	}	

	if((R840_I2C_Len.Data[3] & 0xE0) == 0xE0)    
        R840_Chip = R840;
	else if((R840_I2C_Len.Data[3] & 0xE0) == 0xC0)
		R840_Chip = R840_R;
	else
        R840_Chip = R840;
	...
	if(R840_Xtal==16000)  //16M	
	 ...
	 if(I2C_Write(&R840_I2C) != RT_Success)
		return RT_Fail;
...
R840_ErrCode R840_SetFrequency(R840_Set_Info R840_INFO)
{
	 ...
	 if(R840_INFO.R840_Standard<R840_ATV_SIZE)
	 {
		 if((R840_Chip==R840_R))  
		{
			 if(R840_DetectTfType==R840_UL_USING_270NH)
			 {
				if(R840_INFO.RF_KHz<=43000)
					R840_Array[0] = (R840_Array[0] & 0x80) | 0x77;
				else if(R840_INFO.RF_KHz<=45000)
					R840_Array[0] = (R840_Array[0] & 0x80) | 0x6F;
		 		else if(R840_INFO.RF_KHz<=48000)
					R840_Array[0] = (R840_Array[0] & 0x80) | 0x66;
				else if(R840_INFO.RF_KHz<=49000)
					R840_Array[0] = (R840_Array[0] & 0x80) | 0x5F;
				else if(R840_INFO.RF_KHz<=50000)
					R840_Array[0] = (R840_Array[0] & 0x80) | 0x3E;
				else if(R840_INFO.RF_KHz<=52000)
					R840_Array[0] = (R840_Array[0] & 0x80) | 0x3C;
...
else  
{
	 ...
	 //LT off
	 R840_I2C.RegAddr = 0x17;
	 R840_Array[23] = (R840_Array[23] | 0x20);    
	 R840_I2C.Data = R840_Array[23];
	 if(I2C_Write(&R840_I2C) != RT_Success)
			return RT_Fail;
	 ...
	 //R840 IF AGC select
	 if(R840_INFO.R840_IfAgc_Select==IF_AGC2)
         R840_Array[30] = R840_Array[30] | 0x10;
     else
	 ...
	 {
#if(FOR_CTMR==TRUE)
		 if((R840_INFO.RF_KHz>=175000) && (R840_INFO.RF_KHz<=185000))
		 {
		 		 //force sharp mode
				 R840_I2C.RegAddr = 0x03;			
				 ...
				 //TF=(0,15)
				 R840_I2C.RegAddr = 0x00;
				 R840_Array[0] = (R840_Array[0] & 0x80) | 0x0F;
				 R840_I2C.Data = R840_Array[0];
				 if(I2C_Write(&R840_I2C) != RT_Success)
					return RT_Fail;
				...
				//Q enhance enable
				R840_I2C.RegAddr = 0x12;
				R840_Array[18] = (R840_Array[18] & 0xEF) | 0x00;
				R840_I2C.Data = R840_Array[18];
				if(I2C_Write(&R840_I2C) != RT_Success)
					return RT_Fail;
				...
				//LPF Cap=5
				R840_I2C.RegAddr = 0x01;
				R840_Array[1] = (R840_Array[1] & 0x07) | 0x28;	
				R840_I2C.Data = R840_Array[1];
				if(I2C_Write(&R840_I2C) != RT_Success)
					return RT_Fail;
				...
				R840_I2C.RegAddr = 0x02;
                if(R840_Chip==R840_R)
					R840_Array[2] = (R840_Array[2] & 0xF0) | 0x00;  //4-bit
				else
                    R840_Array[2] = (R840_Array[2] & 0xE0) | 0x00;  //5-bit
				R840_I2C.Data = R840_Array[2];
				if(I2C_Write(&R840_I2C) != RT_Success)
					return RT_Fail;
				...
				//LNA TOP=2
				R840_I2C.RegAddr = 0x1B;
				R840_Array[27] = (R840_Array[27] & 0xF8) | 0x05;
				R840_I2C.Data = R840_Array[27];
				if(I2C_Write(&R840_I2C) != RT_Success)
					 return RT_Fail;

				//LNA VTH/VTL=1.24/0.54
				R840_I2C.RegAddr = 0x0D;
				R840_Array[13] = (R840_Array[13] & 0x00) | 0x92;
				R840_I2C.Data = R840_Array[13];
				if(I2C_Write(&R840_I2C) != RT_Success)
					return RT_Fail;
				...
				//RF TOP=6
				R840_I2C.RegAddr = 0x1A;
				R840_Array[26] = (R840_Array[26] & 0x1F) | 0x20;
				R840_I2C.Data = R840_Array[26];
				if(I2C_Write(&R840_I2C) != RT_Success)
					return RT_Fail;
		 }
		 ...
		 if(I2C_Write(&R840_I2C) != RT_Success)
			 return RT_Fail;
		 //Set Filter current
		 if(R840_DetectTfType==R840_UL_USING_BEAD)  //all region
		 {					 					
			 R840_I2C.RegAddr = 0x0A;
			 R840_Array[10] = (R840_Array[10] & 0x9F) | 0x00;  // highest
			 R840_I2C.Data = R840_Array[10];
			 if(I2C_Write(&R840_I2C) != RT_Success)
				return RT_Fail;
		 }

		 //Filter current/comp for EN55020
		 if((R840_DetectTfType==R840_UL_USING_270NH) && (R840_INFO.RF_KHz<=55000))
		 {
			 if(R840_Chip==R840_R)
			 {
				 R840_Array[10] = (R840_Array[10] & 0x9F) | 0x40;   //low
				 R840_Array[30] = (R840_Array[30] & 0x9F) | 0x20;  //1
			 }
			 else
			 {
				 R840_Array[10] = (R840_Array[10] & 0x9F) | 0x60;   //lowest
				 R840_Array[30] = (R840_Array[30] & 0x9F) | 0x60;  //3
			 }
...
{ 	
	...
	INT32    fine_tune = 0;    //for find tune 
        ...
        RT_Standard=RT_Standard;//for compile warning
	R840_I2C_Len.RegAddr = 0x00;
	R840_I2C_Len.Len = 5;
	if(I2C_Read_Len(&R840_I2C_Len) != RT_Success)
	{
...
R840_ErrCode R840_GetIfRssi(INT32 *VgaGain)
{
	...
	INT32   vga_table[64] = {                        //*100
		...
		60, 60, 60, 100, 150, 300, 410, 520, 650, 780,   //10~19
		920, 1060, 1200, 1340, 1470, 1600, 1750, 1900, 1960, 2030,   //20~29
		2090, 2270, 2450, 2640, 2790, 2940, 3100, 3270, 3430, 3550,   //30~39
	...
	if(I2C_Write(&Dlg_I2C) != RT_Success)
		return RT_Fail;
	...
	Dlg_I2C_Len.Len = 2;
	if(I2C_Read_Len(&Dlg_I2C_Len) != RT_Success) // read data length
	{
