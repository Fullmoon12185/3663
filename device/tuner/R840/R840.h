...
#define R840_INIT_SMALL_XTAL_CAP   FALSE      //if use small Xtal cap, set to TRUE
...
//----------------------------------------------------------//
#define R840_Delay_MS(x) msAPI_Timer_Delayms(x)
