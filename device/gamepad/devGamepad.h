...
#ifndef _DEV_GAMEPAD_H_
#define _DEV_GAMEPAD_H_
...
typedef enum
{
    ...
    GAMEPAD_TYPE_DragonRise_Gamepad,
    GAMEPAD_TYPE_DragonRise_PC_TWIN_SHOCK_Gamepad,
...
#define GAMEPAD_ISKEYPRESSED    0x01
