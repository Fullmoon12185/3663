...
//Thomas 20150714 to do
    ...
    #include "msb124x.c"
   #elif (FRONTEND_DEMOD_DVBC_TYPE == SI2164B_DVBT)
    #include "Silab2164B.c"
...
//    #include "INTERN_DVBT.c"  //For VIF init usage, only mailbox function 20100601EL
    ...
    #include "msb124x.c"
    #elif (FRONTEND_DEMOD_S2_TYPE == SI2164B_DVBT)
    #include "Silab2164B.c"
    ...
    *wCell_id = DTV_GetCellID();
    ...
    if(IsDVBTInUse())
    {
            ...
            *wCell_id = DTV_GetCellID();
            return TRUE;
        #elif (FRONTEND_DEMOD_DVBT_TYPE == SI2164B_DVBT)
             *wCell_id = devDemod_Silab2164B_DTV_GetCellID();
            return TRUE;
        #else //1 EMBEDDED_DVBT_DEMOD
         #if DEMOD_DVBT_USE_UTOPIA
            return MDrv_DMD_DVBT_GetCellID(wCell_id);
...
BOOLEAN devCOFDM_Get_Modul_Mode(WORD *Modul_Mode)
{
    ...
    *Modul_Mode=*Modul_Mode;
    ...
    if(IsDVBTInUse())
    {
        ...
        #elif (FRONTEND_DEMOD_DVBT_TYPE == SI2164B_DVBT)
            return devDemod_Silab2164B_DTV_DVB_T_Get_TPS_Parameter(Modul_Mode, TS_MODUL_MODE);
