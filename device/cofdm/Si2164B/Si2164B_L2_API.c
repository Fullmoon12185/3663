                                   ...
                                   )
{
    ...
    tunerAdd_Sat = tunerAdd_Sat; /*avoid compile warning*/
...
#if 0 // del jhkwon 20170824 for XL1P
...
#endif
#endif /* Si2164B_USING_SILABS_TER_TUNER */
      //L1_RF_TER_TUNER_Tune       (front_end->tuner_ter , rf);  // del jhkwon 20170824 for XL1P
