...
//-------------------------------------------
    IRKEY_SIZE              = 0x20,
    IRKEY_TTX_MODE         = 0x21,
    IRKEY_INDEX           = 0x1E, //0x23, //sean sync code 0422
    IRKEY_CLOCK             = 0x1D,
//-------------------------------------------
    IRKEY_MIX               = 0x22,
    IRKEY_SUBTITLE            = 0x23, //0x1E,  //sean sync code 0422
    IRKEY_REVEAL            = 0x24,
    IRKEY_UPDATE       = 0x25,
//-------------------------------------------
    IRKEY_TTX               = 0x26,
...
//-------------------------------------------
    ...
    IRKEY_FREEZE            = 0x61,
    IRKEY_PAGE_UP           =0x62,
    IRKEY_PAGE_DOWN         = 0x63,
    IRKEY_TV_INPUT           = 0x64,

    IRKEY_NINE_LATTICE      =0x65,
    IRKEY_CC                = 0x66,
    IRKEY_CRADRD            = 0x67,
    IRKEY_DASH              = 0x68,
