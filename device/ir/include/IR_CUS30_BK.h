...
#define IR_VOLUME_USE_AS_LEFTRIGHT      0// 1 bariso 22.04.2008 volume keys should work in every menus&sub-menus
...
{
    IRKEY_TV_ANTENNA        = 0xA0,
    IRKEY_TV_RADIO          = 0xA1,//same as IRKEY_PAGE_UP
    IRKEY_CHANNEL_LIST      = 0xA2,
    IRKEY_CHANNEL_FAV_LIST  = 0x31,
    IRKEY_CHANNEL_RETURN    = 0x22, // IRKEY SWAP
    ...
    IRKEY_DTV               = 0xAC,
    IRKEY_TV                = 0xCF,
    IRKEY_COMPONENT         = 0xFB,
    IRKEY_SV                = 0XFC,

    IRKEY_DASH              = 0XC0, // no use
    IRKEY_BACKWARD          = 0XC1,  // no use
    IRKEY_FORWARD           = 0XC2, // no use
    IRKEY_PLAY              = 0X0E, // no use
    IRKEY_RECORD            = 0X0A, // no use
    IRKEY_STOP              = 0x1A, // no use
    IRKEY_PAUSE             = 0X0B,
    IRKEY_MEMORY_RECALL     = 0XC7, // no use

    IRKEY_SLEEP             = 0x1C,   //IRKEY PIP_Position
    IRKEY_EPG               = 0x25, //IRKEY Guide for LX'

    IRKEY_P_CHECK           = 0xAE,
    IRKEY_S_CHECK           = 0xAF,

      IRKEY_MIX               = IRKEY_DUMY -1,
    IRKEY_INDEX             = 0xCE,
    IRKEY_HOLD              = 0x29,
    IRKEY_PREVIOUS          = 0xB0,
    IRKEY_NEXT              = 0xB1,
    ...
    IRKEY_TTX_MODE          = IRKEY_DUMY -2,//0x30,
    IRKEY_RED2              = 0xB6,
    IRKEY_GREEN2            = 0xB7,
    IRKEY_UPDATE            = 0x2D,
    IRKEY_SUBTITLE          = 0x30, //gokhan 0x29,
    IRKEY_TIME               = 0x1D, //IRKEY PIP_Size

    IRKEY_SIZE              = 0x1D,//0x2B, //IRKEY DOUBLE
    IRKEY_DOUBLE            = 0X2B,//recepy 14.07.08
    IRKEY_REVEAL            = 0x2C,
    IRKEY_RETURN            = 0xBD,
    IRKEY_ADJUST            = 0XC8,
    IRKEY_TV_INPUT          = 0XC9,
    IRKEY_KEY_DISABLE_KEYPAD= 0XCA,
    IRKEY_BACK              = 0X26,
    IRKEY_SUBPAGE           = 0X2A,

//Keys for Automatic Adjust in Production
    IRKEY_SWITCH_SCART                 = 0x1B,/**cihan 13.06.08 0x0E can not be becaue it is PLAY button*/
    IRKEY_SWITCH_AV                         = 0x28,
    IRKEY_SWITCH_SVIDEO                 = 0x2E,
    IRKEY_SWITCH_PC                         = 0x2F,
    IRKEY_SWITCH_HDMI                     = 0x3A,
    IRKEY_SWITCH_YPBPR                   = 0x3B,
    IRKEY_SWITCH_HEADPHONE_INC  = 0x3D,
    IRKEY_SWITCH_HEADPHONE_DEC  = 0x3E,
    IRKEY_SWITCH_HDMI2                     = 0x3F,
    IRKEY_SWITCH_HDMI3                     = 0x40,
}IrCommandType;
