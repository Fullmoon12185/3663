...
#define IR_HEADER_CODE0         0x41    // Custom 0
#define IR_HEADER_CODE1         0x01    // Custom 1
...
typedef enum _IrCommandType
{
    ...
    #if MHEG5_ENABLE
    // Add test key as temporary DSMCC entry point
    IRKEY_DSMCC_TEST        = 0x52,
    #endif
    ...
    IRKEY_AV                 = IRKEY_DUMY-23,
    IRKEY_HDMI            = IRKEY_DUMY-24,
    IRKEY_SCART         = IRKEY_DUMY-25,
    IRKEY_PC                = IRKEY_DUMY-26,
    IRKEY_TV                = IRKEY_DUMY-27,
    IRKEY_DTV              = IRKEY_DUMY-28,
    IRKEY_COMPONENT  = IRKEY_DUMY-29,
    IRKEY_SV                = IRKEY_DUMY-30,

    IRKEY_SUBPAGE   =   IRKEY_DUMY-31,
}IrCommandType;
//*************************************************************************
