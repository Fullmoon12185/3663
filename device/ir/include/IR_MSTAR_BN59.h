...
typedef enum _IrCommandType
{
    ...
    IRKEY_CHANNEL_FAV_LIST  = 0x44,//0x4F,
    ...
    IRKEY_RED               = 0x6C,
    IRKEY_GREEN             = 0x14,
    IRKEY_YELLOW            = 0x42,//0x15,
    IRKEY_BLUE              = 0x16,
    IRKEY_MTS               = 0x00,
    IRKEY_NINE_LATTICE      = IRKEY_DUMY-2,
    IRKEY_TTX               = IRKEY_DUMY-3,
    IRKEY_CC                = 0x25,//0x97,
