...
#define IR_HEADER_CODE0         0x86    // Custom 0
#define IR_HEADER_CODE1         0x05    // Custom 1
...
typedef enum _IrCommandType
{
    ...
    IRKEY_TV_INPUT          = IRKEY_DUMY-26,
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-27,


    // source switching hotkeys
    IRKEY_AV                 = IRKEY_DUMY-28,
    IRKEY_HDMI            = IRKEY_DUMY-29,
    IRKEY_SCART         = IRKEY_DUMY-30,
    IRKEY_PC                = IRKEY_DUMY-31,
    IRKEY_TV                = IRKEY_DUMY-32,
    IRKEY_DTV              = IRKEY_DUMY-33,
    IRKEY_COMPONENT  = IRKEY_DUMY-34,
    IRKEY_SV                = IRKEY_DUMY-35,

    IRKEY_SUBPAGE   =   IRKEY_DUMY-36,
}IrCommandType;
//*************************************************************************
