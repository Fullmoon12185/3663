...
{
    IRKEY_TV_ANTENNA        = IRKEY_DUMY-27,
    IRKEY_TV_RADIO          = 0xD6,//TV/RADIO
    IRKEY_CHANNEL_LIST      = 0xD4,//INFO
    IRKEY_CHANNEL_FAV_LIST  = 0xD7,//FAV
    IRKEY_CHANNEL_RETURN    = 0x96,//RETURN
    IRKEY_CHANNEL_PLUS      = 0x9B,//CH+
    IRKEY_CHANNEL_MINUS     = 0x8F,//CH-

    IRKEY_AUDIO             = 0xCE,//SOUND
    IRKEY_VOLUME_PLUS       = 0x9F,//VOL+
    IRKEY_VOLUME_MINUS      = 0x8B,//VOL-

    IRKEY_UP                = 0x99,//UP
    IRKEY_POWER             = 0x82,//POWER
    IRKEY_EXIT              = 0xCC,//,//EXIT
    IRKEY_MENU              = 0x97,//TV_MENU
    IRKEY_DOWN              = 0x9D,//DOWN
    IRKEY_LEFT              = 0x9C,//LEFT
    IRKEY_SELECT            = 0x9A,//OK
    IRKEY_RIGHT             = 0x9E,//RIGHT
    ...
    IRKEY_MUTE              = 0xD0,//MUTE
    IRKEY_FREEZE            = IRKEY_DUMY-34,
    IRKEY_PAGE_UP           = 0x03,
    IRKEY_PAGE_DOWN         = 0x05,
    IRKEY_CLOCK             = 0x5F,

    IRKEY_INFO              = 0xD2,//DISPLAY
    IRKEY_RED               = 0xC8,//A
    IRKEY_GREEN             = 0xC9,//B
    IRKEY_YELLOW            = 0xCA,//C
    IRKEY_BLUE              = 0xCB,//D
    IRKEY_MTS               = 0xCF,//A2/NICAM
    IRKEY_NINE_LATTICE      = IRKEY_DUMY,
    IRKEY_TTX               = 0x84,//LANGUAGE
    IRKEY_CC                = IRKEY_DUMY-11,
    IRKEY_INPUT_SOURCE      = 0x93,//TV/AV
    IRKEY_CRADRD            = IRKEY_DUMY-1,
    IRKEY_PICTURE           = 0xCD,//PICTURE
    IRKEY_ZOOM              = IRKEY_DUMY-7,
    IRKEY_DASH              = IRKEY_DUMY-8,
    IRKEY_SLEEP             = 0xD1,//SLEEP
    IRKEY_EPG               = 0xD5,//EPG

    IRKEY_P_CHECK           = IRKEY_DUMY-9,
    IRKEY_S_CHECK           = IRKEY_DUMY-10,

    IRKEY_MIX               = 0x85, // CANCEL
    IRKEY_INDEX             = 0xC7,//GOTO/INDEX
    IRKEY_HOLD              = 0xC4,//MENU/HOLD
  //IRKEY_PREVIOUS          = 0x0E,
  //IRKEY_NEXT              = 0x12,
  //IRKEY_BRIGHTNESS_PLUS   = 0x0E,
  //IRKEY_BRIGHTNESS_MINUS  = 0x12,
    IRKEY_BACKWARD          = IRKEY_DUMY-12,
    IRKEY_FORWARD           = IRKEY_DUMY-13,
    IRKEY_PLAY              = IRKEY_DUMY-14,
    IRKEY_RECORD            = IRKEY_DUMY-15,
    IRKEY_STOP              = IRKEY_DUMY-16,
    IRKEY_PAUSE             = IRKEY_DUMY-17,

#ifdef __USED_HDMI_CEC__
    IRKEY_PLAY_KEY          = IRKEY_PLAY,
    IRKEY_STOP_KEY          = IRKEY_STOP,
    IRKEY_SKIPM_KEY         = 0x1E,
    IRKEY_SKIPP_KEY         = 0x02,

    IRKEY_PAUSE_KEY         = IRKEY_PAUSE,
    //IRKEY_REC               = IRKEY_RECORD,
    IRKEY_FF                = 0x0E,
    IRKEY_REWIND            = 0x12,
#endif
    IRKEY_POWERONLY         = IRKEY_DUMY-20,

    IRKEY_TTX_MODE          = IRKEY_DUMY-21,
    IRKEY_RED2              = IRKEY_DUMY-22,
    IRKEY_GREEN2            = IRKEY_DUMY-23,
    IRKEY_UPDATE            = IRKEY_DUMY-24,
    IRKEY_SUBTITLE          = 0xD3,//SUBTITLE
//  IRKEY_SUBCODE           = 0x53,
    IRKEY_TIME                 = IRKEY_DUMY-25,

    IRKEY_SIZE              = 0xC5,//ANGLE/SIZE
    IRKEY_REVEAL            = 0x86,//DVD SUBTITLE
    IRKEY_RETURN            = IRKEY_DUMY-26,
    ...
    DSC_IRKEY_PWRON         = IRKEY_DUMY-6,
    DSC_IRKEY_PWROFF        = IRKEY_DUMY-7,
    DSC_IRKEY_ARC4X3        = IRKEY_DUMY-8,
    DSC_IRKEY_ARC16X9       = IRKEY_DUMY-9,
    DSC_IRKEY_ARCZOOM       = IRKEY_DUMY-10,
    DSC_IRKEY_TV            = 0x1B,
    DSC_IRKEY_VIDEO1        = 0x57,
    DSC_IRKEY_VIDEO2        = IRKEY_DUMY-13,
    DSC_IRKEY_VIDEO3        = IRKEY_DUMY-14,
    DSC_IRKEY_COMP1         = IRKEY_DUMY-15,
    DSC_IRKEY_COMP2         = IRKEY_DUMY-16,
    DSC_IRKEY_RGBPC         = 0x54,
    DSC_IRKEY_RGBDTV        = 0x17,
    DSC_IRKEY_RGBDVI        = IRKEY_DUMY-19,
    DSC_IRKEY_HDMI1         = IRKEY_DUMY-20,
    DSC_IRKEY_HDMI2         = IRKEY_DUMY-21,
    DSC_IRKEY_MULTI_PIP     = IRKEY_DUMY-22,
    DSC_IRKEY_MULTIMEDIA    = IRKEY_DUMY-23,

    IRKEY_TV                = IRKEY_DUMY-28,
    IRKEY_PC                = IRKEY_DUMY-29,
    IRKEY_HDMI              = IRKEY_DUMY-30,
    IRKEY_SCART             = IRKEY_DUMY-31,
    IRKEY_AV                = IRKEY_DUMY-32,
    IRKEY_SV                = IRKEY_DUMY-33,
    IRKEY_COMPONENT     = IRKEY_DUMY-38,
    IRKEY_HOME     = IRKEY_DUMY-35,
    IRKEY_PREVIOUS     = IRKEY_DUMY-36,
    IRKEY_NEXT     = IRKEY_DUMY-37,
