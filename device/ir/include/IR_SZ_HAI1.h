...
//*************************************************************************
#define IR_MODE_SEL            IR_TYPE_FULLDECODE_MODE// IR_TYPE_SWDECODE_RC5HAI_MODE
#define IR_LG_MAP               0
#define IR_CHANNEL_USE_AS_UPDOWN  0// 1
#define IR_VOLUME_USE_AS_LEFTRIGHT     0// 1
// IR Header code define

#define IR_HEADER_CODE0     0x04//0x00    // Custom 0
#define IR_HEADER_CODE1     0xFB//0x08    // Custom 1
...
{
    IRKEY_TV_RADIO          = 0x60,//IRKEY_DUMY-38,  //
    IRKEY_CHANNEL_LIST      = 0x4B,  //
    IRKEY_CHANNEL_FAV_LIST  =0x2F,//IRKEY_DUMY - 37,  // //william edit 20071205
    IRKEY_CHANNEL_RETURN    = 0x1A,//0x0F,  // william edit 20071205
    IRKEY_CHANNEL_PLUS      = 0x00,//0x0A,  //
    IRKEY_CHANNEL_MINUS     = 0x01,  //

    IRKEY_AUDIO             = 0x52,//0x24,//0x3C+0x40,  // sound mode IR_HEADER_CODE1     0x08  //william edit 20071205
    IRKEY_VOLUME_PLUS       = 0x02,  //
    IRKEY_VOLUME_MINUS      = 0x03,  //

    IRKEY_UP                = 0x40,  //IR_HEADER_CODE1     0x08
    IRKEY_POWER             = 0x08,//0x0C,  //
    IRKEY_EXIT              = 0x5B,  //
    IRKEY_MENU              = 0x0A,//0x10,  //
    IRKEY_DOWN              = 0x41,  //IR_HEADER_CODE1     0x08
    IRKEY_LEFT              = 0x07,  //IR_HEADER_CODE1     0x08
    IRKEY_SELECT            = 0x44, //0x3d,//0x36+0x40,  //IR_HEADER_CODE1   //william edit 20071205
    IRKEY_RIGHT             = 0x06,  //IR_HEADER_CODE1     0x08
    ...
    IRKEY_MUTE              = 0x09,//0x0D,  //
    IRKEY_FREEZE            = 0x61,//IRKEY_DUMY-44,
    IRKEY_PAGE_UP           =0x62,//IRKEY_DUMY-38,  //
    IRKEY_PAGE_DOWN         = 0x63,//IRKEY_DUMY-39,  //
    IRKEY_CLOCK             = 0x1D,//IRKEY_DUMY,     //william edit 20071205
    IRKEY_TV_INPUT           = 0x64,//0x3D+0x40,
    IRKEY_INFO              = 0x04,//0x0F,//IRKEY_DUMY-40,  // william edit 20071205
    ...
    IRKEY_BLUE              =0x2C,
    IRKEY_MTS               = 0x05,  //
    IRKEY_NINE_LATTICE      =0x65,// IRKEY_DUMY-5,
    IRKEY_TTX               = 0x26,
    IRKEY_CC                = 0x66,//IRKEY_DUMY-6,  //
    IRKEY_INPUT_SOURCE      = 0x29,  //
    IRKEY_CRADRD            = 0x67,//IRKEY_DUMY-7,
    IRKEY_PICTURE           = 0x4d,//0x0E,  // Picture Mode
    IRKEY_ZOOM              = 0x0B,  //
    IRKEY_DASH              = 0x68,//IRKEY_DUMY-33, //
    IRKEY_SLEEP             = 0x0E,//0x20,//0x1E+0x40 , //      william edit 20071205
    IRKEY_EPG               = 0x2E, //0x29,//0x2B+0x40,  //IR_HEADER_CODE1     0x08   // william edit 20071205

    IRKEY_MIX               = 0x22,
    IRKEY_INDEX             = 0x1E,//IRKEY_DUMY-8,    //william edit 20071205
    IRKEY_HOLD              = 0x27,//0x29+0x40,        //william edit 20071205
    IRKEY_PREVIOUS          = 0xF3,
    IRKEY_NEXT              = 0xF4,
    IRKEY_BACKWARD          = 0xF1,
    IRKEY_FORWARD           = 0xF2,
    IRKEY_PLAY              = 0xE5,//zhanglei test
    IRKEY_RECORD            = 0x69,//IRKEY_DUMY-16,
    IRKEY_STOP              = 0x31,
    IRKEY_PAUSE             = 0x32,
    ...
    IRKEY_REVEAL            = 0x24,
    IRKEY_SUBCODE           = 0x2D,
    IRKEY_ANTENNA           = 0x6a,//IRKEY_DUMY-22,
     IRKEY_LOCK                = 0x6b,//IRKEY_DUMY-23,
  IRKEY_BACK                 = 0x6c,//IRKEY_DUMY-24,
  IRKEY_RED2                  = 0x6d,//IRKEY_DUMY-27,
  IRKEY_GREEN2              = 0x6e,//IRKEY_DUMY-1,//26,
  IRKEY_SUBTITLE            = 0x23, //IRKEY_DUMY-27,
  IRKEY_UPDATE              = 0x25,//0x6f,//IRKEY_DUMY-28,//zhanglei open teletex cancel func.
  IRKEY_TTX_MODE         = 0x21,//0x25,          //william edit 20080118
  IRKEY_SCAN         = 0x0C,//0x25,          //william edit 20080118

  IRKEY_ADJUST               = 0x70,//IRKEY_DUMY-31,
  IRKEY_KEY_DISABLE_KEYPAD = 0x71,//IRKEY_DUMY-32,
   IRKEY_P_CHECK      = 0x72,//IRKEY_DUMY-33,
   IRKEY_S_CHECK   =   0x73,//IRKEY_DUMY-34,


    // source switching hotkeys
    IRKEY_AV                 = 0x74,//IRKEY_DUMY-35,
    IRKEY_HDMI            = 0x75,//IRKEY_DUMY-46,
    IRKEY_SCART         = 0x76,//IRKEY_DUMY-45,
    IRKEY_PC                = 0x77,//IRKEY_DUMY-47,
    IRKEY_TV                = 0x78,//IRKEY_DUMY-39,
    IRKEY_DTV              = 0x79,//IRKEY_DUMY-48,
    IRKEY_COMPONENT  = 0x7a,//IRKEY_DUMY-41,
    IRKEY_SV                = 0x7b,//IRKEY_DUMY-42,

    IRKEY_SUBPAGE   =   0x7c,//IRKEY_DUMY-43,
