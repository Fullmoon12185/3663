...
#define IR_HEADER_CODE0         0x86    // Custom 0     //0x04
#define IR_HEADER_CODE1         0x05    // Custom 1     //0xFB
...
//  IRKEY_SUBCODE           = 0x53,
    ...
    IRKEY_TV_ANTENNA        = IRKEY_DUMY - 6,
    IRKEY_PAGE_UP           = IRKEY_DUMY - 7,
    IRKEY_PAGE_DOWN         = IRKEY_DUMY - 8,
    IRKEY_CLOCK             = IRKEY_DUMY - 9,
    IRKEY_CC                = IRKEY_DUMY - 10,
    IRKEY_DASH              = IRKEY_DUMY - 11,

    IRKEY_P_CHECK           = IRKEY_DUMY - 12,
    IRKEY_S_CHECK           = IRKEY_DUMY - 13,
      IRKEY_MIX               = IRKEY_DUMY - 14,
    IRKEY_INDEX             = IRKEY_DUMY -15,
    IRKEY_BACKWARD          = 0x02,
    IRKEY_FORWARD           = 0x1E,
    IRKEY_PLAY              = 0x01,
    IRKEY_RECORD            = 0x0D,
    ...
    IRKEY_AV                 = IRKEY_DUMY-16,
    IRKEY_HDMI            = IRKEY_DUMY-17,
    IRKEY_SCART         = IRKEY_DUMY-18,
    IRKEY_PC                = IRKEY_DUMY-19,
    IRKEY_TV                = IRKEY_DUMY-20,
    IRKEY_DTV              = IRKEY_DUMY-21,
    IRKEY_COMPONENT  = IRKEY_DUMY-22,
    IRKEY_SV                = IRKEY_DUMY-23,
