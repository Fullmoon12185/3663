...
{
    IRKEY_TV_RADIO          = 0x23,
    IRKEY_CHANNEL_LIST      = 0x2A,
    IRKEY_CHANNEL_FAV_LIST  = 0x25,
    ...
    IRKEY_SIZE              = IRKEY_DUMY-25,
    IRKEY_REVEAL            = IRKEY_DUMY-26,
    IRKEY_SUBCODE           = IRKEY_DUMY-27,
    IRKEY_ANTENNA           = IRKEY_DUMY-28,
    IRKEY_LOCK              = IRKEY_DUMY-29,
    IRKEY_BACK              = IRKEY_DUMY-30,
    IRKEY_RED2              = IRKEY_DUMY-31,
    IRKEY_GREEN2            = IRKEY_DUMY-32,
    IRKEY_SUBTITLE          = IRKEY_DUMY-33,
    IRKEY_UPDATE            = IRKEY_DUMY-34,
    IRKEY_TTX_MODE          = IRKEY_DUMY-35,

    IRKEY_ADJUST            = IRKEY_DUMY-36,
    IRKEY_KEY_DISABLE_KEYPAD= IRKEY_DUMY-37,
    IRKEY_P_CHECK           = IRKEY_DUMY-38,
    IRKEY_S_CHECK           = IRKEY_DUMY-39,


    // source switching hotkeys
    IRKEY_AV                 = IRKEY_DUMY-40,
    IRKEY_HDMI            = IRKEY_DUMY-41,
    IRKEY_SCART         = IRKEY_DUMY-42,
    IRKEY_PC                = IRKEY_DUMY-43,
    IRKEY_TV                = IRKEY_DUMY-44,
    IRKEY_DTV              = IRKEY_DUMY-45,
