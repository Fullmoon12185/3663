...
typedef enum _IrCommandType
{
            ...
            // channel keys
            IRKEY_CHANNEL_LIST    =0x13,//    = 0xA7,0x34F1
            ...
            IRKEY_HORIZ_LAMP,
            IRKEY_TEST_PATTERN_GREEN,
            IRKEY_TEST_PATTERN_BLUE,
            IRKEY_TEST_PATTERN_RED,
            IRKEY_TEST_PATTERN_WHITE50,
            IRKEY_TEST_PATTERN_WHITE,
            IRKEY_TEST_PATTERN_BLACK,
            ...
            IRKEY_NULL                  = 0xFF,
                ...
                IRKEY_LEFT              = 0xD7,
                IRKEY_RIGHT             = 0xD8,
                IRKEY_CHANNEL_PULS      = 0x11,
                IRKEY_CHANNEL_MINUS     = 0x12,
                IRKEY_VOLUME_PLUS       = 0x14,//left is temp//0x16,
    ...
    //////////////////////////////////////////////////////////////////////
                ...
                IRKEY_TV_RADIO          = 0xD9,//left is temp//0x03,//same as IRKEY_PAGE_UP
                IRKEY_CHANNEL_LIST      = 0x10,
                IRKEY_CHANNEL_FAV_LIST  = 0xF8,//left is temp//0x08,
                IRKEY_CHANNEL_RETURN    = 0x5C,
                IRKEY_AUDIO             = 0x44,
                IRKEY_PAGE_UP           = 0xF3,//left is temp//0x03
                IRKEY_PAGE_DOWN         = 0xF5,//left is temp//0x05,
                IRKEY_CLOCK             = 0x5F,
                IRKEY_INFO              = 0xE4,//left is temp//0x14,
                IRKEY_MTS               = 0x41,
                IRKEY_NINE_LATTICE      = IRKEY_DUMY,
                IRKEY_TTX               = 0xEA,//left is temp//0x0A,
                IRKEY_CC                = 0xF9,//left is temp//0x09,
                IRKEY_INPUT_SOURCE      = 0xF4,//left is temp//0x04,
                IRKEY_CRADRD            = IRKEY_DUMY-1,
                IRKEY_PICTURE           = 0x40,
                IRKEY_ZOOM              = 0x4C,
                IRKEY_DASH              = 0x4E,
                IRKEY_EPG               = 0x4D,//left is temp//0x4A,
                IRKEY_P_CHECK           = 0xE7,//left is temp/0x57,//
                IRKEY_S_CHECK           = 0x5b,
                IRKEY_MIX               = 0x1C,
                IRKEY_INDEX             = 0xE8,//left is temp//0x18,
                IRKEY_HOLD              = 0x00,
              //IRKEY_PREVIOUS          = 0x0E,
              //IRKEY_NEXT              = 0x12,
              //IRKEY_BRIGHTNESS_PLUS   = 0x0E,
              //IRKEY_BRIGHTNESS_MINUS  = 0x12,
                IRKEY_BACKWARD          = 0xF2,//left is temp//0x02,
                IRKEY_FORWARD           = 0x1E,
                IRKEY_PLAY              = 0xF1,//left is temp//0x01,
                IRKEY_RECORD            = 0x0D,
                IRKEY_STOP              = 0xE1,//left is temp//0x11,
                IRKEY_PAUSE             = 0x1D,
...
code CUS21SH_IRKEY_TABLE IR_CUS21SH_RAWDATA_MAPPING_TABLE[]= //[205] =
{
    ...
    {0x35A1, IRKEY_WB_ADJ_INIT},
    {0x35C1, IRKEY_ADJ_INIT},
    {0x3821, IRKEY_RF_AGC},
    ...
    */
    ...
    //TEST PATTERN
    {0x205E, IRKEY_HORIZ_LAMP},
    {0x21FE, IRKEY_TEST_PATTERN_GREEN},
    {0x225E, IRKEY_TEST_PATTERN_BLUE},
    {0x223E, IRKEY_TEST_PATTERN_RED},
    {0x229E, IRKEY_TEST_PATTERN_WHITE50},
    {0x22FE, IRKEY_TEST_PATTERN_WHITE},
    {0x231E, IRKEY_TEST_PATTERN_BLACK},

    {0x2DC1, IRKEY_SURROUND},
    {0x221E, IRKEY_EXT3_SD_ADJ},
    {0x213E, IRKEY_COMP_HD_ADJ},
    {0x23DE, IRKEY_PC_RGB_ADJ},
