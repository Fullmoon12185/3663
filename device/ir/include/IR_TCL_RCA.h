...
//-------------------------------------------------------------------------------------------
#define IR_MODE_SEL             IR_TYPE_SWDECODE_RCA_MODE//IR_TYPE_SWDECODE_MODE//IR_TYPE_SWDECODE_RC5_MODE//IR_TYPE_SWDECODE_MODE//IR_TYPE_SWDECODE_RCA_MODE//IR_TYPE_SWDECODE_MODE
...
//    IRKEY_PICTURE           = 0x40,
    ...
    IRKEY_AV                = IRKEY_DUMY+21,
    IRKEY_HDMI              = IRKEY_DUMY+22,
    IRKEY_SCART             = IRKEY_DUMY+23,
    IRKEY_PC                = IRKEY_DUMY+24,
    IRKEY_DTV               = IRKEY_DUMY+25,
    IRKEY_TV                = IRKEY_DUMY+26,
    IRKEY_COMPONENT         = IRKEY_DUMY+27,
    IRKEY_SV                = IRKEY_DUMY+28,

	
	IRKEY_ANTENNA           = IRKEY_DUMY+29,
	IRKEY_LOCK              = IRKEY_DUMY+30,
	IRKEY_BACK              = IRKEY_DUMY+31,
	IRKEY_RED2              = IRKEY_DUMY+32,
	IRKEY_GREEN2            = IRKEY_DUMY+33,
	IRKEY_SUBTITLE          = IRKEY_DUMY+34,
	IRKEY_UPDATE            = IRKEY_DUMY+35,
	IRKEY_TTX_MODE         	= IRKEY_DUMY+36,
	IRKEY_ADJUST            = IRKEY_DUMY+37,
	IRKEY_KEY_DISABLE_KEYPAD= IRKEY_DUMY+38,
	IRKEY_P_CHECK      		= IRKEY_DUMY+39,
	IRKEY_S_CHECK   		= IRKEY_DUMY+40,
	IRKEY_FREEZE   		    = IRKEY_DUMY+41,
	IRKEY_PICTURE   		= IRKEY_DUMY+42,
	IRKEY_TV_INPUT   		= IRKEY_DUMY+43,
    IRKEY_SUBPAGE           = IRKEY_DUMY+44,
