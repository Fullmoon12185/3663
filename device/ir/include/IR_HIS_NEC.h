...
#define IR_HEADER_CODE0        0x04// 0x80    // Custom 0     //0x04
#define IR_HEADER_CODE1         0xFB//0x7F    // Custom 1     //0xFB
...
typedef enum _IrCommandType
{
...
#if (ENABLE_DMP == DISABLE)
    IRKEY_TV_RADIO          = 0xD3,//same as IRKEY_PAGE_UP
#endif
    IRKEY_CHANNEL_LIST      = 0xE0,//0x10,
    IRKEY_CHANNEL_FAV_LIST  = 0xE8,//0x08,
    IRKEY_CHANNEL_RETURN    = 0x5C,
    IRKEY_CHANNEL_PLUS      = 0x00,//0x1F,
    IRKEY_CHANNEL_MINUS     = 0x01,//0x19,

    IRKEY_AUDIO             = 0x44,
    IRKEY_VOLUME_PLUS       = 0x02,//0x16,
    IRKEY_VOLUME_MINUS      = 0x03,//0x15,

    IRKEY_UP                = 0x56,//0x52,
    IRKEY_POWER             = 0x08,//0x46,
    IRKEY_EXIT              = 0x4d,//0x1B,
    IRKEY_MENU              = 0x43,//0x07,
    IRKEY_DOWN              = 0x57,//0x13,
    IRKEY_LEFT              = 0x58,//0x06,
    IRKEY_SELECT            = 0x5a,//0x0F,
    IRKEY_RIGHT             = 0x59,//0x1A,
    ...
    IRKEY_TTX               = 0x0A,
    IRKEY_CC                = 0x09,
    IRKEY_INPUT_SOURCE      = 0x0b,//0x04,
    IRKEY_CRADRD            = IRKEY_DUMY-1,
    IRKEY_PICTURE           = 0x05,//0x40,
    IRKEY_ZOOM              = 0x07,//0x4C,
#if ENABLE_IR_MSTAR_SOURCE_HOTKEY
    IRKEY_AV                = 0x4E,
    IRKEY_HDMI              = 0x02,
    IRKEY_SCART             = 0x1E,
    ...
    IRKEY_S_CHECK           = 0x5b,
      ...
      IRKEY_MIX               = 0x1C,
    IRKEY_INDEX             = 0xD8,//0x18,
    IRKEY_HOLD              = 0xD0,//0x00,
    IRKEY_PREVIOUS          = 0x0E,
    IRKEY_NEXT              = 0x12,
  //IRKEY_BRIGHTNESS_PLUS   = 0x0E,
  //IRKEY_BRIGHTNESS_MINUS  = 0x12,
    ...
    IRKEY_GREEN2            = 0x71,
    IRKEY_UPDATE            = 0xDC,
    IRKEY_SUBTITLE          = 0xE3,//0x53,
//  IRKEY_SUBCODE           = 0x53,
    IRKEY_TIME                 = 0x26,

    IRKEY_SIZE              = 0xC3,//0x43,
    IRKEY_REVEAL            = 0x4F,
    IRKEY_RETURN            = 0x00,
    IRKEY_ADJUST            = IRKEY_DUMY-2,
    IRKEY_TV_INPUT          = IRKEY_DUMY-3,
