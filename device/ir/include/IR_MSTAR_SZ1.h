...
{
    IRKEY_TV_ANTENNA        = 0x03,
#if (ENABLE_DMP == DISABLE)
    IRKEY_TV_RADIO          = 0x4C,//same as IRKEY_PAGE_UP
#endif
    ...
    IRKEY_BLUE              = 0x55,
    IRKEY_MTS               = 0x4B,
    IRKEY_NINE_LATTICE      = IRKEY_DUMY-1,
    IRKEY_TTX               = 0x0F,
    IRKEY_CC                = 0x17,
    IRKEY_INPUT_SOURCE      = 0x1E,
    IRKEY_CRADRD            = IRKEY_DUMY-2,
    IRKEY_PICTURE           = 0x4A,
    IRKEY_ZOOM              = 0x46,
    IRKEY_DASH              = IRKEY_DUMY-3,
    IRKEY_BACKWARD          = 0x51,
    IRKEY_FORWARD           = 0x59,
    IRKEY_PLAY              = 0x09,
    IRKEY_RECORD            = 0x0B,
    IRKEY_STOP              = 0x19,
    IRKEY_PAUSE             = 0x0D,
    IRKEY_MEMORY_RECALL       = 0x54,

    IRKEY_AV                = IRKEY_DUMY-4, // no use
    IRKEY_HDMI              = IRKEY_DUMY-5, // no use
    IRKEY_SCART             = IRKEY_DUMY-6, // no use
    IRKEY_PC                = IRKEY_DUMY-7, // no use
    IRKEY_DTV               = IRKEY_DUMY-8, // no use
    IRKEY_TV                = IRKEY_DUMY-9, // no use
    IRKEY_COMPONENT         =  IRKEY_DUMY-10, // no use
    IRKEY_SV                = IRKEY_DUMY-11, // no use
    IRKEY_SLEEP             = 0x5F,
    IRKEY_EPG               = 0x01,

    IRKEY_P_CHECK           = IRKEY_DUMY-12, // no use,
    IRKEY_S_CHECK           = IRKEY_DUMY-13, // no use,
    ...
    IRKEY_POWERONLY         = IRKEY_DUMY-14,

    IRKEY_TTX_MODE          = IRKEY_DUMY-15,
    IRKEY_RED2              = IRKEY_DUMY-16,
    IRKEY_GREEN2            = IRKEY_DUMY-17,
    IRKEY_UPDATE            = 0x06,
    IRKEY_SUBTITLE          = 0x1A,
//  IRKEY_SUBCODE           = 0x1A,
    IRKEY_TIME                 = IRKEY_DUMY-18,

    IRKEY_SIZE              = 0x1D,
    IRKEY_REVEAL            = 0x12,
    IRKEY_RETURN            = 0x5A,
    IRKEY_ADJUST            = IRKEY_DUMY-19,
    IRKEY_TV_INPUT          = IRKEY_DUMY-20,
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-21,
    IRKEY_BACK              = IRKEY_DUMY-22,
    IRKEY_SUBPAGE   =       IRKEY_DUMY-23,
    IRKEY_HOME =       IRKEY_DUMY-24,
