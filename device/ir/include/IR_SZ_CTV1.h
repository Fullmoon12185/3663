...
#define IR_Life_MAP               0
#define IR_CHANNEL_USE_AS_UPDOWN   0
#define IR_VOLUME_USE_AS_LEFTRIGHT      0
// IR Header code define

#define IR_HEADER_CODE0         0xA0    // Custom 0     //0x04
#define IR_HEADER_CODE1         0x5F    // Custom 1     //0xFB
...
{
    //IRKEY_TV_ANTENNA        = IRKEY_DUMY-25,
    IRKEY_TV_RADIO          = 0x17,
    IRKEY_CHANNEL_LIST      = 0x54,
    IRKEY_CHANNEL_FAV_LIST  = 0x43,
    IRKEY_CHANNEL_RETURN    = IRKEY_DUMY-28,
  ...
  IRKEY_SUBCODE           = 0x53,
    ...
    IRKEY_HDMI            = IRKEY_DUMY-25,
    IRKEY_SCART         = IRKEY_DUMY-26,
    IRKEY_PC                = IRKEY_DUMY-27,
    IRKEY_TV                = IRKEY_DUMY-34,
    IRKEY_DTV              = IRKEY_DUMY-33,
