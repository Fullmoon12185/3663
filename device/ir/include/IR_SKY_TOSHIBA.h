...
//*************************************************************************
#define IR_MODE_SEL             IR_TYPE_SWDECODE_SKY_MODE
#define IR_LG_MAP               0
#define IR_CHANNEL_USE_AS_UPDOWN         0
#define IR_VOLUME_USE_AS_LEFTRIGHT       0
// IR Header code define
#define IR_HEADER_CODE0     0x0E    // Custom 0     
#define IR_HEADER_CODE1     0x0E    // Custom 1     

// IR Timing define
#define IR_HEADER_CODE_TIME     4500//9000    // us
#define IR_OFF_CODE_TIME            4500    // us
#define IR_OFF_CODE_RP_TIME     4500//2500    // us
#define IR_LOGI_01H_TIME      560     // us
#define IR_LOGI_0_TIME          1120    // us
#define IR_LOGI_1_TIME          2240    // us
#define IR_TIMEOUT_CYC          116000  // us
#define IR_TOLERANCE_TIME       ((IR_LOGI_0_TIME-IR_LOGI_1_TIME)/2)  
...
typedef enum _IrCommandType
{
    ...
    IRKEY_AUDIO                          = IRKEY_DUMY-3,
    IRKEY_PICTURE                       = IRKEY_DUMY-5,
    IRKEY_FREEZE                         = IRKEY_DUMY-6,
    
    IRKEY_AV                                 = IRKEY_DUMY-7, 
    IRKEY_HDMI                             = IRKEY_DUMY-8, 
    IRKEY_SCART                           = IRKEY_DUMY-9, 
    IRKEY_PC                                 = IRKEY_DUMY-10, 
    IRKEY_DTV                               = IRKEY_DUMY-11, 
    IRKEY_TV                                  = IRKEY_DUMY-12,
    IRKEY_COMPONENT                 = IRKEY_DUMY-13, 
    IRKEY_SV                                  = IRKEY_DUMY-14, 
    IRKEY_TV_INPUT                     = IRKEY_DUMY-15,
 
    IRKEY_TTX_MODE                    = IRKEY_DUMY-16,
    IRKEY_RED2                             = IRKEY_DUMY-17,
    IRKEY_GREEN2                         = IRKEY_DUMY-18,
    IRKEY_UPDATE                         = IRKEY_DUMY-19,
    IRKEY_SUBTITLE                      = IRKEY_DUMY-20,

    IRKEY_PAGE_UP                   = IRKEY_DUMY-21,
    IRKEY_PAGE_DOWN             = IRKEY_DUMY-22,
    IRKEY_BACK                          = IRKEY_DUMY-23,
    IRKEY_SUBPAGE                    =IRKEY_DUMY-24,
    
    IRKEY_ADJUST                       = IRKEY_DUMY-25,
    IRKEY_CLOCK                        = IRKEY_DUMY-26,
    IRKEY_PAUSE                         = IRKEY_DUMY-27,    
    IRKEY_RED                             = IRKEY_DUMY-28,
    IRKEY_GREEN                         = IRKEY_DUMY-29,
    IRKEY_YELLOW                      = IRKEY_DUMY-30,
    IRKEY_BLUE                            = IRKEY_DUMY-31,
    IRKEY_MTS                              = IRKEY_DUMY-32,
    IRKEY_NINE_LATTICE            = IRKEY_DUMY-33,
    IRKEY_TTX                               = IRKEY_DUMY-34,
    IRKEY_CC                                 = IRKEY_DUMY-35,
    IRKEY_CRADRD                       = IRKEY_DUMY-36,
    IRKEY_SLEEP                          = IRKEY_DUMY-37,
    IRKEY_EPG                              = IRKEY_DUMY-38,
    IRKEY_PIP                              = IRKEY_DUMY-39,
    IRKEY_MIX                             = IRKEY_DUMY-40,
    IRKEY_INDEX                         = IRKEY_DUMY-41,
    IRKEY_HOLD                          = IRKEY_DUMY-42,
    IRKEY_SIZE                            = IRKEY_DUMY-43,
    IRKEY_REVEAL                       = IRKEY_DUMY-44,
    IRKEY_SUBCODE                    = IRKEY_DUMY-45,
    IRKEY_P_CHECK                     = IRKEY_DUMY-46,
    IRKEY_S_CHECK                     = IRKEY_DUMY-47,
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-48,
    IRKEY_HOME                          = IRKEY_DUMY-49,
}IrCommandType;
//*************************************************************************
...
#define IR_TOSHIBA_HEADER_CNT_LB    7000 //us
#define IR_TOSHIBA_HEADER_CNT_UB    12000
#define IR_TOSHIBA_LOGIC0_CNT_LB      800
#define IR_TOSHIBA_LOGIC0_CNT_UB     1400
#define IR_TOSHIBA_LOGIC1_CNT_LB       1800
#define IR_TOSHIBA_LOGIC1_CNT_UB       2700
#define IR_TOSHIBA_REPEATE_TIMEOUT  108+30
#define IR_TOSHIBA_REMAIN_TIME          300
