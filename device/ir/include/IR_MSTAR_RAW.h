...
typedef enum _IrCommandType
{
    ...
    IRKEY_AV                 = IRKEY_DUMY-5,
    IRKEY_HDMI            = IRKEY_DUMY-6,
    IRKEY_SCART         = IRKEY_DUMY-7,
    IRKEY_PC                = IRKEY_DUMY-8,
    IRKEY_TV                = IRKEY_DUMY-9,
    IRKEY_DTV              = IRKEY_DUMY-10,
    IRKEY_COMPONENT  = IRKEY_DUMY-11,
    IRKEY_SV                = IRKEY_DUMY-12,

    IRKEY_SUBPAGE   =   IRKEY_DUMY-13,
}IrCommandType;
//*************************************************************************
