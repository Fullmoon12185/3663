...
#define IR_HEADER_CODE1         0xFF    // Custom 1     //0xFB
...
{
    IRKEY_TV_ANTENNA        = IRKEY_DUMY,  //NO USED
    IRKEY_TV_RADIO          = 0xd5,
    IRKEY_CHANNEL_LIST      = IRKEY_DUMY-1,  //NO USED
    IRKEY_CHANNEL_FAV_LIST  = 0x94,
    IRKEY_CHANNEL_RETURN    = 0x8f,//IRKEY_DUMY-2,  //NO USED
    IRKEY_CHANNEL_PLUS      = 0xcb,//IRKEY_DUMY-3,  //NO USED
    IRKEY_CHANNEL_MINUS     = 0x89,//IRKEY_DUMY-4,  //NO USED

    IRKEY_AUDIO             = 0xd4,//0xca,//dvb-t menu
    IRKEY_VOLUME_PLUS       = 0xc8,//IRKEY_DUMY-5,  //NO USED
    IRKEY_VOLUME_MINUS      = 0x88,//IRKEY_DUMY-6,  //NO USED
   ...
   IRKEY_MUTE              = 0xc5,
   IRKEY_FREEZE            = RKEY_DUMY-43,
   IRKEY_PAGE_UP           = 0xc9,
   IRKEY_PAGE_DOWN         = 0xd7,
   IRKEY_CLOCK             = IRKEY_DUMY-7,  //NO USED
   IRKEY_INFO              = 0xc7,
   IRKEY_RED               = 0xcd,
   IRKEY_GREEN             = 0x8c,
   IRKEY_YELLOW            = 0xcc,
   IRKEY_BLUE              = 0x85,
   IRKEY_MTS               = 0xca,
   IRKEY_NINE_LATTICE      = IRKEY_DUMY-8,  //NO USED
   IRKEY_TTX               = 0x81,
   IRKEY_CC                = IRKEY_DUMY-9,  //NO USED
   IRKEY_INPUT_SOURCE      = 0x8b,
   IRKEY_CRADRD            = IRKEY_DUMY-10,  //NO USED
   IRKEY_PICTURE           = 0x8e,
   IRKEY_ZOOM              = 0x82,
   IRKEY_DASH              = 0x95,  //NO USED
   IRKEY_SLEEP             = 0x97,
   IRKEY_EPG               = 0x91,

    IRKEY_P_CHECK           = IRKEY_DUMY-12,  //NO USED
    IRKEY_S_CHECK           = IRKEY_DUMY-13,  //NO USED

      IRKEY_MIX               = 0xc0,
    IRKEY_INDEX             = 0x80,
    IRKEY_HOLD              = 0x8d,
   IRKEY_PREVIOUS           = 0x0E,
    IRKEY_NEXT              = IRKEY_DUMY-14,  //NO USED
   IRKEY_BRIGHTNESS_PLUS    = IRKEY_DUMY-15,  //NO USED
  IRKEY_BRIGHTNESS_MINUS    = IRKEY_DUMY-16,  //NO USED
    IRKEY_BACKWARD          = 0xd0,
    IRKEY_FORWARD           = 0xd1,
    IRKEY_PLAY              = IRKEY_DUMY-17,  //NO USED
    IRKEY_RECORD            = IRKEY_DUMY-18,  //NO USED
    IRKEY_STOP              = IRKEY_DUMY-19,  //NO USED
    IRKEY_PAUSE             = 0x95,

    IRKEY_POWERONLY         = IRKEY_DUMY-22,  //NO USED

    IRKEY_TTX_MODE          = IRKEY_DUMY-23,  //NO USED
    IRKEY_RED2              = IRKEY_DUMY-24,  //NO USED
    IRKEY_GREEN2            = IRKEY_DUMY-25,  //NO USED
    IRKEY_UPDATE            = IRKEY_DUMY-26,  //NO USED
    IRKEY_SUBTITLE          = IRKEY_DUMY-27,  //NO USED
    IRKEY_SUBCODE           = 0x83,
    IRKEY_TIME               = IRKEY_DUMY-28,  //NO USED

    IRKEY_SIZE              = 0xc1,
    IRKEY_REVEAL            = IRKEY_DUMY-33,
    IRKEY_RETURN            = IRKEY_DUMY-29,  //NO USED
    IRKEY_ADJUST            = IRKEY_DUMY-30,  //NO USED
    IRKEY_TV_INPUT          = IRKEY_DUMY-31,  //NO USED
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-32,  //NO USED

    // source switching hotkeys
    IRKEY_AV                 = IRKEY_DUMY-33,
    IRKEY_HDMI            = IRKEY_DUMY-34,
    IRKEY_SCART         = IRKEY_DUMY-35,
    IRKEY_PC                = IRKEY_DUMY-36,
    IRKEY_TV                = IRKEY_DUMY-37,
    IRKEY_DTV              = IRKEY_DUMY-38,
    IRKEY_COMPONENT  = IRKEY_DUMY-39,
    IRKEY_SV                = IRKEY_DUMY-40,
