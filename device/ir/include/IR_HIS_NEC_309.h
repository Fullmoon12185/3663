...
//*************************************************************************
#define IR_MODE_SEL             IR_TYPE_SWDECODE_HSS_MODE//IR_TYPE_FULLDECODE_MODE
...
{
    IRKEY_TV_ANTENNA        =0xEc, //0x0C,
    IRKEY_TV_RADIO          = 0x58,//same as IRKEY_PAGE_UP
    IRKEY_CHANNEL_LIST      = 0xE0,//0x10,
    IRKEY_CHANNEL_FAV_LIST  = 0x1e,//0xE8,//0x08,
    IRKEY_CHANNEL_RETURN    = 0x0b,//0x5C,
    IRKEY_CHANNEL_PLUS      = 0x4a,//0x00,//0x1F,
    IRKEY_CHANNEL_MINUS     = 0x4b,//0x01,//0x19,

    IRKEY_AUDIO             = 0x11,//0x44,
    IRKEY_VOLUME_PLUS       = 0x44,//0x02,//0x16,
    IRKEY_VOLUME_MINUS      = 0x43,//0x03,//0x15,

    IRKEY_UP                = 0x16,//0x56,//0x52,
    IRKEY_POWER             = 0x0d,//0x08,//0x46,
    IRKEY_EXIT              = 0x5c,//0x1B,
    IRKEY_MENU              = 0x14,//0x43,//0x07,
    IRKEY_DOWN              = 0x17,//0x57,//0x13,
    IRKEY_LEFT              = 0x19,//0x58,//0x06,
    IRKEY_SELECT            = 0x15,//0x5a,//0x0F,
    IRKEY_RIGHT             = 0x18,//0x59,//0x1A,

    IRKEY_NUM_0             = 0x00,//0x10,//0x50,
    IRKEY_NUM_1             = 0x01,//0x11,//0x49,
    IRKEY_NUM_2             = 0x02,//0x12,//0x55,
    IRKEY_NUM_3             = 0x03,//0x13,//0x59,
    IRKEY_NUM_4             = 0x04,//0x14,//0x4D,
    IRKEY_NUM_5             = 0x05,//0x15,//0x51,
    IRKEY_NUM_6             = 0x06,//0x16,//0x5D,
    IRKEY_NUM_7             = 0x07,//0x17,//0x48,
    IRKEY_NUM_8             = 0x08,//0x18,//0x54,
    IRKEY_NUM_9             = 0x09,//0x19,//0x58,

    IRKEY_MUTE              = 0x0e,//0x09,//0x5A,
    IRKEY_FREEZE            = 0x0f,//0x4E,
#ifdef ENABLE_DMP
    IRKEY_PAGE_UP           = 0xD3,//0x03,
#endif
    IRKEY_PAGE_DOWN         = IRKEY_DUMY-24,
    IRKEY_CLOCK             = 0x5F,

    IRKEY_INFO              = 0x0c,//0x14,
    IRKEY_RED               = 0x52,//0x47,
    IRKEY_GREEN             = 0x53,//0x4B,
    IRKEY_YELLOW            = 0x54,//0x57,
    IRKEY_BLUE              = 0x55,//0x5B,
    IRKEY_MTS               = 0x1c,//0x41,
    IRKEY_NINE_LATTICE      = IRKEY_DUMY,
    IRKEY_TTX               = 0x50,//0x0A,
    IRKEY_LANGUAGE_LIST = 0x51,
    IRKEY_INPUT_SOURCE      = 0x12,//0x0b,//0x04,
    IRKEY_CRADRD            = IRKEY_DUMY-1,
    IRKEY_PICTURE           = 0x10,//0x05,//0x40,
    IRKEY_ZOOM              = 0x13,//0x07,//0x4C,
    ...
    IRKEY_PLAY              = 0x4E,
    IRKEY_RECORD            = 0x33,
    IRKEY_STOP              = 0x5A,//0x4D
    IRKEY_PAUSE             = 0x56,
    IRKEY_MEMORY_RECALL 	  = 0X17,
#if ENABLE_PVR
    IRKEY_TIME_SHIFT        = 0x5E,//lgl 20090514 add for time shift
    IRKEY_PVR               = 0x4F,
#endif
    ...
    IRKEY_DTV               = 0x1b,//IRKEY_DUMY-11, // no use
    IRKEY_TV                = IRKEY_DUMY-12, // no use
    IRKEY_COMPONENT  = IRKEY_DUMY-13, // no use
    IRKEY_SV                = IRKEY_DUMY-14, // no use
#endif
    IRKEY_SLEEP             = 0x1a,//0xE5,
    IRKEY_EPG               = 0x1d,//0x40,//0x4A,

    IRKEY_P_CHECK           = 0x32,
    IRKEY_S_CHECK           = 0x5b,

    IRKEY_MIX               =0x45,// 0x1C,
    IRKEY_INDEX             = 0x47,//0xD8,//0x18,
    IRKEY_HOLD              = IRKEY_DUMY-19,//0x00,
  ...
  //IRKEY_BRIGHTNESS_MINUS  = 0x12,
    ...
    IRKEY_TTX_MODE          = 0x22,
    IRKEY_RED2              = 0x72,
    IRKEY_GREEN2            = IRKEY_DUMY-18,//0x71,
    IRKEY_UPDATE            = 0x46,//0xDC,
    IRKEY_SUBTITLE          = 0x1f,//0xE3,//0x53,
    //IRKEY_SUBCODE           = 0x41,//0x53,
    IRKEY_TIME           	  = 0x26,

    IRKEY_SIZE              = 0x40,//0xC3,//0x43,
    IRKEY_REVEAL            =0x42,// 0x4F,
    IRKEY_RETURN            = IRKEY_DUMY-17,//0x0b,//0x00,
    IRKEY_ADJUST            = IRKEY_DUMY-2,
    IRKEY_TV_INPUT          = IRKEY_DUMY-3,
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-4,
    IRKEY_BACK              = IRKEY_DUMY-5,
    IRKEY_SUBPAGE   =   0x41,//IRKEY_DUMY-6,
    IRKEY_CC                = IRKEY_DUMY-20,
    IRKEY_BACKWARD          = IRKEY_DUMY-21,
    IRKEY_FORWARD           = IRKEY_DUMY-22,
    IRKEY_HOME		        = IRKEY_DUMY-23,
#ifdef HSS_FACTORY_REMOTE
// irkey define for factory remoter
    IRKEY_GEO_POWER                        = 0x10+0x60,
    IRKEY_GEO_M                                 = 0x00+0x60,
    IRKEY_GEO_AGING                         = 0x15+0x60,
    IRKEY_GEO_BUS                             = 0x17+0x60,
    IRKEY_GEO_MENU                         = 0x60+0x5E,//0xBE,//0x5E+0x60,
    IRKEY_GEO_OK                               = 0x47+0x60,
    IRKEY_GEO_AGC                             = 0x19+0x60,
    IRKEY_GEO_WB                               = 0x43+0x60,
    IRKEY_GEO_AFT                              = 0x0D+0x60,
    IRKEY_GEO_AV                                = 0x05+0x60,
    IRKEY_GEO_DTV                              = 0x01+0x60,
    IRKEY_GEO_VG2                              = 0x0A+0x60,
    IRKEY_GEO_SUB                              = 0x1B+0x60,
    IRKEY_GEO_WBH                             = 0x5D+0x60,
    IRKEY_GEO_WBL                              = 0x04+0x60,
    IRKEY_GEO_SCAN                            =  0x11+0x60,
    IRKEY_GEO_BAL                               = 0x06+0x60,

    IRKEY_WB_RDRV_INC                      = 0x50+0x60,
    IRKEY_WB_RDRV_DEC                     = 0x46+0x60,
    IRKEY_WB_GDRV_INC                     = 0x4C+0x60,
    IRKEY_WB_GDRV_DEC                     = 0x5A+0x60,
    IRKEY_WB_BDRV_INC                      = 0x49+0x60,
    IRKEY_WB_BDRV_DEC                      = 0x4A+0x60,
    IRKEY_WB_RCUT_INC                      = 0x44+0x60,
    IRKEY_WB_RCUT_DEC                      = 0x41+0x60,
    IRKEY_WB_GCUT_INC                      = 0x4B+0x60,
    IRKEY_WB_GCUT_DEC                      = 0x51+0x60,
    IRKEY_WB_BCUT_INC                       = 0x08+0x60,
    IRKEY_WB_BCUT_DEC                      = 0x45+0x60,

    IRKEY_GEO_VSYS	                       = 0x60+0x4E,//0x4E+0x60,
    IRKEY_GEO_ASYS                              = 0x42+0x60,
    IRKEY_GEO_PMOD                             = 0x54+0x60,
    IRKEY_GEO_AUTO                             = 0x09+0x60,
    IRKEY_GEO_LLLL                               = 0x1D+0x60,
    IRKEY_GEO_RRRR                              = 0x1F+0x60,
    IRKEY_GEO_CH_INC                          = 0x14+0x60,
    IRKEY_GEO_CH_DEC                          = 0x0F+0x60,
    IRKEY_GEO_VOL_INC                         = 0x5B+0x60,
    IRKEY_GEO_VOL_DEC                      = 0x60+0x1E,//0x1E+0x60,

    IRKEY_WB_VGA                                 = 0x18+0x60,
    IRKEY_WB_S1                                    = 0x59+0x60,
    IRKEY_WB_S2                                    = 0x58+0x60,
    IRKEY_WB_S3                                    = 0x56+0x60,
    IRKEY_WB_S4                                    = 0x48+0x60,

    IRKEY_GEO_S5                                   = 0x53+0x60,
    IRKEY_GEO_S6                                   = 0x1C+0x60,
    IRKEY_GEO_S7                                   = 0x4F+0x60,
    IRKEY_WB_TILT                                 = 0x40+0x60,
	IRKEY_FACTORY_POWER                    = 0x10+0x60,	//Karl add 02/04/2010
#endif
#ifdef ADD_NEW_FAC_REMOTE_TO_CHANGE_SOURCE
    IRKEY_CS_TV                                     = 0x00+0xC0,
    IRKEY_CS_DTV                                     = 0x01+0xC0,
    IRKEY_CS_AV1                                     = 0x02+0xC0,
    IRKEY_CS_AV2                                     = 0x03+0xC0,
    IRKEY_CS_AV3                                     = 0x04+0xC0,
    IRKEY_CS_S_VIDEO1                                     = 0x05+0xC0,
    IRKEY_CS_S_VIDEO2                                     = 0x06+0xC0,
    IRKEY_CS_S_VIDEO3                                     = 0x07+0xC0,
    IRKEY_CS_SCART1                                     = 0x08+0xC0,
    IRKEY_CS_SCART2                                     = 0x09+0xC0,
    IRKEY_CS_SCART3                                     = 0x0A+0xC0,
    IRKEY_CS_YPBPR1                                     = 0x0B+0xC0,
    IRKEY_CS_YPBPR2                                     = 0x0C+0xC0,
    IRKEY_CS_YPBPR3                                     = 0x0D+0xC0,
    IRKEY_CS_VGA                           = 0xCE,//0x0E+0xC0,
    IRKEY_CS_HDMI1                                     = 0x0F+0xC0,
    IRKEY_CS_HDMI2                                     = 0x10+0xC0,
    IRKEY_CS_HDMI3                                     = 0x11+0xC0,
    IRKEY_CS_HDMI4                                     = 0x12+0xC0,
    IRKEY_CS_HDMI5                         = 0x13+0xC0,
    IRKEY_CS_DMP                                     = 0x14+0xC0,
    IRKEY_CS_EMP                                    = 0x15+0xC0,
    IRKEY_CS_AUTO_COLOR                                     = 0x16+0xC0,
    IRKEY_CS_POWERSAVE                                     = 0x17+0xC0,
    IRKEY_CS_SUBTITLE                                     = 0x18+0xC0,
    IRKEY_CS_NICAM                                     = 0x19+0xC0,
    IRKEY_CS_VCHIP                                     = 0x1A+0xC0,
    IRKEY_CS_CCD                                    = 0x1B+0xC0,
    IRKEY_CS_BTSC                                     = 0x1C+0xC0,
    IRKEY_CS_OK                                     = 0x1D+0xC0,
#endif
	IRKEY_LED_CONTROL_FLAG  = 0xF5,		//virtual ir for pm_sleep led on/off flag	//Karl add 02/04/2010
