...
//*************************************************************************
#define IR_MODE_SEL             IR_TYPE_FULLDECODE_MODE//for PW use FULLDECODE but kernel use SWDECODE to support factory IR;
#define IR_CHANNEL_USE_AS_UPDOWN   0
#define IR_VOLUME_USE_AS_LEFTRIGHT      0
// IR Header code define //here define only for pw code;
#define IR_HEADER_CODE0         	0x00//0x80    // Custom 0     //0x04 
#define IR_HEADER_CODE1         	0xBF//0x7F    // Custom 1     //0xFB
...
{
    IRKEY_TV_RADIO          = IRKEY_DUMY-39,
    IRKEY_CHANNEL_LIST      = IRKEY_DUMY-6,
    ...
    IRKEY_DMP_INFO          = 0x5D,
    IRKEY_FREAZE            = 0x0F,
    IRKEY_TIME_RECALL       = 0x48,
    IRKEY_SAVE_ENERGY       = 0x1C,
