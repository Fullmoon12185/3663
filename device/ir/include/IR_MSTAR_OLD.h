...
typedef enum _IrCommandType
{
    ...
    IRKEY_ADJUST            = IRKEY_DUMY-23,
    IRKEY_TV_INPUT          = IRKEY_DUMY-24,
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-25,

    // source switching hotkeys
    IRKEY_AV                 = IRKEY_DUMY-26,
    IRKEY_HDMI            = IRKEY_DUMY-27,
    IRKEY_SCART         = IRKEY_DUMY-28,
    IRKEY_PC                = IRKEY_DUMY-29,
    IRKEY_TV                = IRKEY_DUMY-30,
    IRKEY_DTV              = IRKEY_DUMY-31,
    IRKEY_COMPONENT  = IRKEY_DUMY-32,
    IRKEY_SV                = IRKEY_DUMY-33,

    IRKEY_SUBPAGE   =   IRKEY_DUMY-34,
}IrCommandType;
//*************************************************************************
