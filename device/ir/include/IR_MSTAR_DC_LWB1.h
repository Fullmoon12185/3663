...
typedef enum _IrCommandType
{
    ...
    IRKEY_CHANNEL_RETURN        = 0x52, // PREVIOUS
    IRKEY_CHANNEL_PLUS          = 0x1B,
    IRKEY_CHANNEL_MINUS         = 0x1F,

    IRKEY_AUDIO                 = IRKEY_DUMY-3,
    IRKEY_VOLUME_PLUS           = 0x1A,
    IRKEY_VOLUME_MINUS          = 0x1E,
    ...
    IRKEY_BLUE                  = 0x4B,
    IRKEY_MTS                   = 0x13,
    IRKEY_NINE_LATTICE          = IRKEY_DUMY-7,
    IRKEY_TTX                   = 0x17,
    IRKEY_CC                    = IRKEY_DUMY-8,
    IRKEY_INPUT_SOURCE          = 0x14,
    IRKEY_CRADRD                = IRKEY_DUMY-9,
    IRKEY_PICTURE               = IRKEY_DUMY-10,
    IRKEY_ZOOM                  = 0x59,
    IRKEY_DASH                  = IRKEY_DUMY-11,
    IRKEY_SLEEP                 = IRKEY_DUMY-12,
    IRKEY_EPG                   = 0x45,

    IRKEY_P_CHECK               = IRKEY_DUMY-13,
    IRKEY_S_CHECK               = IRKEY_DUMY-14,
...
//    IRKEY_BRIGHTNESS_PLUS       = IRKEY_DUMY,
//    IRKEY_BRIGHTNESS_MINUS      = IRKEY_DUMY,
    IRKEY_BACKWARD              = IRKEY_DUMY-17,
    IRKEY_FORWARD               = IRKEY_DUMY-18,
    IRKEY_PLAY                  = IRKEY_DUMY-19,
    IRKEY_RECORD                = IRKEY_DUMY-20,
    IRKEY_STOP                  = IRKEY_DUMY-21,
    IRKEY_PAUSE                 = 0x22,                     // STILL

    IRKEY_POWERONLY             = IRKEY_DUMY-24,

    IRKEY_TTX_MODE              = 0x2C,                     // TEXT SUB PAGE
    IRKEY_RED2                  = IRKEY_DUMY-25,
    IRKEY_GREEN2                = IRKEY_DUMY-26,
    IRKEY_UPDATE                = IRKEY_DUMY-27,
    IRKEY_SUBTITLE              = 0x0C,
//  IRKEY_SUBCODE               = IRKEY_DUMY,
    IRKEY_TIME                   = 0x15,
    IRKEY_MEMORY_RECALL         = IRKEY_DUMY-28,
    IRKEY_SIZE                  = IRKEY_DUMY-29,
    IRKEY_REVEAL                = 0x54,
    IRKEY_RETURN                = IRKEY_DUMY-30,
    IRKEY_ADJUST                = IRKEY_DUMY-31,
    IRKEY_TV_INPUT              = IRKEY_DUMY-32,
    IRKEY_KEY_DISABLE_KEYPAD    = IRKEY_DUMY-33,
    IRKEY_BACK                  = IRKEY_DUMY-34,

    // -- Specific for Vender ------------------------------------------------------------
    IRKEY_SELECTABLE_PICTURE    = 0x11,
    IRKEY_FULL_TOP_BOTTOM       = 0x0D,
