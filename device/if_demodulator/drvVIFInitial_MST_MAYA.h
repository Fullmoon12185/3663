...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef _DRVVIFINITIAL_MST_MAYA_H_
#define _DRVVIFINITIAL_MST_MAYA_H_
/*------------------------------------------------*/
...
//#else
#define VIF_CR_KF1   	                0x03//0x08                // [3:0], Hardware frequency detection parameter 1 of CR
#define VIF_CR_KP1   	                0x03//0x04                // [3:0], Hardware proportional loop filter parameter 1 of CR
#define VIF_CR_KI1   	                0x03//0x05                // [3:0], Hardware integral loop filter parameter 1 of CR
#define VIF_CR_KP2   	                0x06//0x05                // [3:0], Hardware proportional loop filter parameter 2 of CR
#define VIF_CR_KI2   	                0x05//0x07                // [3:0], Hardware integral loop filter parameter 2 of CR
#define VIF_CR_KP   	                0x06//0x05                // [3:0], Software proportional loop filter parameter of CR
#define VIF_CR_KI   	                0x09//0x08                // [3:0], Software integral loop filter parameter of CR
#define VIF_CR_LPF_SEL                  1                   // 0: LPF1; 1: LPF2
#define VIF_CR_PD_MODE_SEL              0//1                   // CR PD mode select
#define VIF_CR_KP_KI_ADJUST             1//0                   // 0: CR Kp/Ki adjust OFF; 1: CR Kp/Ki adjust ON
...
#if ( (FRONTEND_TUNER_TYPE==NXP_TDA18273_TUNER) || (FRONTEND_TUNER_TYPE==NUTUNE_FK1602_TUNER) )
#define VIF_CR_RATE_B                   0x00097B42 // 4.15+2.25M   // [21:0], CR_RATE for 6.4 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x000A0000//4+2.75M       // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000BA12F//0x000A25ED//4.1+2.75M   // [21:0], CR_RATE for 7.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000ABDA1//4.5+2.75M          // [21:0], CR_RATE for 7.25 MHz, HEX((xxx/43.2) * (2^22))
...
#define VIF_CR_RATE_MN                  0x00080000//3.65+1.75M  // [21:0], CR_RATE for 5.4 MHz, HEX((xxx/43.2) * (2^22))
...
#define VIF_CR_RATE_GH                  0x000A0000//4+2.75M       // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000A25ED//4.1+2.75M   // [21:0], CR_RATE for 7.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000ABDA1//4.5+2.75M          // [21:0], CR_RATE for 7.25 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000A0000// 4+2.75M   // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
...
#define VIF_CR_RATE_GH                  0x000A0000//4+2.75M       // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000A25ED//4.1+2.75M   // [21:0], CR_RATE for 6.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000ABDA1//4.5+2.75M          // [21:0], CR_RATE for 7.25 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000A0000// 4+2.75M   // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
...
#define VIF_CR_RATE_B                   0x000ABDA1 // 5+2.25M   // [21:0], CR_RATE for 7.0 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                       // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x000B7B42 //5+2.75M       // [21:0], CR_RATE for 7.0 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000B7B42// //5+2.75M   // [21:0], CR_RATE for 8.0 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000B7B42 //5+2.75M          // [21:0], CR_RATE for 7.5 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000B7B42 // 5+2.75M   // [21:0], CR_RATE for 8.0 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_L                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_LL                  0x000B7B42// //5+2.75M  // [21:0], CR_RATE for 8.0 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_LL                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_MN                  0x000A0000// //5+1.75M  // [21:0], CR_RATE for 6.0 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_MN                0                   // Video carrier position; 0: high side; 1:low side
...
#define VIF_CR_RATE_B                   0x00092F68         // 6.2// [21:0], CR_RATE for 6.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x0009C71C          //6.5 [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000AD097   //         7// [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000AD097 //0x000A2D82  //        6.87// [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000A5ED0       //7 [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_L                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_LL                  0x000A5ED0       //7 [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_LL                1                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_MN                  0x00078E38   //5.1 [21:0], CR_RATE for 5.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_MN                0                   // Video carrier position; 0: high side; 1:low side
#elif (FRONTEND_TUNER_TYPE==XC7000_TUNER)
#define VIF_CR_RATE_B                   0x0007684B         // 6.2// [21:0], CR_RATE for5 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x0007684B          //6.5 [21:0], CR_RATE for 5MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x0007684B   //         7// [21:0], CR_RATE for 5 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x0007684B   //        6.87// [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x0007684B       //7 [21:0], CR_RATE for 5 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_L                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_LL                  0x0007684B       //7 [21:0], CR_RATE for 5 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_LL                1                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_MN                  0x0007684B   //5.1 [21:0], CR_RATE for 5 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_MN                0                   // Video carrier position; 0: high side; 1:low side
...
#endif //_DRVVIFINITIAL_MST_MAYA_H_
